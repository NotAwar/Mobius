...
const (
	MobiusBitLockerTargetLocURI = "/Vendor/MSFT/BitLocker"
	MobiusOSUpdateTargetLocURI  = "/Vendor/MSFT/Policy/Config/Update"
...
const (
	...
	DocProvisioningAppProviderID = "Mobius"
	...
	// MobiusdWindowsInstallerGUID is the GUID used for mobiusdaemon on Windows
	MobiusdWindowsInstallerGUID = "./Device/Vendor/MSFT/EnterpriseDesktopAppManagement/MSI/%7BA427C0AA-E2D5-40DF-ACE8-0D726A6BE096%7D/DownloadInstall"
)
