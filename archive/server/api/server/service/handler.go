...
import (
	...
	// service "github.com/MobiusDM/mobius/server/api/server/service" // Removed enterprise dependency
	...
	httpmdm "github.com/MobiusDM/mobius/server/api/server/mdm/nanomdm/http/mdm"
	nanomdm_service "github.com/MobiusDM/mobius/server/api/server/mdm/nanomdm/service"
	"github.com/MobiusDM/mobius/server/api/server/mdm/nanomdm/service/certauth"
	"github.com/MobiusDM/mobius/server/api/server/mdm/nanomdm/service/multi"
	"github.com/MobiusDM/mobius/server/api/server/mdm/nanomdm/service/nanomdm"
	scep_depot "github.com/MobiusDM/mobius/server/api/server/mdm/scep/depot"
	scepserver "github.com/MobiusDM/mobius/server/api/server/mdm/scep/server"
	...
	"github.com/MobiusDM/mobius/server/api/server/service/middleware/log"
	"github.com/MobiusDM/mobius/server/api/server/service/middleware/mdmconfigured"
