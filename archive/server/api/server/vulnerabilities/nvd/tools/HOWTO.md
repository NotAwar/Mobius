...
* Hosted software: packages sitting in software repositories, available to your mobius (source and binary, first-party and third-party)
...
These are domain-specific programs that scrape software repositories (or logs) and report packages available to the mobius.
...
* Consider whether you really need to process inventories from installed and running software using cpe2cve: this can be expensive depending on the size of your mobius; you may want to start by simply matching CPEs back to your hosted software inventories
