...
func main() {
	...
	r.Path("/").Methods("GET").HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		w.Write([]byte(`<center><h1>MobiusDM Windows MDM Demo Server<br></h1>.<center>`))
		w.Write([]byte(`<br><center><img src="https://mobiusmdm.com/images/press-kit/mobius-logo-dark-rgb.png"></center>`))
	})
