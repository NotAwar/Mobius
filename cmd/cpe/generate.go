...
import (
	...
	"github.com/notawar/mobius set/v4/server/vulnerabilities/nvd/tools/cpedict"
	"github.com/notawar/mobius set/v4/server/vulnerabilities/nvd/tools/wfn"
...
func main() {
	...
	client := mobiushttp.NewClient(mobiushttp.WithTimeout(httpClientTimeout))
