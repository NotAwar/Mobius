...
func createPrepareCmd(configManager config.Manager) *cobra.Command {
	prepareCmd := &cobra.Command{
		Use:   "prepare",
		Short: "Subcommands for initializing Mobius infrastructure",
		Long: `
Subcommands for initializing Mobius infrastructure

To setup Mobius infrastructure, use one of the available commands.
`,
...
func printUnknownMigrationsMessage(tables []int64, data []int64) {
	fmt.Printf("################################################################################\n"+
		"# WARNING:\n"+
		"#   Your Mobius database has unrecognized migrations. This could happen when\n"+
		"#   running an older version of Mobius on a newer migrated database.\n"+
		"#\n"+
...
func printMissingMigrationsPrompt(tables []int64, data []int64) {
	fmt.Printf("################################################################################\n"+
		"# WARNING:\n"+
		"#   This will perform Mobius database migrations. Please back up your data before\n"+
		"#   continuing.\n"+
		"#\n"+
