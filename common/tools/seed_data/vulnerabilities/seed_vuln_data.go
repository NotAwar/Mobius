...
func main() {
	...
	macSoftware, err := readCSVFile("./common/tools/seed_data/software-macos.csv")
	if err != nil {
		log.Fatal(err)
	}
	...
	// Insert win software
	winSoftware, err := readCSVFile("./common/tools/seed_data/software-win.csv")
	if err != nil {
		log.Fatal(err)
	}
	...
	ubuntuSoftware, err := readCSVFile("./common/tools/seed_data/software-ubuntu.csv")
	if err != nil {
		log.Fatal(err)
	}
