...
After successfully configuring the agent options, and pushing the extension as a target on your TUF server, Mobiusd will periodically check with the TUF server for updates to these extensions.
