...
2. On the **Single sign-on options** page:
 ...
 ![The configuration for the SSO connection in Mobius](https://raw.githubusercontent.com/mobiusmdm/mobius/main/docs/images/entra-sso-configuration-mobius-config.png)
