...
The Mobius frontend is a Single Page Application using React with Typescript and Hooks.

## Table of contents

- [Running the Mobius web app](#running-the-mobius-web-app)
- [Testing](#testing)
- [Directory Structure](#directory-structure)
- [Patterns](#patterns)
- [Storybook](#storybook)

## Running the Mobius web app

For details instruction on building and serving the Mobius web application
consult the [Contributing documentation](../docs/Contributing/getting-started/README.md).

## Testing

Visit the [overview of Mobius UI testing](../docs/Contributing/guides/ui/mobius-ui-testing.md) for more information on our testing strategy, philosophies, and tools.

To run unit or integration tests in `ComponentName.tests.tsx`, run `yarn test -- ComponentName.tests.tsx`. To [test all Javascript components](https://mobiusmdm.com/docs/contributing/testing-and-local-development#javascript-unit-tests) run `yarn test`.
...
Component directories in the Mobius front-end application encapsulate the entire
...
Files in the interfaces directory are used to specify the Typescript interface for a reusable Mobius
...
### [layouts](https://github.com/notawar/mobius/tree/main/frontend/layouts)

The Mobius application has only 1 layout, the [Core Layout](./layouts/CoreLayout/CoreLayout.jsx).
...
CRUD functions for all Mobius entities (e.g. `query`) that link directly to the Mobius API.
...
The list of patterns used in the Mobius UI codebase can be found [in `patterns.md`](./docs/patterns.md).

## Storybook

[Storybook](https://storybook.js.org/) is a tool to document and visualize components, and we
use it to capture our global components used across Mobius. Storybook is key when developing new
...
- Go to your root mobius project directory
- Run `make deps`
- Run `yarn storybook`
