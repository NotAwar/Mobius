...
const DEFAULT_MOBIUS_MAINTAINED_APPS_MOCK: IMobiusMaintainedApp = {
  id: 1,
  name: "test app",
  version: "1.2.3",
  platform: "darwin",
...
export const createMockMobiusMaintainedApp = (
  overrides?: Partial<IMobiusMaintainedApp>
): IMobiusMaintainedApp => {
  return {
    ...DEFAULT_MOBIUS_MAINTAINED_APPS_MOCK,
    ...overrides,
  };
};

const DEFAULT_MOBIUS_MAINTAINED_APP_DETAILS_MOCK: IMobiusMaintainedAppDetails = {
  id: 1,
  name: "Test app",
  version: "1.2.3",
  platform: "darwin",
...
export const createMockMobiusMaintainedAppDetails = (
  overrides?: Partial<IMobiusMaintainedAppDetails>
) => {
  return { ...DEFAULT_MOBIUS_MAINTAINED_APP_DETAILS_MOCK, ...overrides };
};
