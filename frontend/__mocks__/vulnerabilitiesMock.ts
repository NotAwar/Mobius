...
const DEFAULT_VULNERABILITY: IVulnerability = {
  ...
  cvss_score: 7.8, // Available in Mobius Pro
  epss_probability: 0.9729, // Available in Mobius Pro
  cisa_known_exploit: true, // Available in Mobius Pro
  cve_published: "2022-06-01T00:15:00Z", // Available in Mobius Pro
  cve_description:
    "Microsoft Windows Support Diagnostic Tool (MSDT) Remote Code Execution Vulnerability.", // Available in Mobius Pro
  resolved_in_version: "", // Available in Mobius Pro
};
