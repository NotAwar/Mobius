...
interface IMobiusAvatarProps {
  className?: string;
}

/**
 * a simple component that can be used to display a the Mobius logo as an avatar
 */
const MobiusAvatar = ({ className }: IMobiusAvatarProps) => {
  return (
    <svg
      data-testid="mobius-avatar"
      className={className}
      width="32"
      height="32"
      viewBox="0 0 32 32"
...
interface IAvatarProps {
  ...
  /**
   * Set this to `true` to use the mobius avatar instead of the users gravatar.
   */
  useMobiusAvatar?: boolean;
}
...
const Avatar = ({
  ...
  return (
    <div className="avatar-wrapper">
      {useMobiusAvatar ? (
        <MobiusAvatar className={avatarClasses} />
      ) : (
        <img
          alt="User avatar"
