...
class RegistrationForm extends Component {
  ...
  render() {
    ...
    const mobiusDetailsContainerClass = classnames(
      `${baseClass}__container`,
      `${baseClass}__container--mobius`
    );

    const mobiusDetailsClass = classnames(
      `${baseClass}__field-wrapper`,
      `${baseClass}__field-wrapper--mobius`
    );
    ...
    return (
      <div className={baseClass}>
        <div className={formSectionClasses}>
          ...
          <div className={mobiusDetailsContainerClass}>
            <h2>Set Mobius URL</h2>
            <MobiusDetails
              formData={formData}
              handleSubmit={onPageFormSubmit}
              className={mobiusDetailsClass}
