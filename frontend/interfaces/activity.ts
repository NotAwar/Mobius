...
export enum ActivityType {
  ...
  AppliedSpecPack = "applied_spec_pack", // MobiusCLI
  AppliedSpecPolicy = "applied_spec_policy", // MobiusCLI
  AppliedSpecSavedQuery = "applied_spec_saved_query", // MobiusCLI
  AppliedSpecSoftware = "applied_spec_software", // MobiusCLI
  AppliedSpecTeam = "applied_spec_team", // MobiusCLI
  ...
  MobiusEnrolled = "mobius_enrolled",
