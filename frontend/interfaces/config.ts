/* Config interface is a flattened version of the mobius/config API response */
import {
  IWebhookHostStatus,
...
export interface ILicense {
  ...
  note: string;
  organization: string;
  // Whether the Mobius instance is managed by MobiusDM
...
export interface IMdmConfig {
  /** Update this URL if you're self-hosting Mobius and you want your hosts to talk to a different URL for MDM features. (If not configured, hosts will use the base URL of the Mobius instance.) */
   ...
   * https://github.com/mobiusdm/mobius/pull/21043/files#r1705977965
   */
...
export interface IMobiusDesktopSettings {
...
export interface IConfig {
  ...
  license: ILicense;
  mobius_desktop: IMobiusDesktopSettings;
  vulnerabilities: {
  ...
  partnerships?: IMobiusPartnerships;
}

interface IMobiusPartnerships {
