...
export default PropTypes.shape({
  ...
  mobius_desktop_version: PropTypes.string,
...
export interface IHost {
  ...
  mobius_desktop_version: string | null;
  os_version: string;
  build: string;
 ...
 * dep_assigned_to_mobius field, which is not returned by the /hosts endpoint.
 */
export interface IHostDevice extends IHost {
  dep_assigned_to_mobius: boolean;
}
