...
export const isScriptSupportedPlatform = (hostPlatform: string) =>
  ["darwin", "windows", ...HOST_LINUX_PLATFORMS].includes(hostPlatform); // excludes chrome, ios, ipados, android see also https://github.com/mobiusdm/mobius/blob/5a21e2cfb029053ddad0508869eb9f1f23997bf2/server/mobius/hosts.go#L775
