        ...
        <>
          <InfoBanner>
            <p>
              ...
              <CustomLink
                url="https://mobius-mdm.org/docs/using-mobius/MobiusCLI-cli?utm_medium=mobiusui&utm_campaign=get-api-token#using-MobiusCLI-with-an-api-only-user"
                text="API-only user"
                newTab
              />
              &nbsp;instead.
          ...
          <InputFieldHiddenContent
            ...
            helpText={
              <>
                ...
                MobiusCLI CLI. It expires based on the{" "}
                <CustomLink
                  url="https://mobius-mdm.org/docs/deploying/configuration?utm_medium=mobiusui&utm_campaign=get-api-token#session-duration"
