...
import LearnMobius from "./cards/LearnMobius";
...
const DashboardPage = ({ router, location }: IDashboardProps): JSX.Element => {
    ...
    if (hasSoftwareResults) {
      ...
      setSoftwareTitleDetail(
        <LastUpdatedText
          ...
          customTooltipText={
            <>
              Mobius periodically queries all hosts to
              <br />
  ...
  const LearnMobiusCard = useInfoCard({
    title: "Learn how to use Mobius MDM",
    showTitle: true,
    children: <LearnMobius />,
  });
