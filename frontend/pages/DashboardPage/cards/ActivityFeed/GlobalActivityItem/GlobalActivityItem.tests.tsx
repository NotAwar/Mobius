...
describe("Activity Feed", () => {
  ...
  it("renders an applied_spec_pack type activity", () => {
    ...
    expect(
      screen.getByText("edited a pack using MobiusCLI.")
    ).toBeInTheDocument();
  });
  ...
  it("renders an applied_spec_policy type activity", () => {
    ...
    expect(
      screen.getByText("edited policies using MobiusCLI.")
    ).toBeInTheDocument();
  });
  ...
  it("renders an applied_spec_saved_query type activity", () => {
    ...
    expect(
      screen.getByText("edited a query using MobiusCLI.")
    ).toBeInTheDocument();
  });
  ...
  it("renders an applied_spec_saved_query type activity when run on multiple queries", () => {
    ...
    expect(
      screen.getByText("edited queries using MobiusCLI.")
    ).toBeInTheDocument();
  });
  ...
  it("renders an applied_spec_software type activity", () => {
    ...
    expect(
      screen.getByText("edited software using MobiusCLI.")
    ).toBeInTheDocument();
  });
  ...
  it("renders an applied_spec_team type activity for a single team", () => {
    ...
    expect(
      screen.getByText("edited the team using MobiusCLI.")
    ).toBeInTheDocument();
  ...
  it("renders an applied_spec_team type activity for multiple team", () => {
    ...
    expect(
      screen.getByText("edited multiple teams using MobiusCLI.")
    ).toBeInTheDocument();
  });
  ...
  it("renders an user_added_by_sso type activity", () => {
    ...
    expect(screen.getByText("was added to Mobius by SSO.")).toBeInTheDocument();
  });
  ...
  it("renders an 'edited_script' type activity for a team", () => {
    ...
    expect(screen.getByText("Alphas")).toBeInTheDocument();
    expect(
      screen.getByText(" team via MobiusCLI.", { exact: false })
    ).toBeInTheDocument();
    const withNoTeams = screen.queryByText("no team");
    expect(withNoTeams).toBeNull();
  });
  ...
  it("renders an 'edited_script' type activity for hosts with no team.", () => {
    ...
    expect(
      screen.getByText("for no team via MobiusCLI.", { exact: false })
    ).toBeInTheDocument();
  });
