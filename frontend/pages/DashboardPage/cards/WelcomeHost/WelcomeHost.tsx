    ...
    return (
      <div className={baseClass}>
        <div className={`${baseClass}__empty-hosts`}>
          ...
          <p>
            In Mobius, laptops, workstations, and servers are referred to as
            &quot;hosts.&quot;
          </p>
          <Button
      ...
      <div className={baseClass}>
        <div className={`${baseClass}__error`}>
          <p className="error-message">
            ...
            Your device is not communicating with Mobius.
          </p>
          <p>Join the #mobius Slack channel for help troubleshooting.</p>
          <a
            target="_blank"
            rel="noreferrer"
      ...
      <div className={baseClass}>
        <div className={`${baseClass}__intro`}>
          ...
          <div className="info">
            ...
            <p>Your host is successfully connected to Mobius.</p>
          </div>
        </div>
        <div className={`${baseClass}__blurb`}>
          <p>
            Mobius already ran the following policies to assess the security of
            your device:{" "}
          </p>
        </div>
        ...
        <div className={`${baseClass}__refetch`}>
          ...
          >
            <Icon name="refresh" color="core-mobius-white" /> Refetch
          </Button>
          <span>
            Last updated{" "}
