...
const AGGREGATE_STATUS_DISPLAY_OPTIONS: IAggregateDisplayOption[] = [
  {
    ...
    text: "Verified",
    iconName: "success",
    tooltipText: "These hosts applied all OS settings. Mobius verified.",
  },
  {
    value: "verifying",
    text: "Verifying",
    ...
    tooltipText:
      "These hosts acknowledged all MDM commands to apply OS settings. Mobius is verifying the OS settings are applied.",
  },
  {
    value: "pending",
    text: "Pending",
