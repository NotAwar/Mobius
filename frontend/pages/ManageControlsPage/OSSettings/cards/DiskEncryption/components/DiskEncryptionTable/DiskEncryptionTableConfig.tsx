...
const STATUS_CELL_VALUES: Record<DiskEncryptionStatus, IStatusCellValue> = {
  verified: {
    ...
    value: "verified",
    tooltip:
      "These hosts turned disk encryption on and sent their key to Mobius. Mobius verified with osquery.",
  },
  verifying: {
    ...
    value: "verifying",
    tooltip:
      "These hosts acknowledged the MDM command to turn on disk encryption. Mobius is verifying with " +
