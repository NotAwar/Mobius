...
const AddInstallSoftware = ({
    ...
    if (noSoftwareUploaded) {
      return (
        <>
          ...
          <LinkWithContext
            to={PATHS.SOFTWARE_ADD_MOBIUS_MAINTAINED}
  ...
  const manuallyInstallTooltipText = (
    <>
      Disabled because you manually install Mobius&apos;s agent (
    ...
    <div className={baseClass}>
      <div className={`${baseClass}__description-container`}>
        <p className={`${baseClass}__description`}>
          Install software on hosts that automatically enroll to Mobius.
        </p>
        <CustomLink
          newTab
