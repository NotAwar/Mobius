...
import { CONTACT_MOBIUS_LINK } from "utilities/constants";
...
const NoAccessPage = ({ router, orgContactUrl }: INoAccessPageProps) => {
  ...
  return (
    <AuthenticationFormWrapper>
      <StackedWhiteBoxes
        router={router}
        headerText="This account does not currently have access to Mobius."
      >
        <>
          <p>
            To get access,{" "}
            <CustomLink
              url={orgContactUrl || CONTACT_MOBIUS_LINK}
