...
const baseClass = "mobius-app-details-modal";

interface IMobiusAppDetailsModalProps {
  name: string;
  platform: string;
  version: string;
  slug?: string;
...
const URL_TOOLTIP_MESSAGE = (
  <>
    Mobius downloads the package from the URL and stores it.
    <br />
    Hosts download it from Mobius before install.
  </>
);

const MobiusAppDetailsModal = ({
  name,
  platform,
  version,
  slug,
...
export default MobiusAppDetailsModal;
