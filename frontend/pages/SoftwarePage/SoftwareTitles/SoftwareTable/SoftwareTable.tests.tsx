...
describe("Software table", () => {
  ...
  it("does not render 'Available for install' filter when team id is undefined (Mobius Free/All teams)", () => {
    const render = createCustomRenderer({
      context: {
        app: {
          isGlobalAdmin: true,
    ...
    render(
      <SoftwareTable
        ...
        currentPage={0}
        teamId={undefined} // Undefined for Mobius Free or Mobius Pro "All teams"
        isLoading={false}
        onAddFiltersClick={noop}
      />
    );
