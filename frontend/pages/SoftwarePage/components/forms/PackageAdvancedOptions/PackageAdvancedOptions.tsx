...
const getInstallScriptTooltip = (pkgType: PackageType) => {
  if (
    !isMobiusMaintainedPackageType(pkgType) &&
...
const getInstallHelpText = (pkgType: PackageType) => {
  if (pkgType === "exe") {
    return (
      <>
        For Windows, Mobius only creates install scripts for .msi packages. Use
...
const getUninstallHelpText = (pkgType: PackageType) => {
  if (isMobiusMaintainedPackageType(pkgType)) {
  ...
  if (pkgType === "exe") {
    return (
      <>
        For Windows, Mobius only creates uninstall scripts for .msi packages.
