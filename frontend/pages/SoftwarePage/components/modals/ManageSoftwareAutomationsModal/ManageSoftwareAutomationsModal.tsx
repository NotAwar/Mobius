      ...
      <>
        ...
        (zendeskIntegrationsIndexed &&
          ...
          <Dropdown
            ...
            helpText="For each new vulnerability detected, Mobius will create a ticket with a list of the affected hosts."
          />
        ) : (
    ...
    return (
      <>
        ...
        <InputField
          ...
          error={errors.url}
          helpText={
            "For each new vulnerability detected, Mobius will send a JSON payload to this URL with a list of the affected hosts."
          }
