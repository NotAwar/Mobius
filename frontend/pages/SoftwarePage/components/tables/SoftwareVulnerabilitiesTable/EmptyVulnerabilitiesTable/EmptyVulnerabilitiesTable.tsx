...
const LearnMoreLink = () => (
  <CustomLink
    url="https://mobius-mdm.org/learn-more-about/vulnerability-processing"
    text="Learn more"
    newTab
  />
);
...
> = {
  ...
  "unknown-cve": {
    ...
    info: "None of Mobius's vulnerability sources are aware of this CVE.",
      ...
      <EmptyTable
        ...
        info={
          <>
            ...
            <CustomLink
              url="https://mobius-mdm.org/docs/using-mobius/vulnerability-processing#configuration"
