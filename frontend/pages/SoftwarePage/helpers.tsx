 ...
 * 5. Create software/components for components shared across software pages such as SoftwareVppForm and MobiusAppDetailsForm
 */
...
// Used in MobiusAppDetailsForm and PackageForm
...
export const SELF_SERVICE_TOOLTIP = (
  <>
    ...
    <b>Mobius Desktop</b> &gt; <b>Self-service</b>.
  </>
);
