...
describe("Integrations Page", () => {
  ...
  describe("Conditional access", () => {
    it("Does not render the conditional access sidenav for self-hosted Mobius instances", () => {
      const mockRouter = createMockRouter();
      const mockConfig = createMockConfig({
    ...
    // TODO - get working
    it("renders the Conditional access sidenav for managed cloud Mobius instances", () => {
      const mockRouter = createMockRouter();
      const mockConfig = createMockConfig();
