...
const CREATING_SERVICE_ACCOUNT =
  "https://www.mobiusdm.com/learn-more-about/creating-service-accounts";
const GOOGLE_WORKSPACE_DOMAINS =
  "https://www.mobiusdm.com/learn-more-about/google-workspace-domains";
const DOMAIN_WIDE_DELEGATION =
  "https://www.mobiusdm.com/learn-more-about/domain-wide-delegation";
const ENABLING_CALENDAR_API =
  "https://www.mobiusdm.com/learn-more-about/enabling-calendar-api";
const OAUTH_SCOPES =
        ...
        <div className={`${baseClass}__section-instructions`}>
          ...
          <p>
            ...
            <ul>
              ...
              <li>
                Enter &quot;Mobius calendar events&quot; as the project name.
              </li>
              <li>
          ...
          <p>
            ...
            <ul>
              ...
              <li>
                Set the service account name to &quot;Mobius calendar
                events&quot;.
              </li>
              <li>
          ...
          <p className={`${baseClass}__configuration`}>
            5. Configure your service account integration in Mobius using the
            form below.
            <ul>
              <li>
          ...
          <p>
            ...
            <ul>
              ...
              <li>
                Make sure the &quot;Mobius calendar events&quot; project is
