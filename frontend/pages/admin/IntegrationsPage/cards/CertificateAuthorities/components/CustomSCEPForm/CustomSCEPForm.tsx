    ...
    <form onSubmit={onSubmitForm}>
      <div className={`${baseClass}__fields`}>
        <InputField
          ...
          helpText="Letters, numbers, and underscores only. Mobius will create configuration profile variables with the name as suffix (e.g. $MOBIUS_VAR_CUSTOM_SCEP_CHALLENGE_WIFI_CERTIFICATE)."
        />
        <InputField
          label="SCEP URL"
          name="scepURL"
