    ...
    <form className={baseClass} onSubmit={onSubmitForm}>
      <div className={`${baseClass}__fields`}>
        <InputField
          ...
          helpText="Letters, numbers, and underscores only. Mobius will create configuration profile variables with the name as suffix (e.g. $MOBIUS_VAR_DIGICERT_DATA_WIFI_CERTIFICATE)."
          parseTarget
        ...
        <InputField
          ...
          placeholder="$MOBIUS_VAR_HOST_HARDWARE_SERIAL"
        />
        <InputField
