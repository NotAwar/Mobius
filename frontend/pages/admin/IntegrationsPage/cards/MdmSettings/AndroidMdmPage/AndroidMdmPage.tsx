      ...
      if (
        ...
        renderFlash(
          ...
          <>
            ...
            Mobius server. For help, please contact{" "}
            <CustomLink
              text="Mobius support"
              url={SUPPORT_LINK}
              newTab
    ...
    <>
      <div className={`${baseClass}__turn-on-description`}>
        ...
        <CustomLink
          text="Learn More"
          newTab
          url="https://mobius-mdm.org/learn-more-about/how-to-connect-android-enterprise"
        />
      </div>
            ...
            tipContent={
              <>
                ...
                <CustomLink
                  ...
                  url="https://mobius-mdm.org/learn-more-about/google-admin-emm"
