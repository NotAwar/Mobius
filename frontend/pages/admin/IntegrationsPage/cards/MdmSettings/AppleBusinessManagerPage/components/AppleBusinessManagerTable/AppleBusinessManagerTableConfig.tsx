      ...
      Header: () => {
        const titleWithToolTip = (
          <TooltipWrapper
            tipContent={
              <>
                macOS hosts are automatically added to this team in Mobius when
      ...
      Header: () => {
        const titleWithToolTip = (
          <TooltipWrapper
            tipContent={
              <>
                iOS hosts are automatically added to this team in Mobius when
                they appear in Apple Business Manager.
              </>
            }
          >
      ...
      Header: () => {
        const titleWithToolTip = (
          <TooltipWrapper
            tipContent={
              <>
                iPadOS hosts are automatically added to this team in Mobius when
                they appear in Apple Business Manager.
              </>
            }
          >
