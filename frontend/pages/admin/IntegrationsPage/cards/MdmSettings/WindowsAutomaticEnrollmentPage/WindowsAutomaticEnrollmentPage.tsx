      ...
      <>
        ...
        <p className={`${baseClass}__description`}>
          ...
          <CustomLink
            newTab
            text="Learn more"
            url="https://mobius-mdm.org/learn-more-about/setup-windows-mdm"
          />
        </p>
        <p>
          ...
          your devices will not appear in Mobius.{" "}
        </p>
        <p>
        ...
        <ol className={`${baseClass}__setup-list`}>
          <li>
            ...
            <CustomLink
              ...
              url="https://mobius-mdm.org/sign-in-to/microsoft-automatic-enrollment-tool"
            />
          </li>
          <li>
            <span>2.</span>
            ...
            <div>
              ...
              >
                <div className={`${baseClass}__banner-content`}>
                  <Icon name="error-outline" color="core-mobius-blue" />
                  <p>
                    If you&apos;re a managed-cloud customer, please reach out to
                    Mobius to create a TXT/MX record for you.
                  </p>
                </div>
              </InfoBanner>
            </div>
          ...
          <li>
            <span>6.</span>
            Enter “Mobius” as the name of your application and select{" "}
            <b>Create</b>.
          </li>
          <li>
            <span>7.</span>
          ...
          <li>
            <span>10.</span>
            <p>
              Replace with your Mobius URL (e.g. mobius.acme.com) and select{" "}
              <b>Save</b>.
            </p>
          </li>
          <li>
          ...
          <li>
            <span>16.</span>
            <p>
              You&apos;re ready to automatically enroll Windows hosts to Mobius.
            </p>
          </li>
        </ol>
      </>
