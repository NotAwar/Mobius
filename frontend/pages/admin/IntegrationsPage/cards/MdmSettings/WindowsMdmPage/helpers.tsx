...
import { MOBIUS_GUIDES_BASE_LINK } from "utilities/constants";
...
export const getErrorMessage = (err: unknown) => {
  ...
  if (message) {
    return (
      <>
        Couldn&apos;t turn on Windows MDM. Please configure Mobius with a
        certificate and key pair first.{" "}
        <CustomLink
          url={`${MOBIUS_GUIDES_BASE_LINK}/windows-mdm-setup#step-1-generate-your-certificate-and-key`}
          text="Learn more"
          newTab
