...
const VOLUNTARY_MODE_DESCRIPTION =
  "The end user sees the above window when they select Migrate to Mobius in the Mobius Desktop menu. If they’re unenrolled from your old MDM, the window appears every 15-20 minutes.";
