...
const IdpSection = () => {
  ...
  return (
    <div className={baseClass}>
      ...
      <form>
        <p>
          Connect Mobius to your identity provider to require end users to
          authenticate when they first setup their new macOS hosts.{" "}
          <CustomLink
            url="https://mobius-mdm.org/learn-more-about/end-user-authentication"
            text="Learn more"
            newTab
          />
        </p>
        ...
        >
          ...
          <InputField
            ...
            tooltip="The required entity ID is a URI that you use to identify Mobius when configuring the identity provider."
          />
          <InputField
            label="Metadata URL"
            helpText={
