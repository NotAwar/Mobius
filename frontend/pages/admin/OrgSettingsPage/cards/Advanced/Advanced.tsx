                  ...
                  labelTooltipContent={
                    !disableChildren && (
                      <>
                        ...
                        <br />
                        (ad hoc queries executed via the UI or MobiusCLI).{" "}
                        <em>
                          (Default: <strong>Off</strong>)
                        </em>
                      </>
            ...
            <GitOpsModeTooltipWrapper
              ...
              renderChildren={(disableChildren) => (
                <Checkbox
                  ...
                  helpText="If enabled, only policy queries (SQL) are sent to the LLM. Mobius doesn’t use this data to train models."
                >
            ...
            <GitOpsModeTooltipWrapper
              ...
              renderChildren={(disableChildren) => (
                <Checkbox
                    ...
                    !disableChildren && (
                      <>
                        <>
                          ...
                          <br />
                          Mobius and will delete existing reports. This can also
                          be <br />
                  ...
                  helpText="Enabling this setting will delete all existing query reports in Mobius."
                >
