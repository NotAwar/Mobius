...
const Info = ({
  ...
  const [formData, setFormData] = useState<IOrgInfoFormData>({
    ...
    orgSupportURL:
      appConfig.org_info.contact_url || "https://mobius-mdm.org/company/contact",
  });
        ...
        <form onSubmit={onFormSubmit} autoComplete="off">
          ...
          >
            <p className={`${baseClass}__section-description`}>
              ...
              <CustomLink
                url="https://mobius-mdm.org/learn-more-about/organization-logo-size"
              ...
              <InputField
                ...
                tooltip={
                  <>
                    ...
                    <br />
                    areas of Mobius that have dark backgrounds.
                  </>
                }
              />
              <div
            ...
            <div className={`${cardClass}__logo-field-set`}>
              <InputField
                ...
                inputWrapperClass={`${cardClass}__logo-field`}
                tooltip="Logo is displayed in Mobius on top of light backgrounds.
"
              />
              <div
