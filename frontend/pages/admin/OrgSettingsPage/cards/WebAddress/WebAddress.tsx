...
const validateFormData = ({ serverURL }: IWebAddressFormData) => {
  ...
  if (!serverURL) {
    errors.server_url = "Mobius server URL must be present";
  } else if (
    !validUrl({
      url: serverURL,
  ...
  return (
    <div className={baseClass}>
      <div className={`${baseClass}__section`}>
        <SectionHeader title="Mobius web address" />
        <form onSubmit={onFormSubmit} autoComplete="off">
          <InputField
            label="Mobius app URL"
            helpText={
              <>
            ...
            tooltip="The base URL of this instance for use in Mobius links."
