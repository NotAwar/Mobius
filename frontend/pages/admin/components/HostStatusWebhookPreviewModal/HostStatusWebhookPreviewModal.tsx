...
const getHostStatusPreview = (teamScope?: boolean) => {
  ...
  return {
    text:
      "More than X% of your hosts have not checked into Mobius for more than Y days. You’ve been sent this message because the Host status webhook is enabled in your Mobius instance.",
    data,
  };
};
