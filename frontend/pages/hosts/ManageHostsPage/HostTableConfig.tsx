...
const allHostTableHeaders: IHostTableColumnConfig[] = [
          ...
          <>
            ...
            >
              <span className={`tooltip__tooltip-text`}>
                ...
                vitals when it is enrolled in Mobius <br />
              </span>
            </ReactTooltip>
          </>
        );
  ...
  },
  {
    ...
    Header: (cellProps: IHostTableHeaderProps) => (
      <HeaderCell
        value={
          <TooltipWrapper tipContent="The IP address the host uses to connect to Mobius.">
            Public IP address
          </TooltipWrapper>
        }
        isSortedDesc={cellProps.column.isSortedDesc}
  ...
  },
  {
    ...
    Cell: (cellProps: IHostTableStringCellProps) => (
      ...
      <TextCell
        ...
        formatter={HumanTimeDiffWithMobiusLaunchCutoff}
      />
    ),
  },
  {
 ...
 * permissions and license tier of mobius they are on.
 */
