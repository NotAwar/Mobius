...
const ManageHostsPage = ({
  ...
  const renderAddHostsModal = () => {
    ...
    return (
      <AddHostsModal
        currentTeamName={currentTeamName || "Mobius"}
      ...
      <>
        ...
        {!!totalFilteredHostsCount && (
          ...
          >
            <>
              Export hosts
              <Icon name="download" size="small" color="core-mobius-blue" />
            </>
          </Button>
        )}
      </>
    ...
    if (maybeEmptyHosts) {
      const emptyState = () => {
        const emptyHosts: IEmptyTableProps = {
          ...
          header: "Hosts will show up here once they’re added to Mobius",
          info:
        ...
        if (includesFilterQueryParam) {
          ...
          emptyHosts.header = "Add your hosts to Mobius";
          emptyHosts.info =
            "Generate Mobius's agent (mobiusdaemon) to add your own hosts.";
        ...
        >
          <div>
            <span>
              ...
              to <b>{isAnyTeamSelected ? currentTeamName : "Mobius"}</b>.
            </span>
          </div>
        </InfoBanner>
      )
