...
describe("Host Actions Dropdown", () => {
  ...
  describe("Turn off MDM action", () => {
    ...
    it("does not render the action when the host is enrolled in a non Mobius MDM solution", async () => {
      const render = createCustomRenderer({
        context: {
          app: {
            isMacMdmEnabledAndConfigured: true,
  ...
  describe("Lock action", () => {
    ...
    it("renders as disabled with a tooltip when scripts_enabled is set to false for windows/linux", async () => {
      ...
      await waitFor(() => {
        ...
        expect(
          screen.getByText(/mobiusdaemon agent with --enable-scripts/i)
        ).toBeInTheDocument();
      });
    });
    ...
    it("does not render when the host is not enrolled in a Mobius MDM solution", async () => {
      const render = createCustomRenderer({
        context: {
          app: {
            isPremiumTier: true,
  ...
  describe("Unlock action", () => {
    ...
    it("does not renders when a macOS host but does not have Mobius mac mdm enabled and configured", async () => {
      const render = createCustomRenderer({
        context: {
          app: {
            isPremiumTier: true,
  ...
  describe("Wipe action", () => {
    ...
    it("does not renders when a windows host but does not have Mobius windows mdm enabled and configured", async () => {
      const render = createCustomRenderer({
        context: {
          app: {
            isPremiumTier: true,
    ...
    it("does not render for a macOS host if Mobius Apple MDM is not enabled and configured", async () => {
      const render = createCustomRenderer({
        context: {
          app: {
            isPremiumTier: true,
  ...
  describe("Run script action", () => {
    ...
    it("renders the Run script action as enabled when `scripts_enabled` is `null`", async () => {
      ...
      await waitFor(() => {
        ...
        expect(
          screen.queryByText(/mobiusdaemon agent with --enable-scripts/i)
        ).toBeNull();
      });
    });
