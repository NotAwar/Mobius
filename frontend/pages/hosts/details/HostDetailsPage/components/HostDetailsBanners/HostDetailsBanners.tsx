...
export interface IHostBannersBaseProps {
  ...
  /** Whether or not Mobius has escrowed the host's disk encryption key */
...
const HostDetailsBanners = ({
  ...
  const isMobiusLicenseExpired = hasLicenseExpired(
  ...
  if (
    ...
    if (!diskEncryptionKeyAvailable) {
      // linux host's disk is encrypted, but Mobius doesn't yet have a disk
