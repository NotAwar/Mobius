...
export const DEVICE_STATUS_TAGS: DeviceStatusTagConfig = {
  ...
  unlocking: {
    ...
    tagType: "warning",
    generateTooltip: () =>
      "Host will unlock when it comes online.  If the host is online, it will unlock the next time it checks in to Mobius.",
  },
  locking: {
    title: "LOCK PENDING",
    tagType: "warning",
    generateTooltip: () =>
      "Host will lock when it comes online.  If the host is online, it will lock the next time it checks in to Mobius.",
  },
  wiped: {
    title: "WIPED",
    tagType: "error",
    generateTooltip: (platform) =>
      isAppleDevice(platform)
        ? "Host is wiped. To prevent the host from automatically reenrolling to Mobius, first release the host from Apple Business Manager and then delete the host in Mobius."
        : "Host is wiped.",
  },
  wiping: {
    title: "WIPE PENDING",
    tagType: "error",
    generateTooltip: () =>
      "Host will wipe when it comes online. If the host is online, it will wipe the next time it checks in to Mobius.",
  },
};
