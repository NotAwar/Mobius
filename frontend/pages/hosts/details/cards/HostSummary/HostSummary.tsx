...
const getHostDiskEncryptionTooltipMessage = (
  ...
  if (platform === "chrome") {
    return "Mobius does not check for disk encryption on Chromebooks, as they are encrypted by default.";
  }
        ...
        value={
          <>
            {!osVersionRequirementMet && (
              <Icon name="error-outline" color="ui-mobius-black-75" />
            )}
            <TooltipWrapper
              tipContent={
                osVersionRequirementMet ? (
            ...
            <TooltipWrapper
              tipContent={
                <>
                  ...
                  {summaryData.mobius_desktop_version !==
                    DEFAULT_EMPTY_CELL_VALUE && (
                    <>
                      <br />
                      Mobius Desktop: {summaryData.mobius_desktop_version}
                    </>
                  )}
                </>
              }
  ...
  return (
    ...
    >
      ...
      {!isIosOrIpadosHost && (
        <DataSet
          title="Memory"
          value={wrapMobiusHelper(humanHostMemory, summaryData.memory)}
        />
      )}
      {!isIosOrIpadosHost && (
