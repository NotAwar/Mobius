...
const ManagePolicyPage = ({
  ...
  const getAutomationsDropdownOptions = (configPresent: boolean) => {
    ...
    if (!isPremiumTier) {
      disabledInstallTooltipContent = "Available in Mobius Pro";
      disabledCalendarTooltipContent = "Available in Mobius Pro";
      disabledRunScriptTooltipContent = "Available in Mobius Pro";
      disabledConditionalAccessTooltipContent = "Available in Mobius Pro";
