    ...
    return (
      <>
        <InputField
          ...
          error={errors.url}
          helpText='For each policy, Mobius will send a JSON payload to this URL with a list of the hosts that updated their answer to "No."'
      ...
      <>
        <div className={`${baseClass}__integrations`}>
          <Dropdown
            ...
            hint={
              "For each policy, Mobius will create a ticket with a list of the failing hosts."
            }
          />
        </div>
        <RevealButton
            ...
            <PoliciesPaginatedList
              ...
              helpText={
                <>
                  ...
                  <CustomLink
                    url="https://www.mobiusdm.com/learn-more-about/policy-automations"
                    text="Learn more"
                    newTab
