...
const EditQueryPage = ({
  ...
  */
  ...
  const detectIsMobiusQueryRunnable = () => {
 ...
 reroute edit existing query page (/:queryId/edit) to query report page (/:queryId) */
  ...
  useEffect(() => {
    // e.g., Editing Discover TLS certificates | Queries | Mobius
  ...
  const renderLiveQueryWarning = (): JSX.Element | null => {
    ...
    return (
      <InfoBanner color="yellow">
        Mobius is unable to run a live query. Refresh the page or log in again.
        If this keeps happening please{" "}
        <CustomLink
          url="https://github.com/mobiusdm/mobius/issues/new/choose"
          text="file an issue"
          newTab
        />
      </InfoBanner>
