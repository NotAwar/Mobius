...
import Mobius403 from "pages/errors/Mobius403";
import Mobius404 from "pages/errors/Mobius404";
...
import SoftwareMobiusMaintained from "pages/SoftwarePage/SoftwareAddPage/SoftwareMobiusMaintained";
...
const routes = (
  <Router history={browserHistory}>
        ...
        <Route component={CoreLayout}>
          ...
          <Route path="software">
            ...
            <Route path="add" component={SoftwareAddPage}>
              <IndexRedirect to="mobius-maintained" />
              <Route
                path="mobius-maintained"
                component={SoftwareMobiusMaintained}
              />
              <Route path="app-store" component={SoftwareAppStore} />
              <Route path="package" component={SoftwareCustomPackage} />
            </Route>
            <Route
              path="add/mobius-maintained/:id"
              component={MobiusMaintainedAppDetailsPage}
            />
    ...
    <Route path="/404" component={Mobius404} />
    <Route path="/403" component={Mobius403} />
    <Route path="*" component={Mobius404} />
  </Router>
);
