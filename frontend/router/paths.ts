...
export default {
  ...
  // Portal pages
  PORTALS: `${URL_PREFIX}/portals`,
  INTERNAL_PORTAL: `${URL_PREFIX}/internal-portal`,
  USER_PORTAL: `${URL_PREFIX}/user-portal`,
  ...
  ADMIN_ORGANIZATION_MOBIUS_DESKTOP: `${URL_PREFIX}/settings/organization/mobius-desktop`,
  ...
  SOFTWARE_ADD_MOBIUS_MAINTAINED: `${URL_PREFIX}/software/add/mobius-maintained`,
  SOFTWARE_MOBIUS_MAINTAINED_DETAILS: (id: number) =>
    `${URL_PREFIX}/software/add/mobius-maintained/${id}`,
  ...
  // error pages
  MOBIUS_403: `${URL_PREFIX}/403`,
  MOBIUS_404: `${URL_PREFIX}/404`,
  MOBIUS_500: `${URL_PREFIX}/500`,
