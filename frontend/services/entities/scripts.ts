 ...
 *
 * https://github.com/mobiusdm/mobius/blob/main/docs/Contributing/reference/api-for-contributors.md#run-script-asynchronously
 */
...
export interface IScriptBatchSupportedFilters {
  // a search string, not a Mobius.Query
  query?: string;
  label_id?: number;
  team_id?: number;
