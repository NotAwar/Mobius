...
export const DEFAULT_GRAVATAR_LINK =
  "https://mobius-mdm.org/images/permanent/icon-avatar-default-transparent-64x64%402x.png";

export const DEFAULT_GRAVATAR_LINK_DARK =
  "https://mobius-mdm.org/images/permanent/icon-avatar-default-dark-24x24%402x.png";
...
export const GITHUB_NEW_ISSUE_LINK =
  "https://github.com/mobiusdm/mobius/issues/new?assignees=&labels=bug%2C%3Areproduce&template=bug-report.md";

/** website links */
export const MOBIUS_WEBSITE_URL = "https://mobius-mdm.org";
export const TRANSPARENCY_LINK = `${MOBIUS_WEBSITE_URL}/better`;
export const SUPPORT_LINK = `${MOBIUS_WEBSITE_URL}/support`;
export const CONTACT_MOBIUS_LINK = `${MOBIUS_WEBSITE_URL}/contact`;
export const LEARN_MORE_ABOUT_BASE_LINK = `${MOBIUS_WEBSITE_URL}/learn-more-about`;
export const MOBIUS_GUIDES_BASE_LINK = `${MOBIUS_WEBSITE_URL}/guides`;

/**  July 28, 2016 is the date of the initial commit to mobius/mobius. */
export const INITIAL_MOBIUS_DATE = "2016-07-28T00:00:00Z";
...
export const MDM_STATUS_TOOLTIP: Record<string, string | React.ReactNode> = {
  ...
  "On (manual)": (
    <span>
      ...
      with mobiusdaemon (Windows). End users can turn MDM off.
    </span>
  ),
  ...
  Pending: (
    <span>
      ...
      automatically enroll to Mobius <br /> and turn on MDM when they&apos;re
      unboxed.
    </span>
  ),
};
...
export const DOCUMENT_TITLE_SUFFIX = "Mobius";
