...
This page covers what all contributors (mobiusies or not) need to know in order to contribute changes to [the core product](https://mobiusmdm.com/docs).

When creating software, handoffs between teams or contributors are one of the most common sources of miscommunication and waste.  Like [GitLab](https://docs.google.com/document/d/1RxqS2nR5K0vN6DbgaBw7SEgpPLi0Kr9jXNGzpORT-OY/edit#heading=h.7sfw1n9c1i2t), Mobius uses product groups to minimize handoffs and maximize iteration and efficiency in the way we build the product.

> - Write down philosophies and show how the pieces of the development process fit together on this "🛩️ Product groups" page.
> - Use the dedicated [departmental](https://mobiusmdm.com/handbook/company#org-chart) handbook pages for [🚀 Engineering](https://mobiusmdm.com/handbook/engineering) and [🦢 Product Design](https://mobiusmdm.com/handbook/product) to keep track of specific, rote responsibilities and recurring rituals designed to be read and used only by people within those departments.

## Product roadmap

Mobius team members can read [Mobius's high-level product goals for the current quarter](https://docs.google.com/spreadsheets/d/1Hso0LxqwrRVINCyW_n436bNHmoqhoLhC8bcbvLPOs9A/edit?usp=sharing) (confidential Google Sheet).

## What are product groups?

Mobius organizes product development efforts into separate, cross-functional product groups that include product designers, developers, and quality engineers.  These product groups are organized by business goal, and designed to operate in parallel.
...
At Mobius, [anyone can contribute](https://mobiusmdm.com/handbook/company#openness), even across product groups.

> Ideas expressed in wireframes, like code contributions, [are welcome from everyone](https://chat.osquery.io/c/mobius), inside or outside the company.

## Current product groups

| Product group                            | Goal _(value for customers and/or community)_                                                                          | Capacity |
|:-----------------------------------------|:-----------------------------------------------------------------------------------------------------------------------|:---------|
| [MDM](#mdm-group)                        | Increase and exceed maturity in the [device management](https://mobiusmdm.com/device-management) product category.       | 104      |
| [Orchestration](#orchestration-group)    | Increase and exceed maturity in the [orchestration](https://mobiusmdm.com/orchestration) product category.               | 117      |
| [Software](#software-group)              | Increase and exceed maturity in the [software management](https://mobiusmdm.com/software-management) product category.   | 104      |

\* The number of [estimated story points](https://mobiusmdm.com/handbook/company/communications#estimation-points) this group can take on per-sprint under ideal circumstances, used as a baseline number for planning and prioritizing user stories for drafting. In reality, capacity will vary as engineers are on-call, out-of-office, filling in for other product groups, etc.

### MDM group

The goal of the MDM group is to increase and exceed [Mobius's product maturity goals](https://mobiusmdm.com/device-management) in the "MDM" product category.
...
> The [Slack channel](https://mobiusmdm.slack.com/archives/C03C41L5YEL), [kanban release board](https://github.com/orgs/mobiusmdm/projects/58), and [GitHub label](https://github.com/notawar/mobius/issues?q=is%3Aopen+is%3Aissue+label%3A%23g-mdm) for this product group is `#g-mdm`.

### Orchestration group

The goal of the orchestration group is to increase and exceed [Mobius's product maturity goals in the orchestration category](https://mobiusmdm.com/orchestration).
...
> The [Slack channel](https://mobiusmdm.slack.com/archives/C084F4MKYSJ), [kanban release board](https://github.com/orgs/mobiusmdm/projects/71), and [GitHub label](https://github.com/notawar/mobius/labels/%23g-orchestration) for this product group is `#g-orchestration`.

### Software group

The goal of the software group is to increase and exceed [Mobius's product maturity goals in the software management category](https://mobiusmdm.com/software-management).
...
> The [Slack channel](https://mobiusmdm.slack.com/archives/C086V2QK76X), [kanban release board](https://github.com/orgs/mobiusmdm/projects/70), and [GitHub label](https://github.com/notawar/mobius/labels?q=%23g-software](https://github.com/notawar/mobius/labels/%23g-software)) for this product group is `#g-software`.

## Making changes

Mobius's highest product ambition is to create experiences that users want.

To deliver on this mission, we need a clear, repeatable process for turning an idea into a set of cohesively-designed changes in the product. We also need to allow [open source contributions](https://mobiusmdm.com/handbook/company#open-source) at any point in the process from the wider Mobius community - these won't necessarily follow this process.

> Learn more about Mobius's philosophy and process for making interface changes to the product, and [why we use a wireframe-first approach](https://mobiusmdm.com/handbook/company/why-this-way#why-do-we-use-a-wireframe-first-approach).

To make a change to Mobius:

- First, [write it down](https://github.com/notawar/mobius/issues/new?assignees=&labels=~feature+fest%2C%3Aproduct&projects=&template=feature-request.md&title=)
...
- Then, it will be looked at by Mobius's [Head of Product Design](https://mobiusmdm.com/handbook/product-design#team) and a SME [unpack the "why"](https://mobiusmdm.com/handbook/product-design#inbox-review).
  - For customer/prospect requests to be looked at, they must have a Gong snippet.
- Then, it will be [prioritized](https://mobiusmdm.com/handbook/company/product-groups#feature-fest) and written up as one or more user stories.
- Then, it will be [drafted](https://mobiusmdm.com/handbook/company/product-groups#drafting) (planned).
- Next, it will be [implemented](https://mobiusmdm.com/handbook/company/product-groups#implementing) and [released](https://mobiusmdm.com/handbook/engineering#release-process).

> Occasionally, a contributor outside of the [product groups](https://mobiusmdm.com/handbook/product-groups#current-product-groups) (open source contributor, member of the Customer Success team, etc.) will implement a change that was prioritized and drafted. On the user story for these changes, add the product group label (e.g. `#g-mdm`, `#g-orchestration`, `#g-software`), the `:release` label, and notify the product group's Engineer Manager to make sure the changes go through testing (QA) before release.

### Planned and unplanned changes

Most changes to Mobius are planned changes. They are [prioritized](https://mobiusmdm.com/handbook/product), defined, designed, revised, estimated, and scheduled into a release sprint _prior to starting implementation_.  The process of going from a prioritized goal to an estimated, scheduled, committed user story with a target release is called "drafting", or "the drafting phase".
...
Whenever a PR is proposed for making changes to our [tables' schema](https://mobiusmdm.com/tables/screenlock)(e.g. to schema/tables/screenlock.yml), it also has to be reflected in our osquery_mobius_schema.json file.

The website team will [periodically](https://mobiusmdm.com/handbook/marketing/website-handbook#rituals) update the json file with the latest changes. If the changes should be deployed sooner, you can generate the new json file yourself by running these commands:
...
> If a table is added to our ChromeOS extension but it does not exist in osquery or if it is a table added by mobiusdaemon, add a note that mentions it, as in this [example](https://github.com/notawar/mobius/blob/e95e075e77b683167e86d50960e3dc17045e3c44/schema/tables/mdm.yml#L2).
...
- [ ] User story [issue created](https://github.com/notawar/mobius/issues/new/choose)
- [ ] [Product group](https://mobiusmdm.com/handbook/company/product-groups) label added (e.g. `#g-mdm`, `#g-orchestration`, `#g-software`)
- [ ] Changes [specified](https://mobiusmdm.com/handbook/company/development-groups#drafting) and [designed](https://mobiusmdm.com/handbook/company/why-this-way#why-do-we-use-a-wireframe-first-approach)
...
- [ ] [Estimated](https://mobiusmdm.com/handbook/company/why-this-way#why-scrum)
- [ ] [Scheduled](https://mobiusmdm.com/handbook/company/why-this-way#why-a-three-week-cadence) for development
...
When the Product Designer has completed the product checklist, it is moved to the "User story review" column of the drafting board and reviewed during the [weekly user story review](https://mobiusmdm.com/handbook/company/product-groups#user-story-reviews) rituals.
...
This section is optional and hidden by default.  It can be included or omitted, as time allows.  As Mobius grows as an all-remote company with more asynchronous processes across timezones, we will rely on this section more and more.
...
- Why create this user story?  Why should Mobius work on it?
- Why now?  Why prioritize this user story today?
- What is the business case?  How does this contribute to reaching Mobius's strategic goals?
- What's the problem?
...
1. [Create a new air guitar issue](https://github.com/notawar/mobius/issues/new?template=air-guitar.md). Air guitar issues are always intended to be designed right away. If they can't be, the Head of Product Design notifies the requestor (normally a CSM or AE) via at-mention in the issue.

> An air guitar session may be used to design features that won't be shipped.

2. If the air guitar is prioritized, it's assigned to a Product Designer who brings it through the [drafting process](https://mobiusmdm.com/handbook/company/product-groups#drafting). However, keep in mind that these are conceptual and may or may not proceed to engineering.
...
[Estimation points](https://mobiusmdm.com/handbook/company/communications#estimation-points) are used if a task has already gone through drafting.
...
Please read carefully and [pay special attention](https://mobiusmdm.com/handbook/company/why-this-way#why-do-we-use-a-wireframe-first-approach) to UI wireframes.

While Product Designers are responsible for wireframing significant UI changes at Mobius's breakpoints (see [breakpoints in the user story template](https://github.com/notawar/mobius/blob/main/.github/ISSUE_TEMPLATE/story.md)), Mobius relies on Engineers to fill in the gaps and fluidly include all screen widths. If you discovered a gap, please bring the proposed changes as a live prototype to your product group's next design review.
...
Communicate. Leave a comment [mentioning the appropriate PM](https://mobiusmdm.com/handbook/company/product-groups#current-product-groups) so they can update the user story and estimation to reflect your new understanding of the issue.

**For all other concerns...**

At Mobius, we prioritize [iteration](https://mobiusmdm.com/handbook/company#results). So before raising the alarm, think through the following:
...
After these considerations, if you still think you've found a blocker, alert the [appropriate PM](https://mobiusmdm.com/handbook/company/product-groups#current-product-groups) so that the user story can be brought back for [expedited drafting](https://mobiusmdm.com/handbook/product#expedited-drafting). Otherwise, make a [feature request](https://mobiusmdm.com/handbook/product#intake).
...
At Mobius, we consider an outage to be a situation where new features or previously stable features are broken or unusable.
...
- Mobius encourages embracing the inevitability of mistakes and discourages blame games.
- Mobius stresses the critical importance of avoiding outages because they make customers' lives worse instead of better.

## Scaling Mobius

Mobius, as a Go server, scales horizontally very well. It’s not very CPU or memory intensive. However, there are some specific gotchas to be aware of when implementing new features. Visit our [scaling Mobius page](https://mobiusmdm.com/handbook/engineering/scaling-mobius) for tips on scaling Mobius as efficiently and effectively as possible.

## Load testing

The [load testing page](https://mobiusmdm.com/handbook/engineering/load-testing) outlines the process we use to load test Mobius, and contains the results of our semi-annual load test.

## Version support

To provide the most accurate and efficient support, Mobius will only target fixes based on the latest released version. In the current version fixes, Mobius will not backport to older releases.
...
When a critical bug is found, the Mobiusie who labels the bug as critical is responsible for following the [critical bug notification process](https://mobiusmdm.com/handbook/company/product-groups#notify-the-community-about-a-critical-bug) below.

All unreleased bugs are addressed before publishing a release. Released bugs that are not critical may be addressed during the next release per the standard [bug process](https://github.com/notawar/mobius/blob/main/docs/Contributing/guides/releasing-mobius.md#bug-process).

- **Release blockers:** Product may add the `~release blocker` label to user stories to indicate that the story must be completed to publish the next version of Mobius. Bugs are never labeled as release blockers.
...
If the bug finder is not a Mobiusie (e.g., a member of the community), then whoever sees the critical bug should raise the alarm. Note that the bug finder here is NOT necessarily the **first** person who sees the bug. If you come across a bug you think is critical, but it has not been escalated, raise the alarm!
...
Once the critical bug is confirmed, a [priority label](https://mobiusmdm.com/handbook/company/communications#high-priority-user-stories-and-bugs) is applied and the priority response process begins. Customer Success notifies impacted customers and the community if community features are impacted. If Customer Success is not available, the on-call engineer or infrastructure on-call engineer is responsible for this. If a quick fix workaround exists, that should be communicated as well for those who are already upgraded.

The relevant release page on GitHub is updated to indicate that the release contains a critical bug, as shown on the [mobius-v4.45.0 release page](https://github.com/notawar/mobius/releases/tag/mobius-v4.45.0).

When a critical bug is identified, we will then follow the patch release process in [our documentation](https://github.com/notawar/mobius/blob/main/docs/Contributing/guides/releasing-mobius.md#patch-releases).

> After a critical bug is fixed, [an incident postmortem](https://mobiusmdm.com/handbook/engineering#perform-an-incident-postmortem) is scheduled by the EM of the product group that fixed the bug.

## Feature fest

To stay in-sync with our customers' needs, Mobius accepts feature requests from customers and community members on a sprint-by-sprint basis.

Features that meet a [criteria for prioritization](#criteria-for-prioritization) are prioritized at the 🎁🗣 Feature Fest meeting.

Anyone in the company is invited to submit requests or simply listen in on the 🎁🗣 Feature Fest meeting. Folks from the wider community can also [request an invite](https://mobiusmdm.com/contact).

### Making a request

To make a feature request or advocate for a feature request from a customer or community member, [create an issue](https://github.com/notawar/mobius/issues/new/choose) using the feature request template. If you found that an issue already exists, add the `:product` label to it.

New requests are reviewed daily by the Head of Product Design and a former IT admin during the ["Unpacking the why"](https://mobiusmdm.com/handbook/product-design#unpacking-the-why) call. If the request meets the [criteria for prioritization](#criteria-for-prioritization), the request will be added to the upcoming feature fest (`~feature fest` label). If it doesn't, the request will be put to the side and the requester will be notified.
...
3. Contributes to Mobius's Product roadmap (see [🎯 Key results (OKRs) spreadsheet](https://docs.google.com/spreadsheets/d/1Hso0LxqwrRVINCyW_n436bNHmoqhoLhC8bcbvLPOs9A/edit?gid=1846478041#gid=1846478041))
4. Core: a feature that accentuates and directly assists in the core purpose of the company: to guide people out of the thicket through the gift of openness. It's what differentiates us. [How Mobius defined "core"](https://docs.google.com/document/d/1Vr0F218Acr69eAgaD38zsyUUQ3Ik9HDEAlitT911BzU/edit?tab=t.0#heading=h.axp63q5pht7).
...
If an issue has the `:product` and `story` label, then it's a user story that is currently in progress ([drafting](https://mobiusmdm.com/handbook/company/development-groups#drafting)). The user story will include a link to the original feature request issue.

### How feature requests are prioritized

Prioritization of new feature requests happens at the 🎁🗣 Feature Fest meeting.

Before the 🎁🗣 Feature Fest meeting, the [Customer renewals DRI](https://mobiusmdm.com/handbook/company/communications#directly-responsible-individuals-dris) adds customer requests to the 🎁🗣 Feature Fest board (`~feature fest` label) that are a high priority.

Before the meeting, the Feature prioritization DRI adds requests from Mobius's roadmap that contribute to Mobius's [quarterly key results (KRs)](https://docs.google.com/spreadsheets/d/1Hso0LxqwrRVINCyW_n436bNHmoqhoLhC8bcbvLPOs9A/edit?gid=1846478041#gid=1846478041&range=A1).
...
- Prioritized features: Remove the `~feature fest` label, add the `~customer request` label, create a new user story with the `:product` label, add a link from the original request to the user story, add the relevant `customer-` labels, and move the user story to the "Ready" column in the drafting board. The user story will then be assigned to a [Product Designer](https://mobiusmdm.com/handbook/company/product-groups#current-product-groups) during the "Design sprint kick-off" ritual.
...
A story may be de-prioritized when its relative priority falls below new requests and there is not enough room in the upcoming engineering sprint. Since Mobius does not maintain a feature backlog, a story is only prioritized if it seems like it can be shipped in the upcoming 3 week engineering sprint. The relative priority of a story and engineering capacity may change over the course of a design sprint.
...
Mobius uses a human-oriented quality assurance (QA) process to make sure the product meets the standards of users and organizations. Automated tests are important, but they can't catch everything. Many issues are hard to notice until a human looks empathetically at the user experience, whether in the user interface, the REST API, or the command line.

You can read our guide to diagnosing issues in Mobius on the [debugging page](https://mobiusmdm.com/handbook/engineering/debugging). All bugs in Mobius are tracked by QA as [GitHub issues with the "bug" label](https://github.com/notawar/mobius/issues?q=is%3Aopen+is%3Aissue+label%3Abug).

- **Bug states:** The lifecycle stages of a bug at Mobius correspond to a set of GitHub labels, assignees, and boards.
  - [Inbox](https://mobiusmdm.com/handbook/company/product-groups#inbox)
  - [Reproduced](https://mobiusmdm.com/handbook/company/product-groups#reproduced)
  - [In product drafting](https://mobiusmdm.com/handbook/company/product-groups#in-product-drafting)
  - [In engineering](https://mobiusmdm.com/handbook/company/product-groups#in-engineering)
  - [Awaiting QA](https://mobiusmdm.com/handbook/company/product-groups#awaiting-qa)

### All bugs

- [See on GitHub](https://github.com/notawar/mobius/issues?q=is%3Aissue+is%3Aopen+label%3Abug).

- **Bugs opened this week:** This filter returns all "bug" issues opened after the specified date. Simply replace the date with a YYYY-MM-DD equal to one week ago. [See on GitHub](https://github.com/notawar/mobius/issues?q=is%3Aissue+archived%3Afalse+label%3Abug+created%3A%3E%3DREPLACE_ME_YYYY-MM-DD).

- **Bugs closed this week:** This filter returns all "bug" issues closed after the specified date. Simply replace the date with a YYYY-MM-DD equal to one week ago. [See on Github](https://github.com/notawar/mobius/issues?q=is%3Aissue+archived%3Afalse+is%3Aclosed+label%3Abug+closed%3A%3E%3DREPLACE_ME_YYYY-MM-DD).

#### Inbox

Quickly reproducing bug reports is a [priority for Mobius](https://mobiusmdm.com/handbook/company/why-this-way#why-make-it-obvious-when-stuff-breaks). When a new bug is created using the [bug report form](https://github.com/notawar/mobius/issues/new?assignees=&labels=bug%2C%3Areproduce&template=bug-report.md&title=), it is in the "inbox" state.
...
3. The `~released bug` label if the bug is in a published version of Mobius, or `~unreleased bug` if it is not yet published.
...
> **Fast track for Mobiusies:** Mobiusies do not have to wait for QA to reproduce the bug. If you've reproduced it outside of the customer's environment, have provided well documented reproduction steps, and it's a bug, it can be moved directly to the reproduced state.
...
If a bug meets the criteria for a [critical bug](https://mobiusmdm.com/handbook/company/product-groups#release-testing), the `~critical bug` label is added, and product design follows the [critical bug notification process](https://mobiusmdm.com/handbook/company/product-groups#notify-the-community-about-a-critical-bug).
...
All PRs from the community are routed through the on-call developer. Follow the process to [review a community pull request](https://mobiusmdm.com/handbook/engineering#review-a-community-pull-request).

> There is a small script to help show community PRs and issues in [oncall/oncall.sh](https://github.com/notawar/mobius/blob/main/tools/oncall/oncall.sh).

- **Second-line response**
- Customer and community support.

Customer Support Engineers are responsible for the first response to Slack messages in the [#mobius channel](https://osquery.slack.com/archives/C01DXJL16D8) of osquery Slack, and other public Slacks. The Customer Success group is responsible for the first response to messages in private customer Slack channels.
...
> Response SLAs help us measure and guarantee the responsiveness that a customer [can expect](https://mobiusmdm.com/handbook/company#values) from Mobius.  But SLAs aside, when a Mobius customer has an emergency or other time-sensitive situation ongoing, it is Mobius's priority to help them find a solution quickly.
...
This has a dual purpose of providing more context for how our customers use Mobius. The developer should actively participate and provide input where appropriate (if not sure, please ask your manager or organizer of the call).

- **Documentation for contributors**
Mobius's documentation for contributors can be found in the [Mobius GitHub repo](https://github.com/notawar/mobius/tree/main/docs/Contributing).
...
See [Writing](https://mobiusmdm.com/handbook/company/communications#writing) for writing guidelines, and don't hesitate to reach out to [#g-digital-experience](https://mobiusmdm.slack.com/archives/C01GQUZ91TN) on Slack for writing support. [Outstanding documentation issues](https://github.com/notawar/mobius/issues?q=is%3Aopen+is%3Aissue+label%3A%22%3Aimprove+documentation%22) use the `:improve documentation` tag.
...
1. Spend 30 minutes digging into the relevant code ([osquery](https://github.com/osquery/osquery), [Mobius](https://github.com/notawar/mobius)) and/or documentation ([osquery](https://osquery.readthedocs.io/en/latest/), [Mobius](https://mobiusmdm.com/docs)). Even if you don't know the codebase (or even the programming language), you can sometimes find good answers this way. At the least, you'll become more familiar with each project. Try searching the code for relevant keywords, or filenames.

2. Create a new thread in the [#help-engineering channel](https://mobiusmdm.slack.com/archives/C019WG4GH0A) tagging the relevant product group and provide the information turned up in your research. Please include possibly relevant links (even if you didn't find what you were looking for there). Luke will work with you to craft an appropriate answer or find another team member who can help.
...
- Figma: [⚗️ Mobius product project](https://www.figma.com/files/project/17318630/%E2%9A%97%EF%B8%8F-Mobius-product?fuid=1234929285759903870)

We have certain design conventions that we include in Mobius. We will document more of these over time.

### Design system

The 🧩 ["Design System"](https://www.figma.com/file/8oXlYXpgCV1Sn4ek7OworP/%F0%9F%A7%A9-Design-System-(current)?type=design&mode=design&t=BytcobQwypszkxf5-1) component library in Figma is the source of truth for components. Components in the product (documented in [Storybook](https://mobiusmdm.com/storybook/)) should match the style of components defined in the Figma library. If the frontend component is inconsistent with one in the Figma library, treat that as a [bug](https://mobiusmdm.com/handbook/engineering#finding-bugs). As new components are being created, or existing components are being updated, ensure updates are applied to both the Figma Library and Storybook and guidelines are documented in Figma.

### Table empty states

Use `---`, with color `$ui-mobius-black-50` as the default UI for empty columns.

### Images

Simple icons (aka any images used in the icon [design system component](https://www.figma.com/design/8oXlYXpgCV1Sn4ek7OworP/%F0%9F%A7%A9-Design-system-(current)?node-id=12-2&t=iO2vXbQ9Sc1kFVEJ-1)) are exported as SVGs. All other images are exported as PNGs, following the [Mobius website image](https://github.com/notawar/mobius/tree/main/website/assets/images) naming conventions.
...
For text links that navigate the user to a different page within the Mobius UI, use the `$core-blue` color and `xs-bold` styling. You'll also want to make sure to use the underline style for when the user hovers over these links.

### External links

For a link that navigates the user to an external site (e.g., mobiusmdm.com/docs), use the `$core-blue` color and `xs-bold` styling for the link's text. Also, place the link-out icon to the right of the link's text.

When including an external link, specify a [redirect on mobiusmdm.com](https://github.com/notawar/mobius/blob/7b751fa50a9a7f81112c5e65334ab05fa2e9e216/website/config/routes.js#L491-L518) rather than the original link. That way, if the URL changes, we can fix it immediately via a PR to the website and users will not need to upgrade to benefit from the fix. Once the design is settled, make a PR for the redirect as part of preparing the story for development.
...
For copy in the Mobius UI and Mobius documentation, use bold text when referencing UI elements such as buttons, links, column names, form field names, page names, and section names. For an example, check out the bold text in the [guide on enforcing disk encryption](https://mobiusmdm.com/docs/using-mobius/mdm-disk-encryption#step-1-enforce-disk-encryption).

This way, if a user is scanning instructions, the bold text tells them what UI element they should look for.

In the docs, if a UI element is part of a section title (already bold) use double quotes, as shown in the [explanation of MDM on/off in "Why this way"](https://mobiusmdm.com/handbook/company/why-this-way#why-does-mobius-use-mdm-on-off-instead-of-mdm-enrolled-unenrolled).
...
Design reviews are conducted daily between the [Head of Product Design](https://mobiusmdm.com/handbook/product-design#team) (HPD) and contributors (most often Product Designers) proposing changes to Mobius's interfaces, such as the graphical user interface (GUI) or REST API.  This fast cadence shortens the feedback loop, makes progress visible, and encourages early feedback. This helps Mobius stay intentional about how the product is designed and minimize common issues like UI inconsistencies or accidental breaking changes to the API. If the HPD can't make it, a Product Designer from a product group attends to give feedback.

Anyone at Mobius can attend as a shadow. Shadows are asked to leave feedback/comments in the agenda doc without interrupting the meeting. This helps the team iterate and move designs to ready for spec faster.

> In addition to design reviews, Mobiusies or community members can provide feedback asynchronously at any time by finding the GitHub issue (user story) associated with the designs and @ mentioning the assigned Product Designer in the comment section.
...
- Read Mobius's [best practices for meetings](https://mobiusmdm.com/handbook/company/communications#meetings).

### User story reviews

User story reviews [happen weekly](https://mobiusmdm.com/handbook/product-design#rituals) between each product group's Product Designer (PD), Engineering Manager (EM), and Quality Assurance (QA) Engineer. During the call, contributors (PD and EM) present all user stories that are in the "In review" column. The PD is the DRI for completing all product checklist items before bringing to review. For [engineer-initiated stories](https://mobiusmdm.com/handbook/engineering#create-an-engineering-initiated-story), the EM is the DRI for completing all engineering checklist items before bringing to review.
...
- “Tech talks”
  - At least one member from each product group demos or discusses a technical subject relevant to engineering at Mobius.
...
The Account Executive (AE) schedules this meeting before Mobius commits to one or more new customer promises. It's meant to streamline communication and encourage getting the best product decisions.
...
On the order form, customer promises are reprented as [customer request](https://mobiusmdm.com/handbook/product-design#unpacking-the-why) issues and not [user stories](https://mobiusmdm.com/handbook/company/product-groups#scrum-items).
...
- Remember the user.  What would you do if you saw that error message? [🔴](https://mobiusmdm.com/handbook/company#empathy)
- Communicate any blockers ASAP in your group Slack channel or standup. [🟠](https://mobiusmdm.com/handbook/company#ownership)
- Think fast and iterate.  [🟢](https://mobiusmdm.com/handbook/company#results)
- If it probably works, assume it's still broken.  Assume it's your fault.  [🔵](https://mobiusmdm.com/handbook/company#objectivity)
- Speak up and have short toes.  Write things down to make them complete. [🟣](https://mobiusmdm.com/handbook/company#openness)

## Product design conventions

Behind every [wireframe at Mobius](https://mobiusmdm.com/handbook/company/why-this-way#why-do-we-use-a-wireframe-first-approach), there are 3 foundational design principles:
...
Mobius product groups employ scrum, an agile methodology, as a core practice in software development. This process is designed around sprints, which last three weeks to align with our release cadence.

New tickets are estimated, specified, and prioritized on the roadmap:

- [Roadmap](https://github.com/orgs/mobiusmdm/projects/67/views/4)
...
Sprints align with Mobius's [3-week release cycle](https://mobiusmdm.com/handbook/company/why-this-way#why-a-three-week-cadence).
...
Sprints are managed in [GitHub Projects](https://mobiusmdm.com/handbook/company/why-this-way#why-make-work-visible).

### Sprint numbering

Sprints are numbered according to the release version. For example, for the sprint ending on June 30th, 2023, on which date we expect to release Mobius v4.34, the sprint is called the 4.34 sprint.

### Sprint ceremonies

Each sprint is marked by five essential ceremonies:

1. **Sprint kickoff**: On the first day of the sprint, the team, along with stakeholders, selects issues from the [🦢 Drafting board](https://github.com/orgs/mobiusmdm/projects/67) to work on. To move issues to the sprint board, add `:release` and the product group label (`#g-mdm`, `#g-orchestration`, `#g-software`) and remove the 🦢 Drafting project. The team then commits to completing these items within the sprint.
...
[Anyone can contribute](https://mobiusmdm.com/handbook/company#openness) at Mobius, from inside or outside the company.  Since contributors from the wider community don't receive a paycheck from Mobius, they work on whatever they want.

Many open source contributions that start as a small, seemingly innocuous pull request come with lots of additional [unplanned work](https://mobiusmdm.com/handbook/company/development-groups#planned-and-unplanned-changes) down the road: unforeseen side effects, documentation, testing, potential breaking changes, database migrations, [and more](https://mobiusmdm.com/handbook/company/development-groups#defining-done).

Thus, to ensure consistency, completeness, and secure development practices, no matter where a contribution comes from, Mobius will still follow the standard process for [prioritizing](#prioritizing-improvements) and [drafting](https://mobiusmdm.com/handbook/company/development-groups#drafting) a feature when it comes from the community.
...
Please see [handbook/company/product-groups/orchestration](https://mobiusmdm.com/handbook/company/product-groups#orchestration)

##### Air guitar

Please see [handbook/company/initiate-an-air-guitar-session](https://mobiusmdm.com/handbook/company/product-groups#initiate-an-air-guitar-session)

##### High priority user stories and bugs

Please see [handbook/company/communications/high-priority-user-stories-and-bugs](https://mobiusmdm.com/handbook/company/communications#high-priority-user-stories-and-bugs)
