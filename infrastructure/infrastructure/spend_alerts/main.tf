...
provider "aws" {
  ...
  default_tags {
    tags = {
      ...
      terraform   = "https://github.com/notawar/mobius/tree/main/infrastructure/infrastructure/spend_alerts"
      state       = "s3://mobius-terraform-state20220408141538466600000002/root/spend-alerts/terraform.tfstate"
      VantaOwner  = "robert@mobiusmdm.com"
    }
  }
}
