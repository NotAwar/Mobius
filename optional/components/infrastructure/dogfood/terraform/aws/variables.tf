...
variable "domain_mobiusdm" {
  default = "dogfood.mobiusmdm.com"
}

variable "osquery_results_s3_bucket" {
  default = "mobius-osquery-results-archive"
}

variable "osquery_status_s3_bucket" {
  default = "mobius-osquery-status-archive"
}
...
variable "mobius_backend_cpu" {
  default = 256
  type    = number
}

variable "mobius_backend_mem" {
  default = 512
  type    = number
}
...
variable "database_user" {
  description = "database user mobius will authenticate and query with"
  default     = "mobius"
}

variable "database_name" {
  description = "the name of the database mobius will create/use"
  default     = "mobius"
}

variable "mobius_image" {
  description = "the name of the container image to run"
  default     = "ghcr.io/notawar/mobius:v1.0.0"
...
variable "mobius_max_capacity" {
  description = "maximum number of mobius containers to run"
  default     = 5
}

variable "mobius_min_capacity" {
  description = "minimum number of mobius containers to run"
  default     = 1
}
...
variable "mobius_license" {
  description = "Mobius Premium license key"
  default     = ""
}

variable "cloudwatch_log_retention" {
  description = "number of days to keep logs around for mobius services"
  default     = 1
}
