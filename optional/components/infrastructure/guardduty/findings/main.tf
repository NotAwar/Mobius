...
provider "aws" {
  ...
  default_tags {
    tags = {
      ...
      terraform   = "https://github.com/notawar/mobius/tree/main/infrastructure/guardduty/findings"
      state       = "s3://mobius-terraform-state20220408141538466600000002/root/guardduty/findings/terraform.tfstate"
    }
  }
}
...
resource "aws_s3_bucket" "gd_bucket" {
  bucket        = "mobius-guardduty-findings"
  force_destroy = true
}
