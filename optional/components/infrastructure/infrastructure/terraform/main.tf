provider "aws" {
  ...
  default_tags {
    tags = {
      ...
      terraform   = "https://github.com/notawar/mobius/tree/main/infrastructure/infrastructure/terraform"
      state       = "local"
    }
  }
}
...
terraform {
  ...
  backend "s3" {
    bucket               = "mobius-terraform-state20220408141538466600000002"
...
locals {
  accounts = {
    ...
    mobius-cloud-sandbox-prod = "411315989055"
    mobius-cloud-sandbox-dev  = "968703308407"
    dogfood                   = "160035666661"
    loadtesting               = "917007347864"
    root                      = "831217569274"
    mobius-cloud              = "611884880216"
  }
}
...
module "remote-state-s3-backend" {
  ...
  state_bucket_prefix                    = "mobius-terraform-state"
  tags                                   = {}
  providers = {
    aws         = aws
