data "aws_iam_policy_document" "mobius" {
  statement {
    effect    = "Allow"
  ...
  statement {
    ...
    resources = [aws_secretsmanager_secret.database_password_secret.arn, data.aws_secretsmanager_secret.license.arn, aws_secretsmanager_secret.mobius_server_private_key.arn]
  }
...
resource "aws_iam_policy" "main" {
  ...
  policy = data.aws_iam_policy_document.mobius.json
}
