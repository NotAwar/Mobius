provider "aws" {
  ...
  default_tags {
    tags = {
      ...
      terraform   = "https://github.com/notawar/mobius/tree/main/infrastructure/loadtesting"
      state       = "s3://mobius-terraform-state20220408141538466600000002/loadtesting/${terraform.workspace}/loadtesting/loadtesting/terraform.tfstate"
