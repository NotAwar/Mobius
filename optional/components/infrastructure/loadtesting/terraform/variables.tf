...
variable "mobius_config" {
  description = "The configuration to use for mobius itself, gets translated as environment variables"
  type        = map(string)
  default     = {}
}
...
variable "mobius_containers" {
  description = "The number of containers running Mobius"
  type        = number
  default     = 10
}
