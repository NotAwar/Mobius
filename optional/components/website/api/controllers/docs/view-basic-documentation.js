module.exports = {
  ...
  inputs: {
    pageUrlSuffix : {
      ...
      example: 'using-mobius/supported-browsers',
      type: 'string',
      defaultsTo: ''
    }
  },
  ...
  fn: async function ({pageUrlSuffix}) {
    ...
    return {
      ...
      pageTitleForMeta: (
        thisPage.title !== 'Readme.md' ? thisPage.title + ' | Mobius documentation'// « custom meta title for this page, if provided in markdown
      ...
      pageDescriptionForMeta: (
        ...
        : 'Documentation for Mobius for osquery.'// « otherwise use the generic description
      ),
      showSwagForm,
