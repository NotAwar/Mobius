module.exports = {
  ...
  fn: async function ({tableName}) {
    ...
    let pageTitleForMeta = '"'+tableToDisplay.title +'" in osquery | Mobius documentation';
    let pageDescriptionForMeta = 'Read about how to use the "'+tableToDisplay.title+'" table with osquery and Mobius.';
