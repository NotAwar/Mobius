module.exports = {
  ...
  fn: async function ({ slug }) {
    ...
    let pageDescriptionForMeta = thisVital.description ? thisVital.description : 'Explore Mobius’s built-in queries for collecting and storing important device information.';
