module.exports = {
  ...
  description: 'Receive anonymous usage analytics from deployments of Mobius running in production.  (Not mobiuscli preview or dev-mode deployments.)',


  inputs: {
    anonymousIdentifier: { required: true, type: 'string', example: '9pnzNmrES3mQG66UQtd29cYTiX2+fZ4CYxDvh495720=', description: 'An anonymous identifier telling us which Mobius deployment this is.', },
    mobiusVersion: { required: true, type: 'string', example: 'x.x.x' },
    ...
    numHostsMobiusDesktopEnabled: {type: 'number', defaultsTo: 0 },
