...
without necessarily having a billing card.`
    ...
    mobiusSandboxURL: {
      type: 'string',
      description: 'The URL of the Mobius sandbox instance that was provisioned for this user',
      example: 'https://billybobcat.sandbox.mobiusmdm.com',
      extendedDescription: 'As of Oct. 2023, new user records will not have this value set.'
    },

    mobiusSandboxExpiresAt: {
      type: 'number',
      description: 'An JS timestamp (epoch ms) representing when this user\'s mobius sandbox instance will expire',
      example: '1502844074211',
      extendedDescription: 'As of Oct. 2023, new user records will not have this value set.'
    },
    ...
    mobiusSandboxDemoKey: {
      type: 'string',
      description: 'The UUID that is used as the password of this user\'s Mobius Sandbox instance that is generated when the user signs up. Only used to log the user into their Mobius Sandbox instance while it is still live.',
      extendedDescription: 'As of Oct. 2023, new user records will not have this value set.'
    },

    signupReason: {
      type: 'string',
      description: 'The reason this user signed up for a mobiusmdm.com account',
      isIn: ['Try Mobius Sandbox', 'Buy a license', 'Try Mobius'],
    },

    inSandboxWaitlist: {
      type: 'boolean',
      description: 'whether this user is on the Mobius Sandbox waitlist.',
      defaultsTo: false
    },
    ...
    mobiusPremiumTrialLicenseKey: {
      type: 'string',
      description: 'A Mobius Premium license key that was generated for this user when they progressed through the get started questionnaire.',
    },

    mobiusPremiumTrialLicenseKeyExpiresAt: {
      type: 'number',
      description: 'A JS timestamp of when this user\'s Mobius Premium trial license key expires.',
    },
