  ...
  methods: {
    ...
    submittedContactForm: async function() {
      if(typeof gtag !== 'undefined'){
        gtag('event','mobius_website__contact_forms');
      }
      if(typeof window.lintrk !== 'undefined') {
        window.lintrk('track', { conversion_id: 18587089 });// eslint-disable-line camelcase
      }
      if(typeof analytics !== 'undefined'){
        analytics.track('mobius_website__contact_forms');
      }
    ...
    submittedTalkToUsForm: async function() {
      ...
      if(this.formData.numberOfHosts >= 700){
        this.goto(`https://calendly.com/mobiusmdm/talk-to-us?email=${encodeURIComponent(this.formData.emailAddress)}&name=${encodeURIComponent(this.formData.firstName+' '+this.formData.lastName)}`);
      } else {
        this.goto(`https://calendly.com/mobiusmdm/chat?email=${encodeURIComponent(this.formData.emailAddress)}&name=${encodeURIComponent(this.formData.firstName+' '+this.formData.lastName)}`);
      }
    },
