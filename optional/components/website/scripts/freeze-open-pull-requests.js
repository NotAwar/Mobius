module.exports = {
  ...
  description: 'Freeze existing pull requests open on https://github.com/notawar/mobius, except those that consist exclusively of changes to files where the author is the DRI, according to auto-approval rules.',
