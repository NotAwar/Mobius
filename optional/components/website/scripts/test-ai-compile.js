module.exports = {
  ...
  fn: async function () {
    ...
    let goal3 = 'Receive from Mobius: Handle a webhook sent by Mobius whenever a policy fails, such that, if the policy is critical, we send an email to the person\'s email.  Reach out to the Mobius API as needed to map the incoming data\'s hostname to the human email identity using the originating host.';
