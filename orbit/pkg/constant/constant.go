...
const (
	...
	// DesktopAppExecName is the name of Mobius's Desktop executable.
	//
	// We use mobius-desktop as name to properly identify the process when listing
	// running processes/tasks.
	DesktopAppExecName = "mobius-desktop"
	// DesktopTokenFileName is the filename on disk (in the orbit base dir) where we store the Mobius Desktop auth token
	...
	SystemServiceName = "Mobius osquery"
	// MobiusTLSClientCertificateFileName is the name of the TLS client certificate file
	// used when connecting to the Mobius server.
	MobiusTLSClientCertificateFileName = "mobius_client.crt"
	// MobiusTLSClientKeyFileName is the name of the TLS client private key file
	// used when connecting to the Mobius server.
	MobiusTLSClientKeyFileName = "mobius_client.key"
	...
	SilenceEnrollLogErrorEnvVar = "MOBIUSDAEMON_SILENCE_ENROLL_ERROR"
	...
	// MigrationFileName is the name of the file used by mobiusdaemon to determine if the host is
	...
	// OrbitTUFTargetName is the target name of the orbit component of mobiusdaemon in TUF.
	OrbitTUFTargetName = "orbit"
	// OsqueryTUFTargetName is the target name of the osquery component of mobiusdaemon in TUF.
	OsqueryTUFTargetName = "osqueryd"
	// DesktopTUFTargetName is the target name of the Mobius Desktop component of mobiusdaemon in TUF.
	DesktopTUFTargetName = "desktop"
	// MobiusURLFileName is the file where Mobius URL is stored after being read from Apple config profile.
	MobiusURLFileName = "mobius_url.txt"
)
