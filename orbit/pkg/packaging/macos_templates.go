...
<installer-gui-script minSpecVersion="2">
	<title>Mobius osquery</title>
	<choices-outline>
	    <line choice="choiceBase"/>
    </choices-outline>
    <choice id="choiceBase" title="Mobius osquery" enabled="false" selected="true" description="Standard installation for Mobius osquery.">
...
{{ if .StartService -}}
DAEMON_LABEL="com.mobiusmdm.orbit"
...
<dict>
	...
	<dict>
		...
		<string>true</string>
		{{- end }}
		{{- if .MobiusCertificate }}
		<key>ORBIT_MOBIUS_CERTIFICATE</key>
		<string>/opt/orbit/mobius.pem</string>
		{{- end }}
		{{- if .EnrollSecret }}
		...
		{{- end }}
		{{- if .MobiusURL }}
		<key>ORBIT_MOBIUS_URL</key>
		<string>{{ .MobiusURL }}</string>
		{{- end }}
		...
		{{- end }}
		{{- if .Desktop }}
		<key>ORBIT_MOBIUS_DESKTOP</key>
		<string>true</string>
		<key>ORBIT_DESKTOP_CHANNEL</key>
		<string>{{ .DesktopChannel }}</string>
		{{- if .MobiusDesktopAlternativeBrowserHost }}
		<key>ORBIT_MOBIUS_DESKTOP_ALTERNATIVE_BROWSER_HOST</key>
		<string>{{ .MobiusDesktopAlternativeBrowserHost }}</string>
		{{- end }}
		{{- end }}
	...
	<true/>
	<key>Label</key>
	<string>com.mobiusmdm.orbit</string>
