...
import (
	...
	"github.com/notawar/mobius/v4/orbit/pkg/table/cryptoinfotable"
	"github.com/notawar/mobius set/v4/orbit/pkg/table/dataflattentable"
	"github.com/notawar/mobius set/v4/orbit/pkg/table/firefox_preferences"
	"github.com/notawar/mobius set/v4/orbit/pkg/table/mobiusdaemon_logs"
	"github.com/notawar/mobius set/v4/orbit/pkg/table/sntp_request"
...
func (r *Runner) Execute() error {
	...
	for {
		srv, err := osquery.NewExtensionManagerServer(
			"com.mobiusmdm.orbit.osquery_extension.v1",
			r.socket,
