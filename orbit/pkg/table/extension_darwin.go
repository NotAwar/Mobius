...
import (
	...
	"github.com/notawar/mobius set/v4/orbit/pkg/table/authdb"
	"github.com/notawar/mobius set/v4/orbit/pkg/table/codesign"
	"github.com/notawar/mobius set/v4/orbit/pkg/table/csrutil_info"
	"github.com/notawar/mobius set/v4/orbit/pkg/table/dataflattentable"
	"github.com/notawar/mobius set/v4/orbit/pkg/table/diskutil/apfs"
	"github.com/notawar/mobius set/v4/orbit/pkg/table/diskutil/corestorage"
	"github.com/notawar/mobius set/v4/orbit/pkg/table/dscl"
	"github.com/notawar/mobius set/v4/orbit/pkg/table/filevault_prk"
	"github.com/notawar/mobius set/v4/orbit/pkg/table/filevault_status"
	"github.com/notawar/mobius set/v4/orbit/pkg/table/find_cmd"
	"github.com/notawar/mobius set/v4/orbit/pkg/table/firmware_eficheck_integrity_check"
	"github.com/notawar/mobius set/v4/orbit/pkg/table/firmwarepasswd"
	"github.com/notawar/mobius set/v4/orbit/pkg/table/ioreg"
	"github.com/notawar/mobius set/v4/orbit/pkg/table/macos_user_profiles"
	"github.com/notawar/mobius set/v4/orbit/pkg/table/nvram_info"
	"github.com/notawar/mobius set/v4/orbit/pkg/table/pmset"
	"github.com/notawar/mobius set/v4/orbit/pkg/table/privaterelay"
	"github.com/notawar/mobius set/v4/orbit/pkg/table/pwd_policy"
	"github.com/notawar/mobius set/v4/orbit/pkg/table/software_update"
	"github.com/notawar/mobius set/v4/orbit/pkg/table/sudo_info"
	"github.com/notawar/mobius set/v4/orbit/pkg/table/tcc_access"
	"github.com/notawar/mobius set/v4/orbit/pkg/table/user_login_settings"
	...
	plugins := []osquery.OsqueryPlugin{
		...
		table.NewPlugin(
			...
			func(ctx context.Context, queryContext table.QueryContext) ([]map[string]string, error) {
				return sofa.SofaSecurityReleaseInfoGenerate(ctx, queryContext, opts.Socket, sofa.WithUserAgent("mobiusdaemon"))
			},
		),
		table.NewPlugin(
			"sofa_unpatched_cves", sofa.SofaUnpatchedCVEsColumns(),
			func(ctx context.Context, queryContext table.QueryContext) ([]map[string]string, error) {
				return sofa.SofaUnpatchedCVEsGenerate(ctx, queryContext, opts.Socket, sofa.WithUserAgent("mobiusdaemon"))
			},
		),
