...
// TestDoFlagsUpdateWithEmptyFlags tests the scenario of Mobius flag `command_line_flags`
...
func TestDoFlagsUpdateWithEmptyFlags(t *testing.T) {
	...
	// Non-empty mobius flags and osquery.flags has empty flags.
	testConfig = &mobius.OrbitConfig{
	...
	// Empty Mobius flags and osquery.flags has non-empty flags.
	restartQueued = false
	testConfig = &mobius.OrbitConfig{
		Flags: json.RawMessage("{}"),
	}
