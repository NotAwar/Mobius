...
var (
	...
	DesktopMacOSTarget = TargetInfo{
		...
		ExtractedExecSubPath: []string{"Mobius Desktop.app", "Contents", "MacOS", constant.DesktopAppExecName},
	}
	...
	DesktopLinuxTarget = TargetInfo{
		...
		ExtractedExecSubPath: []string{"mobius-desktop", constant.DesktopAppExecName},
