...
func TestNewRunner(t *testing.T) {
	...
	// "ee/mobiuscli/updates.go" (as it doesn't make sense to have such functionality
	// there and import such eemobiuscli package here).
	nettest.Run(t)
...
func TestGetVersion(t *testing.T) {
	...
	testCases := map[string]struct {
		...
		"42.0.0": {
			cmd:     "#!/bin/bash\n/bin/echo mobius-desktop 42.0.0",
			version: "42.0.0",
		},
