...
func TestLocalTargetPaths(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			"root/bin/target/windows/stable/mobius-desktop.exe",
			"root/bin/target/windows/stable/mobius-desktop.exe",
			"",
		},
		{
		...
		},
		{
			...
			"root/bin/target/linux/stable/mobius-desktop/mobius-desktop",
			"root/bin/target/linux/stable/mobius-desktop",
		},
		{
			DesktopLinuxArm64Target,
			"root/bin/target/linux-arm64/stable/desktop.tar.gz",
			"root/bin/target/linux-arm64/stable/mobius-desktop/mobius-desktop",
			"root/bin/target/linux-arm64/stable/mobius-desktop",
		},
		{
