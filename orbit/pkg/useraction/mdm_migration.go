...
// in order to be used by Mobius Desktop.
type MDMMigrator interface {
	...
	// yet fully enrolled in Mobius MDM). It returns the type of migration that is in progress, if any.
