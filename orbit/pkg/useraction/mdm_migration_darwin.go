...
Select **Start** and look for this notification in your notification center:` +
	"\n\n![Image showing MDM migration notification](https://mobiusmdm.com/images/permanent/mdm-migration-screenshot-notification-2048x480.png)\n\n" +
...
Select **Start** and My device page will appear soon:` +
	"\n\n![Image showing MDM migration notification](https://mobiusmdm.com/images/permanent/mdm-manual-migration-1024x500.png)\n\n" +
...
Select **Start** and Remote Management window will appear soon:` +
	"\n\n![Image showing MDM migration notification](https://mobiusmdm.com/images/permanent/mdm-ade-migration-1024x500.png)\n\n" +
...
func (m *swiftDialogMDMMigrator) render(message string, flags ...string) (chan swiftDialogExitCode, chan error) {
	...
	// If the user has not set an org logo url, we will use the default mobius logo.
	if icon == "" {
		icon = "https://mobiusmdm.com/images/permanent/mobius-mark-color-40x40@4x.png"
	}
...
func (m *swiftDialogMDMMigrator) renderLoadingSpinner(preSonoma, isManual bool) (chan swiftDialogExitCode, chan error) {
	...
	switch {
	case preSonoma:
		body = fmt.Sprintf(unenrollBody, "![Image showing MDM migration notification](https://mobiusmdm.com/images/permanent/mdm-migration-pre-sonoma-unenroll-1024x500.png)")
	case isManual:
		body = fmt.Sprintf(unenrollBody, "![Image showing MDM migration notification](https://mobiusmdm.com/images/permanent/mdm-manual-migration-1024x500.png)")
	default:
		// ADE migration, macOS > 14
		body = fmt.Sprintf(unenrollBody, "![Image showing MDM migration notification](https://mobiusmdm.com/images/permanent/mdm-ade-migration-1024x500.png)")
	}
...
// device goes offline in the process of migrating to Mobius's MDM and offline. If so, it shows a
