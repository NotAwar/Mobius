...
osslsigncode sign -pkcs12 "./orbit/tools/build/mobiusmdm.pfx" -pass "mobiusmdm" -n "Mobius Osquery" -i "https://www.mobiusmdm.com" -t "http://timestamp.comodoca.com/authenticode" -in "$work_file" -out "$input_file"
