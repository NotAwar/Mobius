...
//
// $ GO_TEST_EXTRA_FLAGS="--timeout 20m" MOBIUS_INTEGRATION_TESTS_DISABLE_LOG=1 REDIS_TEST=1 MYSQL_TEST=1 MINIO_STORAGE_TEST=1 go test ./pkg/file -run zzz -bench . -benchmem | prettybench
// goos: linux
// goarch: amd64
// pkg: github.com/notawar/mobius/v4/pkg/file
...
// BenchmarkExtractInstallerMetadata/Mobius_osquery.msi/file_size:_43775_kb-8                               4    277.60 ms/op   252408264 B/op     3737 allocs/op
...
// BenchmarkExtractInstallerMetadata/mobius-osquery.deb/file_size:_79581_kb-8                               4    308.36 ms/op       59696 B/op       90 allocs/op
...
// ok  	github.com/notawar/mobius/v4/pkg/file	36.644s
...
// BenchmarkExtractInstallerMetadata/Mobius_osquery.msi/file_size:_43775_kb-8                               4    296.01 ms/op   252408208 B/op     3737 allocs/op
...
// BenchmarkExtractInstallerMetadata/mobius-osquery.deb/file_size:_79581_kb-8                               3    335.98 ms/op       60384 B/op       90 allocs/op
...
// ok  	github.com/notawar/mobius/v4/pkg/file	37.775s
...
// ok  	github.com/notawar/mobius/v4/pkg/file	35.887s
...
// ok  	github.com/notawar/mobius/v4/pkg/file	39.536s
...
// benchmark                                                                                            iter      time/iter    bytes alloc             allocs
// ---------                                                                                            ----      ---------    -----------             ------
// BenchmarkExtractInstallerMetadata/Mobius_osquery.msi/file_size:_43775_kb-8                               6   191.69 ms/op    879274 B/op     3752 allocs/op
...
// ok  	github.com/notawar/mobius/v4/pkg/file	32.193s
	...
	for _, dent := range dents {
		...
		b.Run(wantName+"."+wantExtension, func(b *testing.B) {
			...
			b.Run(fmt.Sprintf("file size: %d kb", info.Size()/1024), func(b *testing.B) {
				...
				// iteration.
				for i := 0; i < b.N; i++ {
					tfr, err := mobius.NewKeepFileReader(filepath.Join("testdata", "installers", dent.Name()))
					require.NoError(b, err)
