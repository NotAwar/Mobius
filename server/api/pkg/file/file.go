...
import (
	...
	"github.com/MobiusDM/mobius/server/api/pkg/secure"
...
func ExtractInstallerMetadata(tfr *mobius.TempFileReader) (*InstallerMetadata, error) {
...
// running this operation in the context of mobiusdaemon running as root on a host
// (e.g. for installs), so we have different constraints than mobiuscli building
