...
import (
	...
	"github.com/notawar/mobius/mobius-server/pkg/retry"
)
...
// use.
var client = mobiushttp.NewClient(mobiushttp.WithTimeout(10 * time.Second))
...
func getBaseURL() string {
	devURL := os.Getenv("MOBIUS_DEV_ITUNES_URL")
	if devURL != "" {
		return devURL
	}
