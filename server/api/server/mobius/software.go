...
type Software struct {
	...
	// TODO: Remove this as part of the clean up of https://github.com/notawar/mobius/pull/7297
...
func (s Software) ComputeRawChecksum() ([]byte, error) {
	...
	// mutable and can lead to unintentional duplicates of Software in Mobius.
	if s.Source != "apps" {
...
// SoftwareFromOsqueryRow creates a mobius.Software from the values reported by osquery.
...
//
// All fields are trimmed to fit on Mobius's database.
