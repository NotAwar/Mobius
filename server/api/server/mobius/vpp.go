...
// VPPAppTeam contains extra metadata injected by mobius
type VPPAppTeam struct {
	...
	// Mobius as being valid labels. This field is only used internally.
	...
	// this VPP app on VPP app add to Mobius.
	...
	// automatically created when a VPP app is added to Mobius. This field should be set after VPP
