...
func main() {
	detailQueriesMap := osquery_utils.GetDetailQueries(context.Background(),
		...
		&mobius.AppConfig{MDM: mobius.MDM{EnabledAndConfigured: true, WindowsEnabledAndConfigured: true}},
		&mobius.Features{
...
Following is a summary of the detail queries hardcoded in Mobius used to populate the device details:
