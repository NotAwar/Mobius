...
import (
	...
	"github.com/notawar/mobius/mobius-server/server/bindata"
...
func PostJSONWithTimeout(ctx context.Context, url string, v interface{}) error {
	...
	client := mobiushttp.NewClient(mobiushttp.WithTimeout(30 * time.Second))
...
// NOTE: Additional crypto utilities from server/mdm/apple/util could be consolidated here
...
// that Mobius has never updated the host vitals.
