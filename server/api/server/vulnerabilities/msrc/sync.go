...
import (
	...
	"github.com/notawar/mobius/mobius-server/server/vulnerabilities/msrc/parsed"
...
func SyncFromGithub(ctx context.Context, dstDir string, os []mobius.OperatingSystem) error {
