...
# Go to the [Software|{{ .MobiusURL }}/software/manage] page in Mobius.
...
This issue was created automatically by your Mobius Jira integration.
`)),
...
func (j *Jira) runFailingPolicy(ctx context.Context, cli JiraClient, args jiraArgs) error {
	tplArgs := newFailingPoliciesTplArgs(j.MobiusURL, args.FailingPolicy)
...
func QueueJiraFailingPolicyJob(ctx context.Context, ds mobius.Datastore, logger kitlog.Logger,
