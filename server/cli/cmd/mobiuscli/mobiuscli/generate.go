...
const (
	apnsCSRPath         = "mobius-mdm-csr.csr"
	bmPublicKeyCertPath = "mobius-apple-mdm-bm-public-key.crt"
)
...
func generateMDMAppleCommand() *cli.Command {
	return &cli.Command{
		...
		Action: func(c *cli.Context) error {
			...
			// get the mobius API client first, so that any login requirement are met
