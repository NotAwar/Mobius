...
func NewContext(ctx context.Context, lic *mobius.LicenseInfo) context.Context {
...
func FromContext(ctx context.Context) (*mobius.LicenseInfo, bool) {
	v, ok := ctx.Value(licenseKey).(*mobius.LicenseInfo)
	return v, ok
}
