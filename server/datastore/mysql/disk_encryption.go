...
func (ds *Datastore) SetOrUpdateHostDiskEncryptionKey(ctx context.Context, host *mobius.Host, encryptedBase64Key, clientError string,
...
func (ds *Datastore) getExistingHostDiskEncryptionKey(ctx context.Context, host *mobius.Host) (encryptionKey, error) {
...
func (ds *Datastore) archiveHostDiskEncryptionKey(ctx context.Context, host *mobius.Host, incomingKey encryptionKey,
...
func (ds *Datastore) SaveLUKSData(ctx context.Context, host *mobius.Host, encryptedBase64Passphrase string, encryptedBase64Salt string,
	keySlot uint) error {
...
func (ds *Datastore) AssertHasNoEncryptionKeyStored(ctx context.Context, hostID uint) error {
	...
	if hasKeyCount > 0 {
		return &mobius.BadRequestError{Message: "Key has already been escrowed for this host"}
	}

	return err
}

func (ds *Datastore) GetUnverifiedDiskEncryptionKeys(ctx context.Context) ([]mobius.HostDiskEncryptionKey, error) {
	...
	var keys []mobius.HostDiskEncryptionKey
...
func (ds *Datastore) GetHostDiskEncryptionKey(ctx context.Context, hostID uint) (*mobius.HostDiskEncryptionKey, error) {
...
func cleanupDiskEncryptionKeysOnTeamChangeDB(ctx context.Context, tx sqlx.ExtContext, hostIDs []uint, newTeamID *uint) error {
	...
	_, err := getMDMAppleConfigProfileByTeamAndIdentifierDB(ctx, tx, newTeamID, mobileconfig.MobiusFileVaultPayloadIdentifier)
	if err != nil {
