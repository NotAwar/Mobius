...
`)
	...
	r, err := db.Exec(stmt, 0, "com.mobiusmdm.mobius.mdm.filevault", "Disk encryption", mcBytes)
	...
	r, err = db.Exec(stmt, teamID, "com.mobiusmdm.mobius.mdm.filevault", "Disk encryption", mcBytes)
	require.NoError(t, err)
	...
	require.NoError(t, err)
	require.Equal(t, "com.mobiusmdm.mobius.mdm.filevault", identifier)
