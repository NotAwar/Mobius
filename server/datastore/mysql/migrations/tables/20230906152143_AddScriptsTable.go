...
CREATE TABLE scripts (
    ...
    -- the name of the script file that was uploaded (or applied via mobiuscli), note
    -- that only the filename part of the path is kept and it must be unique for a
    -- given team/no team.
    name               VARCHAR(255) NOT NULL,

    -- the contents of the script to execute, length is limited by Mobius.
	...
	// like an "anonymous" script execution (a one-off, same as those via mobiuscli
