...
func TestUp_20240314085226(t *testing.T) {
	...
	sampleEvent := mobius.CalendarEvent{
	...
	sampleHostEvent := mobius.HostCalendarEvent{
		HostID:          1,
		CalendarEventID: sampleEvent.ID,
		WebhookStatus:   mobius.CalendarWebhookStatusPending,
	}
	...
	var event mobius.CalendarEvent
	...
	var hostEvent mobius.HostCalendarEvent
