...
<dict>
	...
	<array>
		...
		<dict>
			...
			<string>Mobius certificate</string>
			<key>PayloadContent</key>
			<data>dGVzdAo=</data>
			<key>PayloadDisplayName</key>
	...
	<key>PayloadIdentifier</key>
	<string>com.mobiusmdm.mobius.mdm.filevault</string>
	<key>PayloadType</key>
	...
	r, err := db.Exec(insertStmt, 0, mobileconfig.MobiusFileVaultPayloadIdentifier, "Disk encryption", profileBytes)
	...
	r, err = db.Exec(insertStmt, teamID, mobileconfig.MobiusFileVaultPayloadIdentifier, "Disk encryption", profileBytes)
	require.NoError(t, err)
	...
	require.NoError(t, err)
	require.Equal(t, mobileconfig.MobiusFileVaultPayloadIdentifier, identifier)
