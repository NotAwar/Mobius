...
const (
	placeholderUninstallScript        = "# This script will be automatically updated within the next hour\nexit 1"
	placeholderUninstallScriptWindows = "# This script will be automatically updated within the next hour\nExit 1"
)
...
CASE
	...
	ELSE NULL -- not installed from Mobius installer or successfully uninstalled
END
) STORED NULL,
