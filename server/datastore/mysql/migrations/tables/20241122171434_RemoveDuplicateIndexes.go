...
func Up_20241122171434(tx *sql.Tx) error {
	...
	// ALTER TABLE `mobius`.`app_config_json` DROP INDEX `id`;
	//
	// # ########################################################################
	// # mobius.host_users
	// # ########################################################################
	...
	// # To remove this duplicate index, execute:
	// ALTER TABLE `mobius`.`host_users` DROP INDEX `idx_uid_username`;
	//
	// # ########################################################################
	// # mobius.migration_status_tables
	// # ########################################################################
	//
	// # Uniqueness of id ignored because PRIMARY is a duplicate constraint
	// # id is a duplicate of PRIMARY
	...
	// # To remove this duplicate index, execute:
	// ALTER TABLE `mobius`.`migration_status_tables` DROP INDEX `id`;
	//
	// # ########################################################################
	// # mobius.policy_membership
	// # ########################################################################
	//
	...
	// #	  `host_id` int unsigned not null
	// # To remove this duplicate index, execute:
	// ALTER TABLE `mobius`.`policy_membership` DROP INDEX `idx_policy_membership_policy_id`;
	//
	// # ########################################################################
	// # mobius.software
	// # ########################################################################
	...
	// ALTER TABLE `mobius`.`software` DROP INDEX `software_listing_idx`, ADD INDEX `software_listing_idx` (`name`);
	//
	// # ########################################################################
	// # mobius.software_cve
	// # ########################################################################
	...
	// # To remove this duplicate index, execute:
	// ALTER TABLE `mobius`.`software_cve` DROP INDEX `software_cve_software_id`;
