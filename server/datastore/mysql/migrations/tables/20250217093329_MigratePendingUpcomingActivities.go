...
SELECT
	...
	0,
	hsi.user_id,
	hsi.policy_id IS NOT NULL, -- true if mobius-initiated
	'software_install',
	hsi.execution_id,
	JSON_OBJECT(
...
SELECT
	...
	0,
	hvi.user_id,
	hvi.policy_id IS NOT NULL, -- true if mobius-initiated
	'vpp_app_install',
	hvi.command_uuid,
	JSON_OBJECT(
...
SELECT
	...
	0,
	hsr.user_id,
	hsr.policy_id IS NOT NULL, -- true if mobius-initiated
	'script',
	hsr.execution_id,
	JSON_OBJECT(
