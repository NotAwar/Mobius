...
func computeRawChecksumIncludingName(sw mobius.Software) ([]byte, error) {
...
func TestUp_20250410104321(t *testing.T) {
	...
	var gotSoftwareTitles []mobius.SoftwareTitle
	...
	var getSoftwarePaths []mobius.HostSoftwareInstalledPath
