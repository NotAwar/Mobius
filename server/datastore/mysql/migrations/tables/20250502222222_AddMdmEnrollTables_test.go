...
func TestUp_20250502222222(t *testing.T) {
	...
	type hostMDM struct {
		HostID           uint   `db:"host_id"`
		MobiusEnrollRef   string `db:"mobius_enroll_ref"`
	...
	newHostMDM := func(hmdm hostMDM) {
		execNoErr(t, db,
			`INSERT INTO host_mdm (host_id, mobius_enroll_ref, enrolled, server_url, installed_from_dep, mdm_id, is_server) 
				VALUES (?, ?, ?, ?, ?, ?, ?)`,
			hmdm.HostID, hmdm.MobiusEnrollRef, hmdm.Enrolled, hmdm.ServerURL,
	...
	testCases := []testCase{
		{
			...
			hostMDM: hostMDM{
				HostID:         1,
				MobiusEnrollRef: "nobody-uuid",
			},
			hostEmails: []hostEmail{
				{HostID: 1, Email: bob.Email, Source: mobius.DeviceMappingMDMIdpAccounts},
				{HostID: 1, Email: "nobody@example.com", Source: mobius.DeviceMappingMDMIdpAccounts},
			},
		...
		},
		{
			...
			hostEmails: []hostEmail{
				{HostID: 2, Email: dave.Email, Source: mobius.DeviceMappingMDMIdpAccounts},
				{HostID: 2, Email: bob.Email, Source: mobius.DeviceMappingMDMIdpAccounts},
				{HostID: 2, Email: "nobody@example.com", Source: mobius.DeviceMappingMDMIdpAccounts},
			},
			expectLegacyRefs:   []string{"nobody-uuid"},
		...
		},
		{
			...
			hostMDM: hostMDM{
				HostID:         3,
				MobiusEnrollRef: "bob-uuid",
			},
			hostEmails: []hostEmail{
				{HostID: 3, Email: carol.Email, Source: mobius.DeviceMappingMDMIdpAccounts},
				{HostID: 3, Email: bob.Email, Source: mobius.DeviceMappingMDMIdpAccounts},
				{HostID: 3, Email: "nobody@example.com", Source: mobius.DeviceMappingMDMIdpAccounts},
			},
		...
		},
		{
			...
			hostEmails: []hostEmail{
				{HostID: 4, Email: "nobody@example.com", Source: mobius.DeviceMappingMDMIdpAccounts},
			},
			expectLegacyRefs:     []string{"bob-uuid"},
		...
		},
		{
			...
			hostEmails: []hostEmail{
				{HostID: 5, Email: "nobody@example.com", Source: mobius.DeviceMappingMDMIdpAccounts},
			},
			expectLegacyRefs:     []string{"nobody-uuid"},
			expectLegacyEmails:   []string{"nobody@example.com"},
		...
		},
		{
			...
			hostEmails: []hostEmail{
				{HostID: 8, Email: "bob@example.com", Source: mobius.DeviceMappingGoogleChromeProfiles},
			},
			expectLegacyRefs:     []string{"nobody-uuid"},
			expectLegacyEmails:   []string{}, // only included if source is mobius.DeviceMappingMDMIdpAccounts
			expectMDMAccountUUID: "",         // no mdm account
		},
	}
	...
	for _, tc := range testCases {
		...
		newHostMDM(hostMDM{
			HostID:           tc.hostID,
			MobiusEnrollRef:   tc.hostMDM.MobiusEnrollRef,
			Enrolled:         true,
