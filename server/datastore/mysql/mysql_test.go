...
func TestAppendListOptionsToSQL(t *testing.T) {
	...
	sql = "SELECT * FROM my_table"
	opts.OrderDirection = mobius.OrderDescending
	actual, _ = appendListOptionsToSQL(sql, &opts)
...
func TestWhereFilterHostsByTeams(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			filter: mobius.TeamFilter{
				User: &mobius.User{Teams: []mobius.UserTeam{}},
			},
			expected: "FALSE",
		},
			...
			filter: mobius.TeamFilter{
				User: &mobius.User{
					Teams: []mobius.UserTeam{
						{Role: mobius.RoleObserver, Team: mobius.Team{ID: 1}},
					},
				},
			},
			expected: "FALSE",
		...
		},
		{
			filter: mobius.TeamFilter{
				User: &mobius.User{
					Teams: []mobius.UserTeam{
						{Role: mobius.RoleObserver, Team: mobius.Team{ID: 1}},
						{Role: mobius.RoleObserver, Team: mobius.Team{ID: 2}},
					},
				},
			},
			expected: "FALSE",
		},
		{
			filter: mobius.TeamFilter{
				User: &mobius.User{
					Teams: []mobius.UserTeam{
						{Role: mobius.RoleObserver, Team: mobius.Team{ID: 1}},
						{Role: mobius.RoleMaintainer, Team: mobius.Team{ID: 2}},
					},
				},
			},
			...
			filter: mobius.TeamFilter{
				User: &mobius.User{
					Teams: []mobius.UserTeam{
						...
						{Role: "bad", Team: mobius.Team{ID: 37}},
					},
				},
			},
			expected: "hosts.team_id IN (2)",
			...
			filter: mobius.TeamFilter{
				User: &mobius.User{
					Teams: []mobius.UserTeam{
						{Role: mobius.RoleObserver, Team: mobius.Team{ID: 1}},
						{Role: mobius.RoleMaintainer, Team: mobius.Team{ID: 2}},
						{Role: mobius.RoleAdmin, Team: mobius.Team{ID: 3}},
						// Invalid role should be ignored
					},
				},
			},
...
func TestWhereFilterTeams(t *testing.T) {
	...
	testCases := []struct {
		...
		// No teams or global role
		{
			filter:   mobius.TeamFilter{User: nil},
			expected: "FALSE",
		},
		{
			filter: mobius.TeamFilter{
		...
		{
			filter:   mobius.TeamFilter{User: &mobius.User{Teams: []mobius.UserTeam{{Team: mobius.Team{ID: 1}, Role: mobius.RoleAdmin}}}},
			expected: "t.id IN (1)",
		},
		{
			filter:   mobius.TeamFilter{User: &mobius.User{Teams: []mobius.UserTeam{{Team: mobius.Team{ID: 1}, Role: mobius.RoleMaintainer}}}},
			expected: "t.id IN (1)",
		},
		{
			filter:   mobius.TeamFilter{User: &mobius.User{Teams: []mobius.UserTeam{{Team: mobius.Team{ID: 1}, Role: mobius.RoleObserver}}}},
			expected: "FALSE",
		},
		{
			filter: mobius.TeamFilter{
