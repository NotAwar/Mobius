...
func listOperatingSystemsDB(ctx context.Context, tx sqlx.QueryerContext) ([]mobius.OperatingSystem, error) {
...
func (ds *Datastore) ListOperatingSystemsForPlatform(ctx context.Context, platform string) ([]mobius.OperatingSystem, error) {
	var oses []mobius.OperatingSystem
	sqlStatement := `
...
func (ds *Datastore) UpdateHostOperatingSystem(ctx context.Context, hostID uint, hostOS mobius.OperatingSystem) error {
...
func (ds *Datastore) GetHostOperatingSystem(ctx context.Context, hostID uint) (*mobius.OperatingSystem, error) {
...
func getOrGenerateOperatingSystemDB(ctx context.Context, tx sqlx.ExtContext, hostOS mobius.OperatingSystem) (*mobius.OperatingSystem, error) {
...
func newOperatingSystemDB(ctx context.Context, tx sqlx.ExtContext, hostOS mobius.OperatingSystem) (*mobius.OperatingSystem, error) {
...
func getOSVersionID(ctx context.Context, tx sqlx.ExtContext, hostOS mobius.OperatingSystem) (uint, error) {
...
func getOperatingSystemDB(ctx context.Context, tx sqlx.ExtContext, hostOS mobius.OperatingSystem) (*mobius.OperatingSystem, error) {
	var os mobius.OperatingSystem
...
func isHostOperatingSystemUpdateNeeded(ctx context.Context, qc sqlx.QueryerContext, hostID uint, hostOS mobius.OperatingSystem) (
	bool, error,
) {
...
func getHostOperatingSystemDB(ctx context.Context, tx sqlx.QueryerContext, hostID uint) (*mobius.OperatingSystem, error) {
	var os mobius.OperatingSystem
