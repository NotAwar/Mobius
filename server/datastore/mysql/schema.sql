...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `mobius_maintained_apps` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` timestamp(6) NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_mobius_library_apps_token` (`slug`)
) /*!50100 TABLESPACE `innodb_system` */ ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `mobius_variables` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
...
/*!40101 SET character_set_client = @saved_cs_client */;
INSERT INTO `mobius_variables` VALUES (1,'MOBIUS_VAR_NDES_SCEP_CHALLENGE',0,'2025-04-22 00:00:00.000000'),(2,'MOBIUS_VAR_NDES_SCEP_PROXY_URL',0,'2025-04-22 00:00:00.000000'),(3,'MOBIUS_VAR_HOST_END_USER_EMAIL_IDP',0,'2025-04-22 00:00:00.000000'),(4,'MOBIUS_VAR_HOST_HARDWARE_SERIAL',0,'2025-04-22 00:00:00.000000'),(5,'MOBIUS_VAR_HOST_END_USER_IDP_USERNAME',0,'2025-04-22 00:00:00.000000'),(6,'MOBIUS_VAR_HOST_END_USER_IDP_USERNAME_LOCAL_PART',0,'2025-04-22 00:00:00.000000'),(7,'MOBIUS_VAR_HOST_END_USER_IDP_GROUPS',0,'2025-04-22 00:00:00.000000'),(8,'MOBIUS_VAR_DIGICERT_DATA_',1,'2025-04-22 00:00:00.000000'),(9,'MOBIUS_VAR_DIGICERT_PASSWORD_',1,'2025-04-22 00:00:00.000000'),(10,'MOBIUS_VAR_CUSTOM_SCEP_CHALLENGE_',1,'2025-04-22 00:00:00.000000'),(11,'MOBIUS_VAR_CUSTOM_SCEP_PROXY_URL_',1,'2025-04-22 00:00:00.000000'),(12,'MOBIUS_VAR_SCEP_RENEWAL_ID',0,'2025-04-30 00:00:00.000000'),(13,'MOBIUS_VAR_HOST_END_USER_IDP_DEPARTMENT',0,'2025-06-27 00:00:00.000000');
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
CREATE TABLE `host_mdm` (
  ...
  `mobius_enroll_ref` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE `host_mdm_actions` (
  ...
  `mobius_platform` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  PRIMARY KEY (`host_id`)
) /*!50100 TABLESPACE `innodb_system` */ ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
...
CREATE TABLE `mdm_configuration_profile_variables` (
  ...
  KEY `mdm_configuration_profile_variables_mobius_variable_id` (`mobius_variable_id`),
  ...
  CONSTRAINT `mdm_configuration_profile_variables_mobius_variable_id` FOREIGN KEY (`mobius_variable_id`) REFERENCES `mobius_variables` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `software_installers` (
  ...
  `updated_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
  `mobius_maintained_app_id` int unsigned DEFAULT NULL,
  ...
  KEY `fk_software_installers_mobius_library_app_id` (`mobius_maintained_app_id`),
  ...
  CONSTRAINT `software_installers_ibfk_1` FOREIGN KEY (`mobius_maintained_app_id`) REFERENCES `mobius_maintained_apps` (`id`) ON DELETE SET NULL
) /*!50100 TABLESPACE `innodb_system` */ ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
