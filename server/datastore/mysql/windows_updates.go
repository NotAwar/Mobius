...
func (ds *Datastore) InsertWindowsUpdates(ctx context.Context, hostID uint, updates []mobius.WindowsUpdate) error {
	if len(updates) == 0 {
		return nil
	}
