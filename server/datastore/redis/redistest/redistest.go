...
func (nopRedis) Mode() mobius.RedisMode { return mobius.RedisStandalone }
...
func NopRedis() mobius.RedisPool {
	return nopRedis{}
}

func SetupRedis(tb testing.TB, cleanupKeyPrefix string, cluster, redir, readReplica bool) mobius.RedisPool {
	return SetupRedisWithConfig(tb, cleanupKeyPrefix, cluster, redir, readReplica, redis.PoolConfig{})
}

func SetupRedisWithConfig(tb testing.TB, cleanupKeyPrefix string, cluster, redir, readReplica bool, config redis.PoolConfig) mobius.RedisPool {
...
func cleanup(tb testing.TB, pool mobius.RedisPool, cleanupKeyPrefix string) {
