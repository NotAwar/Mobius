...
var testFunctions = [...]func(*testing.T, mobius.LiveQueryStore){
	testLiveQuery,
...
func testLiveQuery(t *testing.T, store mobius.LiveQueryStore) {
...
func testLiveQueryNoTargets(t *testing.T, store mobius.LiveQueryStore) {
	assert.Error(t, store.RunQuery("test", "select 1", []uint{}))
}

func testLiveQueryStopQuery(t *testing.T, store mobius.LiveQueryStore) {
...
func testLiveQueryExpiredQuery(t *testing.T, store mobius.LiveQueryStore) {
...
func testLiveQueryOnlyExpired(t *testing.T, store mobius.LiveQueryStore) {
	oldModulo := cleanupExpiredQueriesModulo
	cleanupExpiredQueriesModulo = 1 // run the cleanup each time
	t.Cleanup(func() { cleanupExpiredQueriesModulo = oldModulo })
...
func testLiveQueryCleanupInactive(t *testing.T, store mobius.LiveQueryStore) {
