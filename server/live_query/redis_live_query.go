...
// is a bitfield representing _all_ the hosts in mobius.
//
...
//
// We believe that normal mobius usage has many hosts, and a small
...
func NewRedisLiveQuery(pool mobius.RedisPool, logger kitlog.Logger, memCacheExp time.Duration) *redisLiveQuery {
