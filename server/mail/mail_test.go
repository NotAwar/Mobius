...
var testFunctions = [...]func(*testing.T, mobius.MailService){
	testSMTPPlainAuth,
...
func TestCanSendMail(t *testing.T) {
	...
	require.False(t, r.CanSendEmail(mobius.SMTPSettings{}))
}
...
func testSMTPPlainAuth(t *testing.T, mailer mobius.MailService) {
	mail := mobius.Email{
		Subject: "smtp plain auth",
		To:      []string{"john@mobius.co"},
...
func testSMTPPlainAuthInvalidCreds(t *testing.T, mailer mobius.MailService) {
	mail := mobius.Email{
...
func testSMTPSkipVerify(t *testing.T, mailer mobius.MailService) {
	mail := mobius.Email{
		Subject: "skip verify",
		To:      []string{"john@mobius.co"},
		SMTPSettings: mobius.SMTPSettings{
...
func testSMTPNoAuthWithTLS(t *testing.T, mailer mobius.MailService) {
	mail := mobius.Email{
		Subject: "no auth",
...
func testSMTPDomain(t *testing.T, mailer mobius.MailService) {
...
func testMailTest(t *testing.T, mailer mobius.MailService) {
	mail := mobius.Email{
		Subject: "test tester",
		To:      []string{"bob@foo.com"},
		SMTPSettings: mobius.SMTPSettings{
