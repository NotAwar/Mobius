...
func getFromSES(e mobius.Email) (string, error) {
...
func (s *sesSender) SendEmail(e mobius.Email) error {
	if s.client == nil {
...
func (s *sesSender) CanSendEmail(smtpSettings mobius.SMTPSettings) bool {
	return s.client != nil
}
...
func (s *sesSender) sendMail(e mobius.Email, msg []byte) error {
