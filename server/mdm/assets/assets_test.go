...
func TestCAKeyPair(t *testing.T) {
	...
	ds.GetAllMDMConfigAssetsByNameFunc = func(ctx context.Context, assetNames []mobius.MDMAssetName,
		...
		require.ElementsMatch(t, []mobius.MDMAssetName{mobius.MDMAssetCACert, mobius.MDMAssetCAKey}, assetNames)
		return assets, nil
	}
...
func TestAPNSKeyPair(t *testing.T) {
	...
	assets := map[mobius.MDMAssetName]mobius.MDMConfigAsset{
		mobius.MDMAssetAPNSCert: {Value: certPEM},
		mobius.MDMAssetAPNSKey:  {Value: keyPEM},
	}
	ds.GetAllMDMConfigAssetsByNameFunc = func(ctx context.Context, assetNames []mobius.MDMAssetName,
		_ sqlx.QueryerContext) (map[mobius.MDMAssetName]mobius.MDMConfigAsset, error) {
		require.ElementsMatch(t, []mobius.MDMAssetName{mobius.MDMAssetAPNSCert, mobius.MDMAssetAPNSKey}, assetNames)
		return assets, nil
	}
...
func TestX509Cert(t *testing.T) {
	...
	ds.GetAllMDMConfigAssetsByNameFunc = func(ctx context.Context, assetNames []mobius.MDMAssetName,
		_ sqlx.QueryerContext) (map[mobius.MDMAssetName]mobius.MDMConfigAsset, error) {
		require.ElementsMatch(t, []mobius.MDMAssetName{mobius.MDMAssetAPNSCert}, assetNames)
		return assets, nil
	}
...
func TestABMToken(t *testing.T) {
	...
	assets := map[mobius.MDMAssetName]mobius.MDMConfigAsset{
		mobius.MDMAssetABMCert: {Value: certPEM},
		mobius.MDMAssetABMKey:  {Value: keyPEM},
	}
	ds.GetAllMDMConfigAssetsByNameFunc = func(ctx context.Context, assetNames []mobius.MDMAssetName,
		_ sqlx.QueryerContext) (map[mobius.MDMAssetName]mobius.MDMConfigAsset, error) {
		require.ElementsMatch(t, []mobius.MDMAssetName{
	...
	ds.GetABMTokenByOrgNameFunc = func(ctx context.Context, orgName string) (*mobius.ABMToken, error) {
