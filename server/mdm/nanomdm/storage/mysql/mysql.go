...
type MySQLStorage struct {
	...
	reader        func(ctx context.Context) mobius.DBReader
}
...
func WithReaderFunc(readerFunc func(ctx context.Context) mobius.DBReader) Option {
...
func New(opts ...Option) (*MySQLStorage, error) {
	...
	if cfg.reader == nil {
		mysqlStore.reader = func(ctx context.Context) mobius.DBReader {
	...
	if v := os.Getenv("MOBIUS_DISABLE_ASYNC_NANO_LAST_SEEN"); v != "1" {
