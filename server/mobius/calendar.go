...
const (
	...
	CalendarDefaultResolution  = (`• Click the <a href="https://mobiusmdm.com/better" rel="noreferrer" target="_blank" >Mobius</a> icon in your computer&apos;s menu and<br />&nbsp;&nbsp;&nbsp;select <b>My device</b>
