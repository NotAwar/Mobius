...
const (
	...
	// CronRefreshVPPAppVersions updates the versions of VPP apps in Mobius to the latest value. Runs
	// every 1h.
...
type CronStats struct {
	...
	Name string `db:"name"`
	// Instance is the unique id of the Mobius instance that performed the run of jobs represented by
	// the stats.
