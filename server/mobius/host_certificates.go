...
type HostCertificateRecord struct {
	...
	// CreatedAt is the time the certificate was recorded by Mobius (i.e. certificate initially
	// reported to Mobius).
	CreatedAt time.Time `json:"-" db:"created_at"`
	// DeletedAt is the time the certificate was soft deleted by Mobius (i.e. previously reported to
	// Mobius certificate is subsequently not reported).
...
// "/C=US/O=Mobius Device Management Inc./OU=Mobius Device Management Inc./CN=MobiusDM".
//
