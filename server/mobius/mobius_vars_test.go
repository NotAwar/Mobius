...
echo $MOBIUS_SECRET_FOO is the secret
echo words${MOBIUS_SECRET_BAR}words
$MOBIUS_SECRET_BAZ
${MOBIUS_SECRET_QUX}
`
...
We want to remember $MOBIUS_SECRET_BANANA and also${MOBIUS_SECRET_STRAWBERRY}are important.
`
	expected := `
This is $OTHER_VAR, $ $$ $* ${} in a sentence with${ALSO_OTHER_VAR}in the middle.
