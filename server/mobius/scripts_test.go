...
func TestUserMessage(t *testing.T) {
	...
	m = hsr.UserMessage(false, ptr.Int(0))
	require.Equal(t, "Timeout. Mobius stopped the script after 300 seconds to protect host performance.", m)
	...
	require.Equal(t, "Timeout. Mobius stopped the script after 30 seconds to protect host performance.", m)
