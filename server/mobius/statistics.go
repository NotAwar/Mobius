...
type StatisticsPayload struct {
	...
	// NumHostsNotResponding is a count of hosts that connect to Mobius successfully but fail to submit results for distributed queries.
	...
	// The number of hosts with Mobius desktop installed.
