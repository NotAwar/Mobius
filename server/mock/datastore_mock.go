...
type NewCarveFunc func(ctx context.Context, metadata *mobius.CarveMetadata) (*mobius.CarveMetadata, error)

type UpdateCarveFunc func(ctx context.Context, metadata *mobius.CarveMetadata) error

type CarveFunc func(ctx context.Context, carveId int64) (*mobius.CarveMetadata, error)

type CarveBySessionIdFunc func(ctx context.Context, sessionId string) (*mobius.CarveMetadata, error)

type CarveByNameFunc func(ctx context.Context, name string) (*mobius.CarveMetadata, error)

type ListCarvesFunc func(ctx context.Context, opt mobius.CarveListOptions) ([]*mobius.CarveMetadata, error)

type NewBlockFunc func(ctx context.Context, metadata *mobius.CarveMetadata, blockId int64, data []byte) error

type GetBlockFunc func(ctx context.Context, metadata *mobius.CarveMetadata, blockId int64) ([]byte, error)

type CleanupCarvesFunc func(ctx context.Context, now time.Time) (expired int, err error)

type NewUserFunc func(ctx context.Context, user *mobius.User) (*mobius.User, error)

type HasUsersFunc func(ctx context.Context) (bool, error)

type ListUsersFunc func(ctx context.Context, opt mobius.UserListOptions) ([]*mobius.User, error)

type UserByEmailFunc func(ctx context.Context, email string) (*mobius.User, error)

type UserByIDFunc func(ctx context.Context, id uint) (*mobius.User, error)

type UserOrDeletedUserByIDFunc func(ctx context.Context, id uint) (*mobius.User, error)

type SaveUserFunc func(ctx context.Context, user *mobius.User) error

type SaveUsersFunc func(ctx context.Context, users []*mobius.User) error
...
type UserSettingsFunc func(ctx context.Context, userID uint) (*mobius.UserSettings, error)

type ApplyQueriesFunc func(ctx context.Context, authorID uint, queries []*mobius.Query, queriesToDiscardResults map[uint]struct{}) error

type NewQueryFunc func(ctx context.Context, query *mobius.Query, opts ...mobius.OptionalArg) (*mobius.Query, error)

type SaveQueryFunc func(ctx context.Context, query *mobius.Query, shouldDiscardResults bool, shouldDeleteStats bool) error
...
type QueryFunc func(ctx context.Context, id uint) (*mobius.Query, error)

type ListQueriesFunc func(ctx context.Context, opt mobius.ListQueryOptions) ([]*mobius.Query, int, *mobius.PaginationMetadata, error)

type ListScheduledQueriesForAgentsFunc func(ctx context.Context, teamID *uint, hostID *uint, queryReportsDisabled bool) ([]*mobius.Query, error)

type QueryByNameFunc func(ctx context.Context, teamID *uint, name string) (*mobius.Query, error)
...
type GetLiveQueryStatsFunc func(ctx context.Context, queryID uint, hostIDs []uint) ([]*mobius.LiveQueryStats, error)

type UpdateLiveQueryStatsFunc func(ctx context.Context, queryID uint, stats []*mobius.LiveQueryStats) error

type CalculateAggregatedPerfStatsPercentilesFunc func(ctx context.Context, aggregate mobius.AggregatedStatsType, queryID uint) error

type NewDistributedQueryCampaignFunc func(ctx context.Context, camp *mobius.DistributedQueryCampaign) (*mobius.DistributedQueryCampaign, error)

type DistributedQueryCampaignFunc func(ctx context.Context, id uint) (*mobius.DistributedQueryCampaign, error)

type SaveDistributedQueryCampaignFunc func(ctx context.Context, camp *mobius.DistributedQueryCampaign) error

type DistributedQueryCampaignTargetIDsFunc func(ctx context.Context, id uint) (targets *mobius.HostTargets, err error)

type NewDistributedQueryCampaignTargetFunc func(ctx context.Context, target *mobius.DistributedQueryCampaignTarget) (*mobius.DistributedQueryCampaignTarget, error)
...
type DistributedQueryCampaignsForQueryFunc func(ctx context.Context, queryID uint) ([]*mobius.DistributedQueryCampaign, error)

type ApplyPackSpecsFunc func(ctx context.Context, specs []*mobius.PackSpec) error

type GetPackSpecsFunc func(ctx context.Context) ([]*mobius.PackSpec, error)

type GetPackSpecFunc func(ctx context.Context, name string) (*mobius.PackSpec, error)

type NewPackFunc func(ctx context.Context, pack *mobius.Pack, opts ...mobius.OptionalArg) (*mobius.Pack, error)

type SavePackFunc func(ctx context.Context, pack *mobius.Pack) error

type DeletePackFunc func(ctx context.Context, name string) error

type PackFunc func(ctx context.Context, pid uint) (*mobius.Pack, error)

type ListPacksFunc func(ctx context.Context, opt mobius.PackListOptions) ([]*mobius.Pack, error)

type PackByNameFunc func(ctx context.Context, name string, opts ...mobius.OptionalArg) (*mobius.Pack, bool, error)

type ListPacksForHostFunc func(ctx context.Context, hid uint) (packs []*mobius.Pack, err error)

type ApplyLabelSpecsFunc func(ctx context.Context, specs []*mobius.LabelSpec) error

type ApplyLabelSpecsWithAuthorFunc func(ctx context.Context, specs []*mobius.LabelSpec, authorId *uint) error

type GetLabelSpecsFunc func(ctx context.Context) ([]*mobius.LabelSpec, error)

type GetLabelSpecFunc func(ctx context.Context, name string) (*mobius.LabelSpec, error)
...
type UpdateLabelMembershipByHostIDsFunc func(ctx context.Context, labelID uint, hostIds []uint, teamFilter mobius.TeamFilter) (*mobius.Label, []uint, error)

type NewLabelFunc func(ctx context.Context, Label *mobius.Label, opts ...mobius.OptionalArg) (*mobius.Label, error)

type SaveLabelFunc func(ctx context.Context, label *mobius.Label, teamFilter mobius.TeamFilter) (*mobius.Label, []uint, error)

type DeleteLabelFunc func(ctx context.Context, name string) error

type LabelFunc func(ctx context.Context, lid uint, teamFilter mobius.TeamFilter) (*mobius.Label, []uint, error)

type ListLabelsFunc func(ctx context.Context, filter mobius.TeamFilter, opt mobius.ListOptions) ([]*mobius.Label, error)

type LabelsSummaryFunc func(ctx context.Context) ([]*mobius.LabelSummary, error)

type GetEnrollmentIDsWithPendingMDMAppleCommandsFunc func(ctx context.Context) ([]string, error)

type LabelQueriesForHostFunc func(ctx context.Context, host *mobius.Host) (map[string]string, error)

type ListLabelsForHostFunc func(ctx context.Context, hid uint) ([]*mobius.Label, error)

type ListHostsInLabelFunc func(ctx context.Context, filter mobius.TeamFilter, lid uint, opt mobius.HostListOptions) ([]*mobius.Host, error)

type ListUniqueHostsInLabelsFunc func(ctx context.Context, filter mobius.TeamFilter, labels []uint) ([]*mobius.Host, error)

type SearchLabelsFunc func(ctx context.Context, filter mobius.TeamFilter, query string, omit ...uint) ([]*mobius.Label, error)

type LabelIDsByNameFunc func(ctx context.Context, labels []string) (map[string]uint, error)

type LabelsByNameFunc func(ctx context.Context, names []string) (map[string]*mobius.Label, error)
...
type NewHostFunc func(ctx context.Context, host *mobius.Host) (*mobius.Host, error)

type DeleteHostFunc func(ctx context.Context, hid uint) error

type HostFunc func(ctx context.Context, id uint) (*mobius.Host, error)

type GetHostHealthFunc func(ctx context.Context, id uint) (*mobius.HostHealth, error)

type ListHostsFunc func(ctx context.Context, filter mobius.TeamFilter, opt mobius.HostListOptions) ([]*mobius.Host, error)

type ListHostsLiteByUUIDsFunc func(ctx context.Context, filter mobius.TeamFilter, uuids []string) ([]*mobius.Host, error)

type ListHostsLiteByIDsFunc func(ctx context.Context, ids []uint) ([]*mobius.Host, error)

type ListHostUsersFunc func(ctx context.Context, hostID uint) ([]mobius.HostUser, error)

type MarkHostsSeenFunc func(ctx context.Context, hostIDs []uint, t time.Time) error

type SearchHostsFunc func(ctx context.Context, filter mobius.TeamFilter, query string, omit ...uint) ([]*mobius.Host, error)
...
type GenerateHostStatusStatisticsFunc func(ctx context.Context, filter mobius.TeamFilter, now time.Time, platform *string, lowDiskSpace *int) (*mobius.HostSummary, error)

type HostIDsByIdentifierFunc func(ctx context.Context, filter mobius.TeamFilter, hostnames []string) ([]uint, error)
...
type HostIDsByOSVersionFunc func(ctx context.Context, osVersion mobius.OSVersion, offset int, limit int) ([]uint, error)

type HostByIdentifierFunc func(ctx context.Context, identifier string) (*mobius.Host, error)

type HostLiteByIdentifierFunc func(ctx context.Context, identifier string) (*mobius.HostLite, error)

type HostLiteByIDFunc func(ctx context.Context, id uint) (*mobius.HostLite, error)
...
type CountHostsFunc func(ctx context.Context, filter mobius.TeamFilter, opt mobius.HostListOptions) (int, error)

type CountHostsInLabelFunc func(ctx context.Context, filter mobius.TeamFilter, lid uint, opt mobius.HostListOptions) (int, error)

type ListHostDeviceMappingFunc func(ctx context.Context, id uint) ([]*mobius.HostDeviceMapping, error)

type SetOrUpdateCustomHostDeviceMappingFunc func(ctx context.Context, hostID uint, email string, source string) ([]*mobius.HostDeviceMapping, error)

type ListHostBatteriesFunc func(ctx context.Context, id uint) ([]*mobius.HostBattery, error)

type ListUpcomingHostMaintenanceWindowsFunc func(ctx context.Context, hid uint) ([]*mobius.HostMaintenanceWindow, error)

type LoadHostByDeviceAuthTokenFunc func(ctx context.Context, authToken string, tokenTTL time.Duration) (*mobius.Host, error)

type SetOrUpdateDeviceAuthTokenFunc func(ctx context.Context, hostID uint, authToken string) error

type FailingPoliciesCountFunc func(ctx context.Context, host *mobius.Host) (uint, error)

type ListPoliciesForHostFunc func(ctx context.Context, host *mobius.Host) ([]*mobius.HostPolicy, error)

type GetHostMunkiVersionFunc func(ctx context.Context, hostID uint) (string, error)

type GetHostMunkiIssuesFunc func(ctx context.Context, hostID uint) ([]*mobius.HostMunkiIssue, error)

type GetHostMDMFunc func(ctx context.Context, hostID uint) (*mobius.HostMDM, error)

type GetHostMDMCheckinInfoFunc func(ctx context.Context, hostUUID string) (*mobius.HostMDMCheckinInfo, error)

type ListIOSAndIPadOSToRefetchFunc func(ctx context.Context, refetchInterval time.Duration) (devices []mobius.AppleDevicesToRefetch, err error)

type AddHostMDMCommandsFunc func(ctx context.Context, commands []mobius.HostMDMCommand) error

type GetHostMDMCommandsFunc func(ctx context.Context, hostID uint) (commands []mobius.HostMDMCommand, err error)

type RemoveHostMDMCommandFunc func(ctx context.Context, command mobius.HostMDMCommand) error
...
type IsHostConnectedToMobiusMDMFunc func(ctx context.Context, host *mobius.Host) (bool, error)

type ListHostCertificatesFunc func(ctx context.Context, hostID uint, opts mobius.ListOptions) ([]*mobius.HostCertificateRecord, *mobius.PaginationMetadata, error)

type UpdateHostCertificatesFunc func(ctx context.Context, hostID uint, hostUUID string, certs []*mobius.HostCertificateRecord) error

type AreHostsConnectedToMobiusMDMFunc func(ctx context.Context, hosts []*mobius.Host) (map[string]bool, error)

type AggregatedMunkiVersionFunc func(ctx context.Context, teamID *uint) ([]mobius.AggregatedMunkiVersion, time.Time, error)

type AggregatedMunkiIssuesFunc func(ctx context.Context, teamID *uint) ([]mobius.AggregatedMunkiIssue, time.Time, error)

type AggregatedMDMStatusFunc func(ctx context.Context, teamID *uint, platform string) (mobius.AggregatedMDMStatus, time.Time, error)

type AggregatedMDMSolutionsFunc func(ctx context.Context, teamID *uint, platform string) ([]mobius.AggregatedMDMSolutions, time.Time, error)

type GenerateAggregatedMunkiAndMDMFunc func(ctx context.Context) error

type GetMunkiIssueFunc func(ctx context.Context, munkiIssueID uint) (*mobius.MunkiIssue, error)

type GetMDMSolutionFunc func(ctx context.Context, mdmID uint) (*mobius.MDMSolution, error)

type OSVersionsFunc func(ctx context.Context, teamFilter *mobius.TeamFilter, platform *string, name *string, version *string) (*mobius.OSVersions, error)

type OSVersionsByCVEFunc func(ctx context.Context, cve string, teamID *uint) ([]*mobius.VulnerableOS, time.Time, error)

type SoftwareByCVEFunc func(ctx context.Context, cve string, teamID *uint) ([]*mobius.VulnerableSoftware, time.Time, error)

type OSVersionFunc func(ctx context.Context, osVersionID uint, teamFilter *mobius.TeamFilter) (*mobius.OSVersion, *time.Time, error)

type UpdateOSVersionsFunc func(ctx context.Context) error

type CountHostsInTargetsFunc func(ctx context.Context, filter mobius.TeamFilter, targets mobius.HostTargets, now time.Time) (mobius.TargetMetrics, error)

type HostIDsInTargetsFunc func(ctx context.Context, filter mobius.TeamFilter, targets mobius.HostTargets) ([]uint, error)

type NewPasswordResetRequestFunc func(ctx context.Context, req *mobius.PasswordResetRequest) (*mobius.PasswordResetRequest, error)

type DeletePasswordResetRequestsForUserFunc func(ctx context.Context, userID uint) error

type FindPasswordResetByTokenFunc func(ctx context.Context, token string) (*mobius.PasswordResetRequest, error)

type CleanupExpiredPasswordResetRequestsFunc func(ctx context.Context) error

type SessionByKeyFunc func(ctx context.Context, key string) (*mobius.Session, error)

type SessionByIDFunc func(ctx context.Context, id uint) (*mobius.Session, error)

type ListSessionsForUserFunc func(ctx context.Context, id uint) ([]*mobius.Session, error)

type NewSessionFunc func(ctx context.Context, userID uint, sessionKeySize int) (*mobius.Session, error)

type DestroySessionFunc func(ctx context.Context, session *mobius.Session) error

type DestroyAllSessionsForUserFunc func(ctx context.Context, id uint) error

type MarkSessionAccessedFunc func(ctx context.Context, session *mobius.Session) error

type SessionByMFATokenFunc func(ctx context.Context, token string, sessionKeySize int) (*mobius.Session, *mobius.User, error)

type NewMFATokenFunc func(ctx context.Context, userID uint) (string, error)

type NewAppConfigFunc func(ctx context.Context, info *mobius.AppConfig) (*mobius.AppConfig, error)

type AppConfigFunc func(ctx context.Context) (*mobius.AppConfig, error)

type SaveAppConfigFunc func(ctx context.Context, info *mobius.AppConfig) error

type GetEnrollSecretsFunc func(ctx context.Context, teamID *uint) ([]*mobius.EnrollSecret, error)

type ApplyEnrollSecretsFunc func(ctx context.Context, teamID *uint, secrets []*mobius.EnrollSecret) error

type AggregateEnrollSecretPerTeamFunc func(ctx context.Context) ([]*mobius.EnrollSecret, error)

type GetYaraRulesFunc func(ctx context.Context) ([]mobius.YaraRule, error)

type ApplyYaraRulesFunc func(ctx context.Context, rules []mobius.YaraRule) error

type YaraRuleByNameFunc func(ctx context.Context, name string) (*mobius.YaraRule, error)

type NewInviteFunc func(ctx context.Context, i *mobius.Invite) (*mobius.Invite, error)

type ListInvitesFunc func(ctx context.Context, opt mobius.ListOptions) ([]*mobius.Invite, error)

type InviteFunc func(ctx context.Context, id uint) (*mobius.Invite, error)

type InviteByEmailFunc func(ctx context.Context, email string) (*mobius.Invite, error)

type InviteByTokenFunc func(ctx context.Context, token string) (*mobius.Invite, error)

type DeleteInviteFunc func(ctx context.Context, id uint) error

type UpdateInviteFunc func(ctx context.Context, id uint, i *mobius.Invite) (*mobius.Invite, error)

type ListScheduledQueriesInPackWithStatsFunc func(ctx context.Context, id uint, opts mobius.ListOptions) ([]*mobius.ScheduledQuery, error)

type NewScheduledQueryFunc func(ctx context.Context, sq *mobius.ScheduledQuery, opts ...mobius.OptionalArg) (*mobius.ScheduledQuery, error)

type SaveScheduledQueryFunc func(ctx context.Context, sq *mobius.ScheduledQuery) (*mobius.ScheduledQuery, error)

type DeleteScheduledQueryFunc func(ctx context.Context, id uint) error

type ScheduledQueryFunc func(ctx context.Context, id uint) (*mobius.ScheduledQuery, error)
...
type QueryResultRowsFunc func(ctx context.Context, queryID uint, filter mobius.TeamFilter) ([]*mobius.ScheduledQueryResultRow, error)

type QueryResultRowsForHostFunc func(ctx context.Context, queryID uint, hostID uint) ([]*mobius.ScheduledQueryResultRow, error)
...
type OverwriteQueryResultRowsFunc func(ctx context.Context, rows []*mobius.ScheduledQueryResultRow, maxQueryReportRows int) error

type CleanupDiscardedQueryResultsFunc func(ctx context.Context) error

type NewTeamFunc func(ctx context.Context, team *mobius.Team) (*mobius.Team, error)

type SaveTeamFunc func(ctx context.Context, team *mobius.Team) (*mobius.Team, error)

type TeamFunc func(ctx context.Context, tid uint) (*mobius.Team, error)

type TeamWithoutExtrasFunc func(ctx context.Context, tid uint) (*mobius.Team, error)

type DeleteTeamFunc func(ctx context.Context, tid uint) error

type TeamByNameFunc func(ctx context.Context, name string) (*mobius.Team, error)

type TeamByFilenameFunc func(ctx context.Context, filename string) (*mobius.Team, error)

type ListTeamsFunc func(ctx context.Context, filter mobius.TeamFilter, opt mobius.ListOptions) ([]*mobius.Team, error)

type TeamsSummaryFunc func(ctx context.Context) ([]*mobius.TeamSummary, error)

type SearchTeamsFunc func(ctx context.Context, filter mobius.TeamFilter, matchQuery string, omit ...uint) ([]*mobius.Team, error)

type TeamEnrollSecretsFunc func(ctx context.Context, teamID uint) ([]*mobius.EnrollSecret, error)

type DeleteIntegrationsFromTeamsFunc func(ctx context.Context, deletedIntgs mobius.Integrations) error

type TeamExistsFunc func(ctx context.Context, teamID uint) (bool, error)

type ListSoftwareTitlesFunc func(ctx context.Context, opt mobius.SoftwareTitleListOptions, tmFilter mobius.TeamFilter) ([]mobius.SoftwareTitleListResult, int, *mobius.PaginationMetadata, error)

type SoftwareTitleByIDFunc func(ctx context.Context, id uint, teamID *uint, tmFilter mobius.TeamFilter) (*mobius.SoftwareTitle, error)

type UpdateSoftwareTitleNameFunc func(ctx context.Context, id uint, name string) error

type InsertSoftwareInstallRequestFunc func(ctx context.Context, hostID uint, softwareInstallerID uint, opts mobius.HostSoftwareInstallOptions) (string, error)
...
type ListSoftwareForVulnDetectionFunc func(ctx context.Context, filter mobius.VulnSoftwareFilter) ([]mobius.Software, error)

type ListSoftwareVulnerabilitiesByHostIDsSourceFunc func(ctx context.Context, hostIDs []uint, source mobius.VulnerabilitySource) (map[uint][]mobius.SoftwareVulnerability, error)

type LoadHostSoftwareFunc func(ctx context.Context, host *mobius.Host, includeCVEScores bool) error

type AllSoftwareIteratorFunc func(ctx context.Context, query mobius.SoftwareIterQueryOptions) (mobius.SoftwareIterator, error)

type UpsertSoftwareCPEsFunc func(ctx context.Context, cpes []mobius.SoftwareCPE) (int64, error)

type DeleteSoftwareCPEsFunc func(ctx context.Context, cpes []mobius.SoftwareCPE) (int64, error)

type ListSoftwareCPEsFunc func(ctx context.Context) ([]mobius.SoftwareCPE, error)

type InsertSoftwareVulnerabilityFunc func(ctx context.Context, vuln mobius.SoftwareVulnerability, source mobius.VulnerabilitySource) (bool, error)

type SoftwareByIDFunc func(ctx context.Context, id uint, teamID *uint, includeCVEScores bool, tmFilter *mobius.TeamFilter) (*mobius.Software, error)

type ListSoftwareByHostIDShortFunc func(ctx context.Context, hostID uint) ([]mobius.Software, error)
...
type HostVulnSummariesBySoftwareIDsFunc func(ctx context.Context, softwareIDs []uint) ([]mobius.HostVulnerabilitySummary, error)

type HostsByCVEFunc func(ctx context.Context, cve string) ([]mobius.HostVulnerabilitySummary, error)

type InsertCVEMetaFunc func(ctx context.Context, cveMeta []mobius.CVEMeta) error

type ListCVEsFunc func(ctx context.Context, maxAge time.Duration) ([]mobius.CVEMeta, error)

type ListHostSoftwareFunc func(ctx context.Context, host *mobius.Host, opts mobius.HostSoftwareTitleListOptions) ([]*mobius.HostSoftwareWithInstaller, *mobius.PaginationMetadata, error)
...
type SetHostSoftwareInstallResultFunc func(ctx context.Context, result *mobius.HostSoftwareInstallResultPayload) (wasCanceled bool, err error)

type UploadedSoftwareExistsFunc func(ctx context.Context, bundleIdentifier string, teamID *uint) (bool, error)

type NewSoftwareCategoryFunc func(ctx context.Context, name string) (*mobius.SoftwareCategory, error)
...
type GetVPPInstallsByVerificationUUIDFunc func(ctx context.Context, verificationUUID string) ([]*mobius.HostVPPSoftwareInstall, error)

type SetVPPInstallAsFailedFunc func(ctx context.Context, hostID uint, installUUID string) error

type GetHostOperatingSystemFunc func(ctx context.Context, hostID uint) (*mobius.OperatingSystem, error)

type ListOperatingSystemsFunc func(ctx context.Context) ([]mobius.OperatingSystem, error)

type ListOperatingSystemsForPlatformFunc func(ctx context.Context, platform string) ([]mobius.OperatingSystem, error)

type UpdateHostOperatingSystemFunc func(ctx context.Context, hostID uint, hostOS mobius.OperatingSystem) error
...
type NewActivityFunc func(ctx context.Context, user *mobius.User, activity mobius.ActivityDetails, details []byte, createdAt time.Time) error

type ListActivitiesFunc func(ctx context.Context, opt mobius.ListActivitiesOptions) ([]*mobius.Activity, *mobius.PaginationMetadata, error)

type MarkActivitiesAsStreamedFunc func(ctx context.Context, activityIDs []uint) error

type ListHostUpcomingActivitiesFunc func(ctx context.Context, hostID uint, opt mobius.ListOptions) ([]*mobius.UpcomingActivity, *mobius.PaginationMetadata, error)

type CancelHostUpcomingActivityFunc func(ctx context.Context, hostID uint, executionID string) (mobius.ActivityDetails, error)

type ListHostPastActivitiesFunc func(ctx context.Context, hostID uint, opt mobius.ListOptions) ([]*mobius.Activity, *mobius.PaginationMetadata, error)

type IsExecutionPendingForHostFunc func(ctx context.Context, hostID uint, scriptID uint) (bool, error)

type GetHostUpcomingActivityMetaFunc func(ctx context.Context, hostID uint, executionID string) (*mobius.UpcomingActivityMeta, error)

type UnblockHostsUpcomingActivityQueueFunc func(ctx context.Context, maxHosts int) (int, error)

type ShouldSendStatisticsFunc func(ctx context.Context, frequency time.Duration, config config.MobiusConfig) (mobius.StatisticsPayload, bool, error)

type RecordStatisticsSentFunc func(ctx context.Context) error

type CleanupStatisticsFunc func(ctx context.Context) error

type ApplyPolicySpecsFunc func(ctx context.Context, authorID uint, specs []*mobius.PolicySpec) error

type NewGlobalPolicyFunc func(ctx context.Context, authorID *uint, args mobius.PolicyPayload) (*mobius.Policy, error)

type PolicyFunc func(ctx context.Context, id uint) (*mobius.Policy, error)

type PolicyLiteFunc func(ctx context.Context, id uint) (*mobius.PolicyLite, error)

type SavePolicyFunc func(ctx context.Context, p *mobius.Policy, shouldRemoveAllPolicyMemberships bool, removePolicyStats bool) error

type ListGlobalPoliciesFunc func(ctx context.Context, opts mobius.ListOptions) ([]*mobius.Policy, error)

type PoliciesByIDFunc func(ctx context.Context, ids []uint) (map[uint]*mobius.Policy, error)
...
type PolicyQueriesForHostFunc func(ctx context.Context, host *mobius.Host) (map[string]string, error)

type GetTeamHostsPolicyMembershipsFunc func(ctx context.Context, domain string, teamID uint, policyIDs []uint, hostID *uint) ([]mobius.HostPolicyMembershipData, error)

type GetPoliciesWithAssociatedInstallerFunc func(ctx context.Context, teamID uint, policyIDs []uint) ([]mobius.PolicySoftwareInstallerData, error)

type GetPoliciesWithAssociatedVPPFunc func(ctx context.Context, teamID uint, policyIDs []uint) ([]mobius.PolicyVPPData, error)

type GetPoliciesWithAssociatedScriptFunc func(ctx context.Context, teamID uint, policyIDs []uint) ([]mobius.PolicyScriptData, error)

type GetCalendarPoliciesFunc func(ctx context.Context, teamID uint) ([]mobius.PolicyCalendarData, error)

type GetPoliciesForConditionalAccessFunc func(ctx context.Context, teamID uint) ([]uint, error)

type AsyncBatchInsertPolicyMembershipFunc func(ctx context.Context, batch []mobius.PolicyMembershipResult) error
...
type MigrationStatusFunc func(ctx context.Context) (*mobius.MigrationStatus, error)

type ListSoftwareFunc func(ctx context.Context, opt mobius.SoftwareListOptions) ([]mobius.Software, *mobius.PaginationMetadata, error)

type CountSoftwareFunc func(ctx context.Context, opt mobius.SoftwareListOptions) (int, error)

type DeleteSoftwareVulnerabilitiesFunc func(ctx context.Context, vulnerabilities []mobius.SoftwareVulnerability) error

type DeleteOutOfDateVulnerabilitiesFunc func(ctx context.Context, source mobius.VulnerabilitySource, duration time.Duration) error

type CreateOrUpdateCalendarEventFunc func(ctx context.Context, uuid string, email string, startTime time.Time, endTime time.Time, data []byte, timeZone *string, hostID uint, webhookStatus mobius.CalendarWebhookStatus) (*mobius.CalendarEvent, error)

type GetCalendarEventFunc func(ctx context.Context, email string) (*mobius.CalendarEvent, error)

type GetCalendarEventDetailsByUUIDFunc func(ctx context.Context, uuid string) (*mobius.CalendarEventDetails, error)
...
type GetHostCalendarEventFunc func(ctx context.Context, hostID uint) (*mobius.HostCalendarEvent, *mobius.CalendarEvent, error)

type GetHostCalendarEventByEmailFunc func(ctx context.Context, email string) (*mobius.HostCalendarEvent, *mobius.CalendarEvent, error)

type UpdateHostCalendarWebhookStatusFunc func(ctx context.Context, hostID uint, status mobius.CalendarWebhookStatus) error

type ListCalendarEventsFunc func(ctx context.Context, teamID *uint) ([]*mobius.CalendarEvent, error)

type ListOutOfDateCalendarEventsFunc func(ctx context.Context, t time.Time) ([]*mobius.CalendarEvent, error)

type NewTeamPolicyFunc func(ctx context.Context, teamID uint, authorID *uint, args mobius.PolicyPayload) (*mobius.Policy, error)

type ListTeamPoliciesFunc func(ctx context.Context, teamID uint, opts mobius.ListOptions, iopts mobius.ListOptions) (teamPolicies []*mobius.Policy, inheritedPolicies []*mobius.Policy, err error)

type ListMergedTeamPoliciesFunc func(ctx context.Context, teamID uint, opts mobius.ListOptions) ([]*mobius.Policy, error)

type DeleteTeamPoliciesFunc func(ctx context.Context, teamID uint, ids []uint) ([]uint, error)

type TeamPolicyFunc func(ctx context.Context, teamID uint, policyID uint) (*mobius.Policy, error)
...
type DBLocksFunc func(ctx context.Context) ([]*mobius.DBLock, error)

type GetLatestCronStatsFunc func(ctx context.Context, name string) ([]mobius.CronStats, error)

type InsertCronStatsFunc func(ctx context.Context, statsType mobius.CronStatsType, name string, instance string, status mobius.CronStatsStatus) (int, error)

type UpdateCronStatsFunc func(ctx context.Context, id int, status mobius.CronStatsStatus, cronErrors *mobius.CronScheduleErrors) error

type UpdateAllCronStatsForInstanceFunc func(ctx context.Context, instance string, fromStatus mobius.CronStatsStatus, toStatus mobius.CronStatsStatus) error
...
type LoadHostByNodeKeyFunc func(ctx context.Context, nodeKey string) (*mobius.Host, error)
...
type TeamFeaturesFunc func(ctx context.Context, teamID uint) (*mobius.Features, error)

type TeamMDMConfigFunc func(ctx context.Context, teamID uint) (*mobius.TeamMDM, error)

type SaveHostPackStatsFunc func(ctx context.Context, teamID *uint, hostID uint, stats []mobius.PackStats) error

type AsyncBatchSaveHostsScheduledQueryStatsFunc func(ctx context.Context, stats map[uint][]mobius.ScheduledQueryStats, batchSize int) (int, error)

type UpdateHostSoftwareFunc func(ctx context.Context, hostID uint, software []mobius.Software) (*mobius.UpdateHostSoftwareDBResult, error)

type UpdateHostSoftwareInstalledPathsFunc func(ctx context.Context, hostID uint, reported map[string]struct{}, mutationResults *mobius.UpdateHostSoftwareDBResult) error

type UpdateHostFunc func(ctx context.Context, host *mobius.Host) error

type ListScheduledQueriesInPackFunc func(ctx context.Context, packID uint) (mobius.ScheduledQueryList, error)
...
type RecordPolicyQueryExecutionsFunc func(ctx context.Context, host *mobius.Host, results map[uint]*bool, updated time.Time, deferredSaveHost bool) error

type RecordLabelQueryExecutionsFunc func(ctx context.Context, host *mobius.Host, results map[uint]*bool, t time.Time, deferredSaveHost bool) error

type SaveHostUsersFunc func(ctx context.Context, hostID uint, users []mobius.HostUser) error
...
type SetOrUpdateMDMDataFunc func(ctx context.Context, hostID uint, isServer bool, enrolled bool, serverURL string, installedFromDep bool, name string, mobiusEnrollRef string) error
...
type SetOrUpdateHostDiskEncryptionKeyFunc func(ctx context.Context, host *mobius.Host, encryptedBase64Key string, clientError string, decryptable *bool) error

type SaveLUKSDataFunc func(ctx context.Context, host *mobius.Host, encryptedBase64Passphrase string, encryptedBase64Salt string, keySlot uint) error

type DeleteLUKSDataFunc func(ctx context.Context, hostID uint, keySlot uint) error

type GetUnverifiedDiskEncryptionKeysFunc func(ctx context.Context) ([]mobius.HostDiskEncryptionKey, error)
...
type GetHostDiskEncryptionKeyFunc func(ctx context.Context, hostID uint) (*mobius.HostDiskEncryptionKey, error)
...
type GetHostCertAssociationsToExpireFunc func(ctx context.Context, expiryDays int, limit int) ([]mobius.SCEPIdentityAssociation, error)

type SetCommandForPendingSCEPRenewalFunc func(ctx context.Context, assocs []mobius.SCEPIdentityAssociation, cmdUUID string) error

type CleanSCEPRenewRefsFunc func(ctx context.Context, hostUUID string) error

type UpdateHostMDMProfilesVerificationFunc func(ctx context.Context, host *mobius.Host, toVerify []string, toFail []string, toRetry []string) error

type GetHostMDMProfilesExpectedForVerificationFunc func(ctx context.Context, host *mobius.Host) (map[string]*mobius.ExpectedMDMProfile, error)

type GetHostMDMProfilesRetryCountsFunc func(ctx context.Context, host *mobius.Host) ([]mobius.HostMDMProfileRetryCount, error)
...
type VerifyEnrollSecretFunc func(ctx context.Context, secret string) (*mobius.EnrollSecret, error)
...
type NewJobFunc func(ctx context.Context, job *mobius.Job) (*mobius.Job, error)

type GetQueuedJobsFunc func(ctx context.Context, maxNumJobs int, now time.Time) ([]*mobius.Job, error)

type UpdateJobFunc func(ctx context.Context, id uint, job *mobius.Job) (*mobius.Job, error)
...
type ProcessListFunc func(ctx context.Context) ([]mobius.MySQLProcess, error)

type ListWindowsUpdatesByHostIDFunc func(ctx context.Context, hostID uint) ([]mobius.WindowsUpdate, error)

type InsertWindowsUpdatesFunc func(ctx context.Context, hostID uint, updates []mobius.WindowsUpdate) error

type ListOSVulnerabilitiesByOSFunc func(ctx context.Context, osID uint) ([]mobius.OSVulnerability, error)

type ListVulnsByOsNameAndVersionFunc func(ctx context.Context, name string, version string, includeCVSS bool) (mobius.Vulnerabilities, error)

type InsertOSVulnerabilitiesFunc func(ctx context.Context, vulnerabilities []mobius.OSVulnerability, source mobius.VulnerabilitySource) (int64, error)

type DeleteOSVulnerabilitiesFunc func(ctx context.Context, vulnerabilities []mobius.OSVulnerability) error

type InsertOSVulnerabilityFunc func(ctx context.Context, vuln mobius.OSVulnerability, source mobius.VulnerabilitySource) (bool, error)

type DeleteOutOfDateOSVulnerabilitiesFunc func(ctx context.Context, source mobius.VulnerabilitySource, duration time.Duration) error

type ListVulnerabilitiesFunc func(ctx context.Context, opt mobius.VulnListOptions) ([]mobius.VulnerabilityWithMetadata, *mobius.PaginationMetadata, error)

type VulnerabilityFunc func(ctx context.Context, cve string, teamID *uint, includeCVEScores bool) (*mobius.VulnerabilityWithMetadata, error)

type CountVulnerabilitiesFunc func(ctx context.Context, opt mobius.VulnListOptions) (uint, error)

type UpdateVulnerabilityHostCountsFunc func(ctx context.Context, maxRoutines int) error

type IsCVEKnownToMobiusFunc func(ctx context.Context, cve string) (bool, error)

type NewMDMAppleConfigProfileFunc func(ctx context.Context, p mobius.MDMAppleConfigProfile, usesMobiusVars []string) (*mobius.MDMAppleConfigProfile, error)

type BulkUpsertMDMAppleConfigProfilesFunc func(ctx context.Context, payload []*mobius.MDMAppleConfigProfile) error

type GetMDMAppleConfigProfileByDeprecatedIDFunc func(ctx context.Context, profileID uint) (*mobius.MDMAppleConfigProfile, error)

type GetMDMAppleConfigProfileFunc func(ctx context.Context, profileUUID string) (*mobius.MDMAppleConfigProfile, error)

type GetMDMAppleDeclarationFunc func(ctx context.Context, declUUID string) (*mobius.MDMAppleDeclaration, error)

type ListMDMAppleConfigProfilesFunc func(ctx context.Context, teamID *uint) ([]*mobius.MDMAppleConfigProfile, error)
...
type BulkDeleteMDMAppleHostsConfigProfilesFunc func(ctx context.Context, payload []*mobius.MDMAppleProfilePayload) error
...
type GetHostMDMAppleProfilesFunc func(ctx context.Context, hostUUID string) ([]mobius.HostMDMAppleProfile, error)

type CleanupDiskEncryptionKeysOnTeamChangeFunc func(ctx context.Context, hostIDs []uint, newTeamID *uint) error

type NewMDMAppleEnrollmentProfileFunc func(ctx context.Context, enrollmentPayload mobius.MDMAppleEnrollmentProfilePayload) (*mobius.MDMAppleEnrollmentProfile, error)

type GetMDMAppleEnrollmentProfileByTokenFunc func(ctx context.Context, token string) (*mobius.MDMAppleEnrollmentProfile, error)

type GetMDMAppleEnrollmentProfileByTypeFunc func(ctx context.Context, typ mobius.MDMAppleEnrollmentType) (*mobius.MDMAppleEnrollmentProfile, error)

type ListMDMAppleEnrollmentProfilesFunc func(ctx context.Context) ([]*mobius.MDMAppleEnrollmentProfile, error)

type GetMDMAppleCommandResultsFunc func(ctx context.Context, commandUUID string) ([]*mobius.MDMCommandResult, error)

type GetVPPCommandResultsFunc func(ctx context.Context, commandUUID string, hostUUID string) ([]*mobius.MDMCommandResult, error)

type ListMDMAppleCommandsFunc func(ctx context.Context, tmFilter mobius.TeamFilter, listOpts *mobius.MDMCommandListOptions) ([]*mobius.MDMAppleCommand, error)

type NewMDMAppleInstallerFunc func(ctx context.Context, name string, size int64, manifest string, installer []byte, urlToken string) (*mobius.MDMAppleInstaller, error)

type MDMAppleInstallerFunc func(ctx context.Context, token string) (*mobius.MDMAppleInstaller, error)

type MDMAppleInstallerDetailsByIDFunc func(ctx context.Context, id uint) (*mobius.MDMAppleInstaller, error)

type DeleteMDMAppleInstallerFunc func(ctx context.Context, id uint) error

type MDMAppleInstallerDetailsByTokenFunc func(ctx context.Context, token string) (*mobius.MDMAppleInstaller, error)

type ListMDMAppleInstallersFunc func(ctx context.Context) ([]mobius.MDMAppleInstaller, error)

type BatchSetMDMAppleProfilesFunc func(ctx context.Context, tmID *uint, profiles []*mobius.MDMAppleConfigProfile) error

type MDMAppleListDevicesFunc func(ctx context.Context) ([]mobius.MDMAppleDevice, error)

type UpsertMDMAppleHostDEPAssignmentsFunc func(ctx context.Context, hosts []mobius.Host, abmTokenID uint) error

type IngestMDMAppleDevicesFromDEPSyncFunc func(ctx context.Context, devices []godep.Device, abmTokenID uint, macOSTeam *mobius.Team, iosTeam *mobius.Team, ipadTeam *mobius.Team) (int64, error)

type IngestMDMAppleDeviceFromOTAEnrollmentFunc func(ctx context.Context, teamID *uint, deviceInfo mobius.MDMAppleMachineInfo) error

type MDMAppleUpsertHostFunc func(ctx context.Context, mdmHost *mobius.Host) error

type RestoreMDMApplePendingDEPHostFunc func(ctx context.Context, host *mobius.Host) error
...
type GetHostDEPAssignmentFunc func(ctx context.Context, hostID uint) (*mobius.HostDEPAssignment, error)

type GetNanoMDMEnrollmentFunc func(ctx context.Context, id string) (*mobius.NanoEnrollment, error)

type GetNanoMDMUserEnrollmentFunc func(ctx context.Context, id string) (*mobius.NanoEnrollment, error)
...
type OutdatedAutomationBatchFunc func(ctx context.Context) ([]mobius.PolicyFailure, error)

type ListMDMAppleProfilesToInstallFunc func(ctx context.Context) ([]*mobius.MDMAppleProfilePayload, error)

type ListMDMAppleProfilesToRemoveFunc func(ctx context.Context) ([]*mobius.MDMAppleProfilePayload, error)

type BulkUpsertMDMAppleHostProfilesFunc func(ctx context.Context, payload []*mobius.MDMAppleBulkUpsertHostProfilePayload) error

type BulkSetPendingMDMHostProfilesFunc func(ctx context.Context, hostIDs []uint, teamIDs []uint, profileUUIDs []string, hostUUIDs []string) (updates mobius.MDMProfilesUpdates, err error)
...
type UpdateOrDeleteHostMDMAppleProfileFunc func(ctx context.Context, profile *mobius.HostMDMAppleProfile) error

type GetMDMAppleCommandRequestTypeFunc func(ctx context.Context, commandUUID string) (string, error)

type GetMDMAppleProfilesSummaryFunc func(ctx context.Context, teamID *uint) (*mobius.MDMProfilesSummary, error)

type InsertMDMIdPAccountFunc func(ctx context.Context, account *mobius.MDMIdPAccount) error

type GetMDMIdPAccountByUUIDFunc func(ctx context.Context, uuid string) (*mobius.MDMIdPAccount, error)

type GetMDMIdPAccountByEmailFunc func(ctx context.Context, email string) (*mobius.MDMIdPAccount, error)

type GetMDMAppleFileVaultSummaryFunc func(ctx context.Context, teamID *uint) (*mobius.MDMAppleFileVaultSummary, error)

type InsertMDMAppleBootstrapPackageFunc func(ctx context.Context, bp *mobius.MDMAppleBootstrapPackage, pkgStore mobius.MDMBootstrapPackageStore) error

type CopyDefaultMDMAppleBootstrapPackageFunc func(ctx context.Context, ac *mobius.AppConfig, toTeamID uint) error

type DeleteMDMAppleBootstrapPackageFunc func(ctx context.Context, teamID uint) error

type GetMDMAppleBootstrapPackageMetaFunc func(ctx context.Context, teamID uint) (*mobius.MDMAppleBootstrapPackage, error)

type GetMDMAppleBootstrapPackageBytesFunc func(ctx context.Context, token string, pkgStore mobius.MDMBootstrapPackageStore) (*mobius.MDMAppleBootstrapPackage, error)

type GetMDMAppleBootstrapPackageSummaryFunc func(ctx context.Context, teamID uint) (*mobius.MDMAppleBootstrapPackageSummary, error)
...
type CleanupUnusedBootstrapPackagesFunc func(ctx context.Context, pkgStore mobius.MDMBootstrapPackageStore, removeCreatedBefore time.Time) error

type GetHostMDMMacOSSetupFunc func(ctx context.Context, hostID uint) (*mobius.HostMDMMacOSSetup, error)

type MDMGetEULAMetadataFunc func(ctx context.Context) (*mobius.MDMEULA, error)

type MDMGetEULABytesFunc func(ctx context.Context, token string) (*mobius.MDMEULA, error)

type MDMInsertEULAFunc func(ctx context.Context, eula *mobius.MDMEULA) error

type MDMDeleteEULAFunc func(ctx context.Context, token string) error

type SetOrUpdateMDMAppleSetupAssistantFunc func(ctx context.Context, asst *mobius.MDMAppleSetupAssistant) (*mobius.MDMAppleSetupAssistant, error)

type GetMDMAppleSetupAssistantFunc func(ctx context.Context, teamID *uint) (*mobius.MDMAppleSetupAssistant, error)
...
type GetMatchingHostSerialsFunc func(ctx context.Context, serials []string) (map[string]*mobius.Host, error)
...
type MDMAppleDDMDeclarationsTokenFunc func(ctx context.Context, hostUUID string) (*mobius.MDMAppleDDMDeclarationsToken, error)

type MDMAppleDDMDeclarationItemsFunc func(ctx context.Context, hostUUID string) ([]mobius.MDMAppleDDMDeclarationItem, error)

type MDMAppleDDMDeclarationsResponseFunc func(ctx context.Context, identifier string, hostUUID string) (*mobius.MDMAppleDeclaration, error)
...
type MDMAppleStoreDDMStatusReportFunc func(ctx context.Context, hostUUID string, updates []*mobius.MDMAppleHostDeclaration) error

type MDMAppleSetPendingDeclarationsAsFunc func(ctx context.Context, hostUUID string, status *mobius.MDMDeliveryStatus, detail string) error

type MDMAppleSetRemoveDeclarationsAsPendingFunc func(ctx context.Context, hostUUID string, declarationUUIDs []string) error

type GetMDMAppleOSUpdatesSettingsByHostSerialFunc func(ctx context.Context, hostSerial string) (*mobius.AppleOSUpdateSettings, error)

type InsertMDMConfigAssetsFunc func(ctx context.Context, assets []mobius.MDMConfigAsset, tx sqlx.ExtContext) error

type InsertOrReplaceMDMConfigAssetFunc func(ctx context.Context, asset mobius.MDMConfigAsset) error
...
type GetAllMDMConfigAssetsHashesFunc func(ctx context.Context, assetNames []mobius.MDMAssetName) (map[mobius.MDMAssetName]string, error)

type DeleteMDMConfigAssetsByNameFunc func(ctx context.Context, assetNames []mobius.MDMAssetName) error

type HardDeleteMDMConfigAssetFunc func(ctx context.Context, assetName mobius.MDMAssetName) error

type ReplaceMDMConfigAssetsFunc func(ctx context.Context, assets []mobius.MDMConfigAsset, tx sqlx.ExtContext) error

type GetAllCAConfigAssetsByTypeFunc func(ctx context.Context, assetType mobius.CAConfigAssetType) (map[string]mobius.CAConfigAsset, error)

type GetCAConfigAssetFunc func(ctx context.Context, name string, assetType mobius.CAConfigAssetType) (*mobius.CAConfigAsset, error)

type SaveCAConfigAssetsFunc func(ctx context.Context, assets []mobius.CAConfigAsset) error
...
type SaveABMTokenFunc func(ctx context.Context, tok *mobius.ABMToken) error

type InsertVPPTokenFunc func(ctx context.Context, tok *mobius.VPPTokenData) (*mobius.VPPTokenDB, error)

type ListVPPTokensFunc func(ctx context.Context) ([]*mobius.VPPTokenDB, error)

type GetVPPTokenFunc func(ctx context.Context, tokenID uint) (*mobius.VPPTokenDB, error)

type GetVPPTokenByTeamIDFunc func(ctx context.Context, teamID *uint) (*mobius.VPPTokenDB, error)

type UpdateVPPTokenTeamsFunc func(ctx context.Context, id uint, teams []uint) (*mobius.VPPTokenDB, error)

type UpdateVPPTokenFunc func(ctx context.Context, id uint, tok *mobius.VPPTokenData) (*mobius.VPPTokenDB, error)
...
type InsertABMTokenFunc func(ctx context.Context, tok *mobius.ABMToken) (*mobius.ABMToken, error)

type ListABMTokensFunc func(ctx context.Context) ([]*mobius.ABMToken, error)

type DeleteABMTokenFunc func(ctx context.Context, tokenID uint) error

type GetABMTokenByIDFunc func(ctx context.Context, tokenID uint) (*mobius.ABMToken, error)
...
type GetMDMAppleEnrolledDeviceDeletedFromMobiusFunc func(ctx context.Context, hostUUID string) (*mobius.MDMAppleEnrolledDeviceInfo, error)

type ListMDMAppleEnrolledIPhoneIpadDeletedFromMobiusFunc func(ctx context.Context, limit int) ([]string, error)

type ReconcileMDMAppleEnrollRefFunc func(ctx context.Context, enrollRef string, machineInfo *mobius.MDMAppleMachineInfo) (string, error)

type GetMDMIdPAccountByHostUUIDFunc func(ctx context.Context, hostUUID string) (*mobius.MDMIdPAccount, error)
...
type MDMWindowsInsertEnrolledDeviceFunc func(ctx context.Context, device *mobius.MDMWindowsEnrolledDevice) error

type MDMWindowsDeleteEnrolledDeviceFunc func(ctx context.Context, mdmDeviceHWID string) error

type MDMWindowsGetEnrolledDeviceWithDeviceIDFunc func(ctx context.Context, mdmDeviceID string) (*mobius.MDMWindowsEnrolledDevice, error)

type MDMWindowsDeleteEnrolledDeviceWithDeviceIDFunc func(ctx context.Context, mdmDeviceID string) error

type MDMWindowsInsertCommandForHostsFunc func(ctx context.Context, hostUUIDs []string, cmd *mobius.MDMWindowsCommand) error

type MDMWindowsGetPendingCommandsFunc func(ctx context.Context, deviceID string) ([]*mobius.MDMWindowsCommand, error)

type MDMWindowsSaveResponseFunc func(ctx context.Context, deviceID string, enrichedSyncML mobius.EnrichedSyncML) error

type GetMDMWindowsCommandResultsFunc func(ctx context.Context, commandUUID string) ([]*mobius.MDMCommandResult, error)

type UpdateMDMWindowsEnrollmentsHostUUIDFunc func(ctx context.Context, hostUUID string, mdmDeviceID string) error

type GetMDMWindowsConfigProfileFunc func(ctx context.Context, profileUUID string) (*mobius.MDMWindowsConfigProfile, error)
...
type GetHostMDMWindowsProfilesFunc func(ctx context.Context, hostUUID string) ([]mobius.HostMDMWindowsProfile, error)

type ListMDMConfigProfilesFunc func(ctx context.Context, teamID *uint, opt mobius.ListOptions) ([]*mobius.MDMConfigProfilePayload, *mobius.PaginationMetadata, error)

type ResendHostMDMProfileFunc func(ctx context.Context, hostUUID string, profileUUID string) error

type BatchResendMDMProfileToHostsFunc func(ctx context.Context, profileUUID string, filters mobius.BatchResendMDMProfileFilters) (int64, error)

type GetMDMConfigProfileStatusFunc func(ctx context.Context, profileUUID string) (mobius.MDMConfigProfileStatus, error)

type GetHostMDMProfileInstallStatusFunc func(ctx context.Context, hostUUID string, profileUUID string) (mobius.MDMDeliveryStatus, error)

type GetLinuxDiskEncryptionSummaryFunc func(ctx context.Context, teamID *uint) (mobius.MDMLinuxDiskEncryptionSummary, error)

type GetMDMCommandPlatformFunc func(ctx context.Context, commandUUID string) (string, error)

type ListMDMCommandsFunc func(ctx context.Context, tmFilter mobius.TeamFilter, listOpts *mobius.MDMCommandListOptions) ([]*mobius.MDMCommand, error)

type GetMDMWindowsBitLockerSummaryFunc func(ctx context.Context, teamID *uint) (*mobius.MDMWindowsBitLockerSummary, error)

type GetMDMWindowsBitLockerStatusFunc func(ctx context.Context, host *mobius.Host) (*mobius.HostMDMDiskEncryption, error)

type GetMDMWindowsProfilesSummaryFunc func(ctx context.Context, teamID *uint) (*mobius.MDMProfilesSummary, error)

type ListMDMWindowsProfilesToInstallFunc func(ctx context.Context) ([]*mobius.MDMWindowsProfilePayload, error)

type ListMDMWindowsProfilesToRemoveFunc func(ctx context.Context) ([]*mobius.MDMWindowsProfilePayload, error)

type BulkUpsertMDMWindowsHostProfilesFunc func(ctx context.Context, payload []*mobius.MDMWindowsBulkUpsertHostProfilePayload) error

type GetMDMWindowsProfilesContentsFunc func(ctx context.Context, profileUUIDs []string) (map[string]mobius.MDMWindowsProfileContents, error)

type BulkDeleteMDMWindowsHostsConfigProfilesFunc func(ctx context.Context, payload []*mobius.MDMWindowsProfilePayload) error

type NewMDMWindowsConfigProfileFunc func(ctx context.Context, cp mobius.MDMWindowsConfigProfile) (*mobius.MDMWindowsConfigProfile, error)

type SetOrUpdateMDMWindowsConfigProfileFunc func(ctx context.Context, cp mobius.MDMWindowsConfigProfile) error

type BatchSetMDMProfilesFunc func(ctx context.Context, tmID *uint, macProfiles []*mobius.MDMAppleConfigProfile, winProfiles []*mobius.MDMWindowsConfigProfile, macDeclarations []*mobius.MDMAppleDeclaration, profilesVariables []mobius.MDMProfileIdentifierMobiusVariables) (updates mobius.MDMProfilesUpdates, err error)

type NewMDMAppleDeclarationFunc func(ctx context.Context, declaration *mobius.MDMAppleDeclaration) (*mobius.MDMAppleDeclaration, error)

type SetOrUpdateMDMAppleDeclarationFunc func(ctx context.Context, declaration *mobius.MDMAppleDeclaration) (*mobius.MDMAppleDeclaration, error)

type NewHostScriptExecutionRequestFunc func(ctx context.Context, request *mobius.HostScriptRequestPayload) (*mobius.HostScriptResult, error)

type SetHostScriptExecutionResultFunc func(ctx context.Context, result *mobius.HostScriptResultPayload) (hsr *mobius.HostScriptResult, action string, err error)

type GetHostScriptExecutionResultFunc func(ctx context.Context, execID string) (*mobius.HostScriptResult, error)

type GetSelfServiceUninstallScriptExecutionResultFunc func(ctx context.Context, execID string, hostID uint) (*mobius.HostScriptResult, error)

type ListPendingHostScriptExecutionsFunc func(ctx context.Context, hostID uint, onlyShowInternal bool) ([]*mobius.HostScriptResult, error)

type ListReadyToExecuteScriptsForHostFunc func(ctx context.Context, hostID uint, onlyShowInternal bool) ([]*mobius.HostScriptResult, error)

type NewScriptFunc func(ctx context.Context, script *mobius.Script) (*mobius.Script, error)

type UpdateScriptContentsFunc func(ctx context.Context, scriptID uint, scriptContents string) (*mobius.Script, error)

type ScriptFunc func(ctx context.Context, id uint) (*mobius.Script, error)
...
type ListScriptsFunc func(ctx context.Context, teamID *uint, opt mobius.ListOptions) ([]*mobius.Script, *mobius.PaginationMetadata, error)

type GetScriptIDByNameFunc func(ctx context.Context, name string, teamID *uint) (uint, error)

type GetHostScriptDetailsFunc func(ctx context.Context, hostID uint, teamID *uint, opts mobius.ListOptions, hostPlatform string) ([]*mobius.HostScriptDetail, *mobius.PaginationMetadata, error)

type BatchSetScriptsFunc func(ctx context.Context, tmID *uint, scripts []*mobius.Script) ([]mobius.ScriptResponse, error)

type BatchExecuteScriptFunc func(ctx context.Context, userID *uint, scriptID uint, hostIDs []uint) (string, error)

type BatchExecuteSummaryFunc func(ctx context.Context, executionID string) (*mobius.BatchExecutionSummary, error)

type GetHostLockWipeStatusFunc func(ctx context.Context, host *mobius.Host) (*mobius.HostLockWipeStatus, error)

type LockHostViaScriptFunc func(ctx context.Context, request *mobius.HostScriptRequestPayload, hostMobiusPlatform string) error

type UnlockHostViaScriptFunc func(ctx context.Context, request *mobius.HostScriptRequestPayload, hostMobiusPlatform string) error

type UnlockHostManuallyFunc func(ctx context.Context, hostID uint, hostMobiusPlatform string, ts time.Time) error
...
type WipeHostViaScriptFunc func(ctx context.Context, request *mobius.HostScriptRequestPayload, hostMobiusPlatform string) error

type WipeHostViaWindowsMDMFunc func(ctx context.Context, host *mobius.Host, cmd *mobius.MDMWindowsCommand) error
...
type GetSoftwareInstallDetailsFunc func(ctx context.Context, executionId string) (*mobius.SoftwareInstallDetails, error)
...
type GetHostLastInstallDataFunc func(ctx context.Context, hostID uint, installerID uint) (*mobius.HostLastInstallData, error)
...
type UpdateSoftwareInstallerWithoutPackageIDsFunc func(ctx context.Context, id uint, payload mobius.UploadSoftwareInstallerPayload) error
...
type SaveInstallerUpdatesFunc func(ctx context.Context, payload *mobius.UpdateSoftwareInstallerPayload) error

type UpdateInstallerSelfServiceFlagFunc func(ctx context.Context, selfService bool, id uint) error

type GetVPPAppByTeamAndTitleIDFunc func(ctx context.Context, teamID *uint, titleID uint) (*mobius.VPPApp, error)

type GetVPPAppMetadataByTeamAndTitleIDFunc func(ctx context.Context, teamID *uint, titleID uint) (*mobius.VPPAppStoreApp, error)

type MapAdamIDsPendingInstallFunc func(ctx context.Context, hostID uint) (map[string]struct{}, error)

type GetTitleInfoFromVPPAppsTeamsIDFunc func(ctx context.Context, vppAppsTeamsID uint) (*mobius.PolicySoftwareTitle, error)

type GetVPPAppMetadataByAdamIDPlatformTeamIDFunc func(ctx context.Context, adamID string, platform mobius.AppleDevicePlatform, teamID *uint) (*mobius.VPPApp, error)

type DeleteSoftwareInstallerFunc func(ctx context.Context, id uint) error

type DeleteVPPAppFromTeamFunc func(ctx context.Context, teamID *uint, appID mobius.VPPAppID) error

type GetSummaryHostSoftwareInstallsFunc func(ctx context.Context, installerID uint) (*mobius.SoftwareInstallerStatusSummary, error)

type GetSummaryHostVPPAppInstallsFunc func(ctx context.Context, teamID *uint, appID mobius.VPPAppID) (*mobius.VPPAppStatusSummary, error)

type GetSoftwareInstallResultsFunc func(ctx context.Context, resultsUUID string) (*mobius.HostSoftwareInstallerResult, error)

type CleanupUnusedSoftwareInstallersFunc func(ctx context.Context, softwareInstallStore mobius.SoftwareInstallerStore, removeCreatedBefore time.Time) error

type BatchSetSoftwareInstallersFunc func(ctx context.Context, tmID *uint, installers []*mobius.UploadSoftwareInstallerPayload) error

type GetSoftwareInstallersFunc func(ctx context.Context, tmID uint) ([]mobius.SoftwarePackageResponse, error)

type HasSelfServiceSoftwareInstallersFunc func(ctx context.Context, platform string, teamID *uint) (bool, error)

type BatchInsertVPPAppsFunc func(ctx context.Context, apps []*mobius.VPPApp) error

type GetAssignedVPPAppsFunc func(ctx context.Context, teamID *uint) (map[mobius.VPPAppID]mobius.VPPAppTeam, error)

type GetVPPAppsFunc func(ctx context.Context, teamID *uint) ([]mobius.VPPAppResponse, error)

type SetTeamVPPAppsFunc func(ctx context.Context, teamID *uint, appIDs []mobius.VPPAppTeam) error

type InsertVPPAppWithTeamFunc func(ctx context.Context, app *mobius.VPPApp, teamID *uint) (*mobius.VPPApp, error)

type GetAllVPPAppsFunc func(ctx context.Context) ([]*mobius.VPPApp, error)

type InsertVPPAppsFunc func(ctx context.Context, apps []*mobius.VPPApp) error

type InsertHostVPPSoftwareInstallFunc func(ctx context.Context, hostID uint, appID mobius.VPPAppID, commandUUID string, associatedEventID string, opts mobius.HostSoftwareInstallOptions) error

type GetPastActivityDataForVPPAppInstallFunc func(ctx context.Context, commandResults *mdm.CommandResults) (*mobius.User, *mobius.ActivityInstalledAppStoreApp, error)

type GetVPPTokenByLocationFunc func(ctx context.Context, loc string) (*mobius.VPPTokenDB, error)
...
type ListSetupExperienceSoftwareTitlesFunc func(ctx context.Context, teamID uint, opts mobius.ListOptions) ([]mobius.SoftwareTitleListResult, int, *mobius.PaginationMetadata, error)
...
type GetTeamsWithInstallerByHashFunc func(ctx context.Context, sha256 string, url string) (map[uint]*mobius.ExistingSoftwareInstaller, error)

type ListSetupExperienceResultsByHostUUIDFunc func(ctx context.Context, hostUUID string) ([]*mobius.SetupExperienceStatusResult, error)

type UpdateSetupExperienceStatusResultFunc func(ctx context.Context, status *mobius.SetupExperienceStatusResult) error

type EnqueueSetupExperienceItemsFunc func(ctx context.Context, hostUUID string, teamID uint) (bool, error)

type GetSetupExperienceScriptFunc func(ctx context.Context, teamID *uint) (*mobius.Script, error)

type GetSetupExperienceScriptByIDFunc func(ctx context.Context, scriptID uint) (*mobius.Script, error)

type SetSetupExperienceScriptFunc func(ctx context.Context, script *mobius.Script) error

type DeleteSetupExperienceScriptFunc func(ctx context.Context, teamID *uint) error

type MaybeUpdateSetupExperienceScriptStatusFunc func(ctx context.Context, hostUUID string, executionID string, status mobius.SetupExperienceStatusResultStatus) (bool, error)

type MaybeUpdateSetupExperienceSoftwareInstallStatusFunc func(ctx context.Context, hostUUID string, executionID string, status mobius.SetupExperienceStatusResultStatus) (bool, error)

type MaybeUpdateSetupExperienceVPPStatusFunc func(ctx context.Context, hostUUID string, commandUUID string, status mobius.SetupExperienceStatusResultStatus) (bool, error)

type ListAvailableMobiusMaintainedAppsFunc func(ctx context.Context, teamID *uint, opt mobius.ListOptions) ([]mobius.MaintainedApp, *mobius.PaginationMetadata, error)

type ClearRemovedMobiusMaintainedAppsFunc func(ctx context.Context, slugsToKeep []string) error

type GetMaintainedAppByIDFunc func(ctx context.Context, appID uint, teamID *uint) (*mobius.MaintainedApp, error)

type GetMaintainedAppBySlugFunc func(ctx context.Context, slug string, teamID *uint) (*mobius.MaintainedApp, error)

type UpsertMaintainedAppFunc func(ctx context.Context, app *mobius.MaintainedApp) (*mobius.MaintainedApp, error)

type BulkUpsertMDMManagedCertificatesFunc func(ctx context.Context, payload []*mobius.MDMManagedCertificate) error

type GetHostMDMCertificateProfileFunc func(ctx context.Context, hostUUID string, profileUUID string, caName string) (*mobius.HostMDMCertificateProfile, error)
...
type ListHostMDMManagedCertificatesFunc func(ctx context.Context, hostUUID string) ([]*mobius.MDMManagedCertificate, error)

type ResendHostCustomSCEPProfileFunc func(ctx context.Context, hostUUID string, profUUID string) error

type UpsertSecretVariablesFunc func(ctx context.Context, secretVariables []mobius.SecretVariable) error

type GetSecretVariablesFunc func(ctx context.Context, names []string) ([]mobius.SecretVariable, error)
...
type AndroidHostLiteFunc func(ctx context.Context, enterpriseSpecificID string) (*mobius.AndroidHost, error)

type BulkSetAndroidHostsUnenrolledFunc func(ctx context.Context) error

type NewAndroidHostFunc func(ctx context.Context, host *mobius.AndroidHost) (*mobius.AndroidHost, error)

type SetAndroidEnabledAndConfiguredFunc func(ctx context.Context, configured bool) error

type UpdateAndroidHostFunc func(ctx context.Context, host *mobius.AndroidHost, fromEnroll bool) error

type CreateScimUserFunc func(ctx context.Context, user *mobius.ScimUser) (uint, error)

type ScimUserByIDFunc func(ctx context.Context, id uint) (*mobius.ScimUser, error)

type ScimUserByUserNameFunc func(ctx context.Context, userName string) (*mobius.ScimUser, error)

type ScimUserByUserNameOrEmailFunc func(ctx context.Context, userName string, email string) (*mobius.ScimUser, error)

type ScimUserByHostIDFunc func(ctx context.Context, hostID uint) (*mobius.ScimUser, error)

type ScimUsersExistFunc func(ctx context.Context, ids []uint) (bool, error)

type ReplaceScimUserFunc func(ctx context.Context, user *mobius.ScimUser) error

type DeleteScimUserFunc func(ctx context.Context, id uint) error

type ListScimUsersFunc func(ctx context.Context, opts mobius.ScimUsersListOptions) (users []mobius.ScimUser, totalResults uint, err error)

type CreateScimGroupFunc func(ctx context.Context, group *mobius.ScimGroup) (uint, error)

type ScimGroupByIDFunc func(ctx context.Context, id uint, excludeUsers bool) (*mobius.ScimGroup, error)

type ScimGroupByDisplayNameFunc func(ctx context.Context, displayName string) (*mobius.ScimGroup, error)

type ReplaceScimGroupFunc func(ctx context.Context, group *mobius.ScimGroup) error

type DeleteScimGroupFunc func(ctx context.Context, id uint) error

type ListScimGroupsFunc func(ctx context.Context, opts mobius.ScimGroupsListOptions) (groups []mobius.ScimGroup, totalResults uint, err error)

type ScimLastRequestFunc func(ctx context.Context) (*mobius.ScimLastRequest, error)

type UpdateScimLastRequestFunc func(ctx context.Context, lastRequest *mobius.ScimLastRequest) error
...
type ConditionalAccessMicrosoftGetFunc func(ctx context.Context) (*mobius.ConditionalAccessMicrosoftIntegration, error)
...
type LoadHostConditionalAccessStatusFunc func(ctx context.Context, hostID uint) (*mobius.HostConditionalAccessStatus, error)
...
type DataStore struct {
	...
	IsHostConnectedToMobiusMDMFunc        IsHostConnectedToMobiusMDMFunc
	IsHostConnectedToMobiusMDMFuncInvoked bool
	...
	AreHostsConnectedToMobiusMDMFunc        AreHostsConnectedToMobiusMDMFunc
	AreHostsConnectedToMobiusMDMFuncInvoked bool
	...
	IsCVEKnownToMobiusFunc        IsCVEKnownToMobiusFunc
	IsCVEKnownToMobiusFuncInvoked bool
	...
	GetMDMAppleEnrolledDeviceDeletedFromMobiusFunc        GetMDMAppleEnrolledDeviceDeletedFromMobiusFunc
	GetMDMAppleEnrolledDeviceDeletedFromMobiusFuncInvoked bool

	ListMDMAppleEnrolledIPhoneIpadDeletedFromMobiusFunc        ListMDMAppleEnrolledIPhoneIpadDeletedFromMobiusFunc
	ListMDMAppleEnrolledIPhoneIpadDeletedFromMobiusFuncInvoked bool
	...
	ListAvailableMobiusMaintainedAppsFunc        ListAvailableMobiusMaintainedAppsFunc
	ListAvailableMobiusMaintainedAppsFuncInvoked bool

	ClearRemovedMobiusMaintainedAppsFunc        ClearRemovedMobiusMaintainedAppsFunc
	ClearRemovedMobiusMaintainedAppsFuncInvoked bool
...
func (s *DataStore) NewCarve(ctx context.Context, metadata *mobius.CarveMetadata) (*mobius.CarveMetadata, error) {
	s.mu.Lock()
...
func (s *DataStore) UpdateCarve(ctx context.Context, metadata *mobius.CarveMetadata) error {
	s.mu.Lock()
...
func (s *DataStore) Carve(ctx context.Context, carveId int64) (*mobius.CarveMetadata, error) {
	s.mu.Lock()
...
func (s *DataStore) CarveBySessionId(ctx context.Context, sessionId string) (*mobius.CarveMetadata, error) {
	s.mu.Lock()
...
func (s *DataStore) CarveByName(ctx context.Context, name string) (*mobius.CarveMetadata, error) {
	s.mu.Lock()
...
func (s *DataStore) ListCarves(ctx context.Context, opt mobius.CarveListOptions) ([]*mobius.CarveMetadata, error) {
	s.mu.Lock()
...
func (s *DataStore) NewBlock(ctx context.Context, metadata *mobius.CarveMetadata, blockId int64, data []byte) error {
	s.mu.Lock()
...
func (s *DataStore) GetBlock(ctx context.Context, metadata *mobius.CarveMetadata, blockId int64) ([]byte, error) {
	s.mu.Lock()
...
func (s *DataStore) NewUser(ctx context.Context, user *mobius.User) (*mobius.User, error) {
	s.mu.Lock()
...
func (s *DataStore) ListUsers(ctx context.Context, opt mobius.UserListOptions) ([]*mobius.User, error) {
	s.mu.Lock()
...
func (s *DataStore) UserByEmail(ctx context.Context, email string) (*mobius.User, error) {
	s.mu.Lock()
...
func (s *DataStore) UserByID(ctx context.Context, id uint) (*mobius.User, error) {
	s.mu.Lock()
...
func (s *DataStore) UserOrDeletedUserByID(ctx context.Context, id uint) (*mobius.User, error) {
	s.mu.Lock()
...
func (s *DataStore) SaveUser(ctx context.Context, user *mobius.User) error {
	s.mu.Lock()
...
func (s *DataStore) SaveUsers(ctx context.Context, users []*mobius.User) error {
	s.mu.Lock()
...
func (s *DataStore) UserSettings(ctx context.Context, userID uint) (*mobius.UserSettings, error) {
	s.mu.Lock()
...
func (s *DataStore) ApplyQueries(ctx context.Context, authorID uint, queries []*mobius.Query, queriesToDiscardResults map[uint]struct{}) error {
	s.mu.Lock()
...
func (s *DataStore) NewQuery(ctx context.Context, query *mobius.Query, opts ...mobius.OptionalArg) (*mobius.Query, error) {
	s.mu.Lock()
...
func (s *DataStore) SaveQuery(ctx context.Context, query *mobius.Query, shouldDiscardResults bool, shouldDeleteStats bool) error {
	s.mu.Lock()
...
func (s *DataStore) Query(ctx context.Context, id uint) (*mobius.Query, error) {
	s.mu.Lock()
...
func (s *DataStore) ListQueries(ctx context.Context, opt mobius.ListQueryOptions) ([]*mobius.Query, int, *mobius.PaginationMetadata, error) {
	s.mu.Lock()
...
func (s *DataStore) ListScheduledQueriesForAgents(ctx context.Context, teamID *uint, hostID *uint, queryReportsDisabled bool) ([]*mobius.Query, error) {
	s.mu.Lock()
...
func (s *DataStore) QueryByName(ctx context.Context, teamID *uint, name string) (*mobius.Query, error) {
	s.mu.Lock()
...
func (s *DataStore) GetLiveQueryStats(ctx context.Context, queryID uint, hostIDs []uint) ([]*mobius.LiveQueryStats, error) {
	s.mu.Lock()
...
func (s *DataStore) UpdateLiveQueryStats(ctx context.Context, queryID uint, stats []*mobius.LiveQueryStats) error {
	s.mu.Lock()
...
func (s *DataStore) CalculateAggregatedPerfStatsPercentiles(ctx context.Context, aggregate mobius.AggregatedStatsType, queryID uint) error {
	s.mu.Lock()
...
func (s *DataStore) NewDistributedQueryCampaign(ctx context.Context, camp *mobius.DistributedQueryCampaign) (*mobius.DistributedQueryCampaign, error) {
	s.mu.Lock()
...
func (s *DataStore) DistributedQueryCampaign(ctx context.Context, id uint) (*mobius.DistributedQueryCampaign, error) {
	s.mu.Lock()
...
func (s *DataStore) SaveDistributedQueryCampaign(ctx context.Context, camp *mobius.DistributedQueryCampaign) error {
	s.mu.Lock()
...
func (s *DataStore) DistributedQueryCampaignTargetIDs(ctx context.Context, id uint) (targets *mobius.HostTargets, err error) {
	s.mu.Lock()
...
func (s *DataStore) NewDistributedQueryCampaignTarget(ctx context.Context, target *mobius.DistributedQueryCampaignTarget) (*mobius.DistributedQueryCampaignTarget, error) {
	s.mu.Lock()
...
func (s *DataStore) DistributedQueryCampaignsForQuery(ctx context.Context, queryID uint) ([]*mobius.DistributedQueryCampaign, error) {
	s.mu.Lock()
...
func (s *DataStore) ApplyPackSpecs(ctx context.Context, specs []*mobius.PackSpec) error {
	s.mu.Lock()
...
func (s *DataStore) GetPackSpecs(ctx context.Context) ([]*mobius.PackSpec, error) {
	s.mu.Lock()
...
func (s *DataStore) GetPackSpec(ctx context.Context, name string) (*mobius.PackSpec, error) {
	s.mu.Lock()
...
func (s *DataStore) NewPack(ctx context.Context, pack *mobius.Pack, opts ...mobius.OptionalArg) (*mobius.Pack, error) {
	s.mu.Lock()
...
func (s *DataStore) SavePack(ctx context.Context, pack *mobius.Pack) error {
	s.mu.Lock()
...
func (s *DataStore) Pack(ctx context.Context, pid uint) (*mobius.Pack, error) {
	s.mu.Lock()
...
func (s *DataStore) ListPacks(ctx context.Context, opt mobius.PackListOptions) ([]*mobius.Pack, error) {
	s.mu.Lock()
...
func (s *DataStore) PackByName(ctx context.Context, name string, opts ...mobius.OptionalArg) (*mobius.Pack, bool, error) {
	s.mu.Lock()
...
func (s *DataStore) ListPacksForHost(ctx context.Context, hid uint) (packs []*mobius.Pack, err error) {
	s.mu.Lock()
...
func (s *DataStore) ApplyLabelSpecs(ctx context.Context, specs []*mobius.LabelSpec) error {
	s.mu.Lock()
...
func (s *DataStore) ApplyLabelSpecsWithAuthor(ctx context.Context, specs []*mobius.LabelSpec, authorId *uint) error {
	s.mu.Lock()
...
func (s *DataStore) GetLabelSpecs(ctx context.Context) ([]*mobius.LabelSpec, error) {
	s.mu.Lock()
...
func (s *DataStore) GetLabelSpec(ctx context.Context, name string) (*mobius.LabelSpec, error) {
	s.mu.Lock()
...
func (s *DataStore) UpdateLabelMembershipByHostIDs(ctx context.Context, labelID uint, hostIds []uint, teamFilter mobius.TeamFilter) (*mobius.Label, []uint, error) {
	s.mu.Lock()
...
func (s *DataStore) NewLabel(ctx context.Context, Label *mobius.Label, opts ...mobius.OptionalArg) (*mobius.Label, error) {
	s.mu.Lock()
...
func (s *DataStore) SaveLabel(ctx context.Context, label *mobius.Label, teamFilter mobius.TeamFilter) (*mobius.Label, []uint, error) {
	s.mu.Lock()
...
func (s *DataStore) Label(ctx context.Context, lid uint, teamFilter mobius.TeamFilter) (*mobius.Label, []uint, error) {
	s.mu.Lock()
...
func (s *DataStore) ListLabels(ctx context.Context, filter mobius.TeamFilter, opt mobius.ListOptions) ([]*mobius.Label, error) {
	s.mu.Lock()
...
func (s *DataStore) LabelsSummary(ctx context.Context) ([]*mobius.LabelSummary, error) {
	s.mu.Lock()
...
func (s *DataStore) LabelQueriesForHost(ctx context.Context, host *mobius.Host) (map[string]string, error) {
	s.mu.Lock()
...
func (s *DataStore) ListLabelsForHost(ctx context.Context, hid uint) ([]*mobius.Label, error) {
	s.mu.Lock()
...
func (s *DataStore) ListHostsInLabel(ctx context.Context, filter mobius.TeamFilter, lid uint, opt mobius.HostListOptions) ([]*mobius.Host, error) {
	s.mu.Lock()
...
func (s *DataStore) ListUniqueHostsInLabels(ctx context.Context, filter mobius.TeamFilter, labels []uint) ([]*mobius.Host, error) {
	s.mu.Lock()
...
func (s *DataStore) SearchLabels(ctx context.Context, filter mobius.TeamFilter, query string, omit ...uint) ([]*mobius.Label, error) {
	s.mu.Lock()
...
func (s *DataStore) LabelsByName(ctx context.Context, names []string) (map[string]*mobius.Label, error) {
	s.mu.Lock()
...
func (s *DataStore) NewHost(ctx context.Context, host *mobius.Host) (*mobius.Host, error) {
	s.mu.Lock()
...
func (s *DataStore) Host(ctx context.Context, id uint) (*mobius.Host, error) {
	s.mu.Lock()
...
func (s *DataStore) GetHostHealth(ctx context.Context, id uint) (*mobius.HostHealth, error) {
	s.mu.Lock()
...
func (s *DataStore) ListHosts(ctx context.Context, filter mobius.TeamFilter, opt mobius.HostListOptions) ([]*mobius.Host, error) {
	s.mu.Lock()
...
func (s *DataStore) ListHostsLiteByUUIDs(ctx context.Context, filter mobius.TeamFilter, uuids []string) ([]*mobius.Host, error) {
	s.mu.Lock()
...
func (s *DataStore) ListHostsLiteByIDs(ctx context.Context, ids []uint) ([]*mobius.Host, error) {
	s.mu.Lock()
...
func (s *DataStore) ListHostUsers(ctx context.Context, hostID uint) ([]mobius.HostUser, error) {
	s.mu.Lock()
...
func (s *DataStore) SearchHosts(ctx context.Context, filter mobius.TeamFilter, query string, omit ...uint) ([]*mobius.Host, error) {
	s.mu.Lock()
...
func (s *DataStore) GenerateHostStatusStatistics(ctx context.Context, filter mobius.TeamFilter, now time.Time, platform *string, lowDiskSpace *int) (*mobius.HostSummary, error) {
	s.mu.Lock()
...
func (s *DataStore) HostIDsByIdentifier(ctx context.Context, filter mobius.TeamFilter, hostnames []string) ([]uint, error) {
	s.mu.Lock()
...
func (s *DataStore) HostIDsByOSVersion(ctx context.Context, osVersion mobius.OSVersion, offset int, limit int) ([]uint, error) {
	s.mu.Lock()
...
func (s *DataStore) HostByIdentifier(ctx context.Context, identifier string) (*mobius.Host, error) {
	s.mu.Lock()
...
func (s *DataStore) HostLiteByIdentifier(ctx context.Context, identifier string) (*mobius.HostLite, error) {
	s.mu.Lock()
...
func (s *DataStore) HostLiteByID(ctx context.Context, id uint) (*mobius.HostLite, error) {
	s.mu.Lock()
...
func (s *DataStore) CountHosts(ctx context.Context, filter mobius.TeamFilter, opt mobius.HostListOptions) (int, error) {
	s.mu.Lock()
...
func (s *DataStore) CountHostsInLabel(ctx context.Context, filter mobius.TeamFilter, lid uint, opt mobius.HostListOptions) (int, error) {
	s.mu.Lock()
...
func (s *DataStore) ListHostDeviceMapping(ctx context.Context, id uint) ([]*mobius.HostDeviceMapping, error) {
	s.mu.Lock()
...
func (s *DataStore) SetOrUpdateCustomHostDeviceMapping(ctx context.Context, hostID uint, email string, source string) ([]*mobius.HostDeviceMapping, error) {
	s.mu.Lock()
...
func (s *DataStore) ListHostBatteries(ctx context.Context, id uint) ([]*mobius.HostBattery, error) {
	s.mu.Lock()
...
func (s *DataStore) ListUpcomingHostMaintenanceWindows(ctx context.Context, hid uint) ([]*mobius.HostMaintenanceWindow, error) {
	s.mu.Lock()
...
func (s *DataStore) LoadHostByDeviceAuthToken(ctx context.Context, authToken string, tokenTTL time.Duration) (*mobius.Host, error) {
	s.mu.Lock()
...
func (s *DataStore) FailingPoliciesCount(ctx context.Context, host *mobius.Host) (uint, error) {
	s.mu.Lock()
...
func (s *DataStore) ListPoliciesForHost(ctx context.Context, host *mobius.Host) ([]*mobius.HostPolicy, error) {
	s.mu.Lock()
...
func (s *DataStore) GetHostMunkiIssues(ctx context.Context, hostID uint) ([]*mobius.HostMunkiIssue, error) {
	s.mu.Lock()
...
func (s *DataStore) GetHostMDM(ctx context.Context, hostID uint) (*mobius.HostMDM, error) {
	s.mu.Lock()
...
func (s *DataStore) GetHostMDMCheckinInfo(ctx context.Context, hostUUID string) (*mobius.HostMDMCheckinInfo, error) {
	s.mu.Lock()
...
func (s *DataStore) ListIOSAndIPadOSToRefetch(ctx context.Context, refetchInterval time.Duration) (devices []mobius.AppleDevicesToRefetch, err error) {
	s.mu.Lock()
...
func (s *DataStore) AddHostMDMCommands(ctx context.Context, commands []mobius.HostMDMCommand) error {
	s.mu.Lock()
...
func (s *DataStore) GetHostMDMCommands(ctx context.Context, hostID uint) (commands []mobius.HostMDMCommand, err error) {
	s.mu.Lock()
...
func (s *DataStore) RemoveHostMDMCommand(ctx context.Context, command mobius.HostMDMCommand) error {
	s.mu.Lock()
...
func (s *DataStore) IsHostConnectedToMobiusMDM(ctx context.Context, host *mobius.Host) (bool, error) {
	s.mu.Lock()
	s.IsHostConnectedToMobiusMDMFuncInvoked = true
	s.mu.Unlock()
	return s.IsHostConnectedToMobiusMDMFunc(ctx, host)
}

func (s *DataStore) ListHostCertificates(ctx context.Context, hostID uint, opts mobius.ListOptions) ([]*mobius.HostCertificateRecord, *mobius.PaginationMetadata, error) {
	s.mu.Lock()
...
func (s *DataStore) UpdateHostCertificates(ctx context.Context, hostID uint, hostUUID string, certs []*mobius.HostCertificateRecord) error {
	s.mu.Lock()
...
func (s *DataStore) AreHostsConnectedToMobiusMDM(ctx context.Context, hosts []*mobius.Host) (map[string]bool, error) {
	s.mu.Lock()
	s.AreHostsConnectedToMobiusMDMFuncInvoked = true
	s.mu.Unlock()
	return s.AreHostsConnectedToMobiusMDMFunc(ctx, hosts)
}

func (s *DataStore) AggregatedMunkiVersion(ctx context.Context, teamID *uint) ([]mobius.AggregatedMunkiVersion, time.Time, error) {
	s.mu.Lock()
...
func (s *DataStore) AggregatedMunkiIssues(ctx context.Context, teamID *uint) ([]mobius.AggregatedMunkiIssue, time.Time, error) {
	s.mu.Lock()
...
func (s *DataStore) AggregatedMDMStatus(ctx context.Context, teamID *uint, platform string) (mobius.AggregatedMDMStatus, time.Time, error) {
	s.mu.Lock()
...
func (s *DataStore) AggregatedMDMSolutions(ctx context.Context, teamID *uint, platform string) ([]mobius.AggregatedMDMSolutions, time.Time, error) {
	s.mu.Lock()
...
func (s *DataStore) GetMunkiIssue(ctx context.Context, munkiIssueID uint) (*mobius.MunkiIssue, error) {
	s.mu.Lock()
...
func (s *DataStore) GetMDMSolution(ctx context.Context, mdmID uint) (*mobius.MDMSolution, error) {
	s.mu.Lock()
...
func (s *DataStore) OSVersions(ctx context.Context, teamFilter *mobius.TeamFilter, platform *string, name *string, version *string) (*mobius.OSVersions, error) {
	s.mu.Lock()
...
func (s *DataStore) OSVersionsByCVE(ctx context.Context, cve string, teamID *uint) ([]*mobius.VulnerableOS, time.Time, error) {
	s.mu.Lock()
...
func (s *DataStore) SoftwareByCVE(ctx context.Context, cve string, teamID *uint) ([]*mobius.VulnerableSoftware, time.Time, error) {
	s.mu.Lock()
...
func (s *DataStore) OSVersion(ctx context.Context, osVersionID uint, teamFilter *mobius.TeamFilter) (*mobius.OSVersion, *time.Time, error) {
	s.mu.Lock()
...
func (s *DataStore) CountHostsInTargets(ctx context.Context, filter mobius.TeamFilter, targets mobius.HostTargets, now time.Time) (mobius.TargetMetrics, error) {
	s.mu.Lock()
...
func (s *DataStore) HostIDsInTargets(ctx context.Context, filter mobius.TeamFilter, targets mobius.HostTargets) ([]uint, error) {
	s.mu.Lock()
...
func (s *DataStore) NewPasswordResetRequest(ctx context.Context, req *mobius.PasswordResetRequest) (*mobius.PasswordResetRequest, error) {
	s.mu.Lock()
...
func (s *DataStore) FindPasswordResetByToken(ctx context.Context, token string) (*mobius.PasswordResetRequest, error) {
	s.mu.Lock()
...
func (s *DataStore) SessionByKey(ctx context.Context, key string) (*mobius.Session, error) {
	s.mu.Lock()
...
func (s *DataStore) SessionByID(ctx context.Context, id uint) (*mobius.Session, error) {
	s.mu.Lock()
...
func (s *DataStore) ListSessionsForUser(ctx context.Context, id uint) ([]*mobius.Session, error) {
	s.mu.Lock()
...
func (s *DataStore) NewSession(ctx context.Context, userID uint, sessionKeySize int) (*mobius.Session, error) {
	s.mu.Lock()
...
func (s *DataStore) DestroySession(ctx context.Context, session *mobius.Session) error {
	s.mu.Lock()
...
func (s *DataStore) MarkSessionAccessed(ctx context.Context, session *mobius.Session) error {
	s.mu.Lock()
...
func (s *DataStore) SessionByMFAToken(ctx context.Context, token string, sessionKeySize int) (*mobius.Session, *mobius.User, error) {
	s.mu.Lock()
...
func (s *DataStore) NewAppConfig(ctx context.Context, info *mobius.AppConfig) (*mobius.AppConfig, error) {
	s.mu.Lock()
...
func (s *DataStore) AppConfig(ctx context.Context) (*mobius.AppConfig, error) {
	s.mu.Lock()
...
func (s *DataStore) SaveAppConfig(ctx context.Context, info *mobius.AppConfig) error {
	s.mu.Lock()
...
func (s *DataStore) GetEnrollSecrets(ctx context.Context, teamID *uint) ([]*mobius.EnrollSecret, error) {
	s.mu.Lock()
...
func (s *DataStore) ApplyEnrollSecrets(ctx context.Context, teamID *uint, secrets []*mobius.EnrollSecret) error {
	s.mu.Lock()
...
func (s *DataStore) AggregateEnrollSecretPerTeam(ctx context.Context) ([]*mobius.EnrollSecret, error) {
	s.mu.Lock()
...
func (s *DataStore) GetYaraRules(ctx context.Context) ([]mobius.YaraRule, error) {
	s.mu.Lock()
...
func (s *DataStore) ApplyYaraRules(ctx context.Context, rules []mobius.YaraRule) error {
	s.mu.Lock()
...
func (s *DataStore) YaraRuleByName(ctx context.Context, name string) (*mobius.YaraRule, error) {
	s.mu.Lock()
...
func (s *DataStore) NewInvite(ctx context.Context, i *mobius.Invite) (*mobius.Invite, error) {
	s.mu.Lock()
...
func (s *DataStore) ListInvites(ctx context.Context, opt mobius.ListOptions) ([]*mobius.Invite, error) {
	s.mu.Lock()
...
func (s *DataStore) Invite(ctx context.Context, id uint) (*mobius.Invite, error) {
	s.mu.Lock()
...
func (s *DataStore) InviteByEmail(ctx context.Context, email string) (*mobius.Invite, error) {
	s.mu.Lock()
...
func (s *DataStore) InviteByToken(ctx context.Context, token string) (*mobius.Invite, error) {
	s.mu.Lock()
...
func (s *DataStore) UpdateInvite(ctx context.Context, id uint, i *mobius.Invite) (*mobius.Invite, error) {
	s.mu.Lock()
...
func (s *DataStore) ListScheduledQueriesInPackWithStats(ctx context.Context, id uint, opts mobius.ListOptions) ([]*mobius.ScheduledQuery, error) {
	s.mu.Lock()
...
func (s *DataStore) NewScheduledQuery(ctx context.Context, sq *mobius.ScheduledQuery, opts ...mobius.OptionalArg) (*mobius.ScheduledQuery, error) {
	s.mu.Lock()
...
func (s *DataStore) SaveScheduledQuery(ctx context.Context, sq *mobius.ScheduledQuery) (*mobius.ScheduledQuery, error) {
	s.mu.Lock()
...
func (s *DataStore) ScheduledQuery(ctx context.Context, id uint) (*mobius.ScheduledQuery, error) {
	s.mu.Lock()
...
func (s *DataStore) QueryResultRows(ctx context.Context, queryID uint, filter mobius.TeamFilter) ([]*mobius.ScheduledQueryResultRow, error) {
	s.mu.Lock()
...
func (s *DataStore) QueryResultRowsForHost(ctx context.Context, queryID uint, hostID uint) ([]*mobius.ScheduledQueryResultRow, error) {
	s.mu.Lock()
...
func (s *DataStore) OverwriteQueryResultRows(ctx context.Context, rows []*mobius.ScheduledQueryResultRow, maxQueryReportRows int) error {
	s.mu.Lock()
...
func (s *DataStore) NewTeam(ctx context.Context, team *mobius.Team) (*mobius.Team, error) {
	s.mu.Lock()
...
func (s *DataStore) SaveTeam(ctx context.Context, team *mobius.Team) (*mobius.Team, error) {
	s.mu.Lock()
...
func (s *DataStore) Team(ctx context.Context, tid uint) (*mobius.Team, error) {
	s.mu.Lock()
...
func (s *DataStore) TeamWithoutExtras(ctx context.Context, tid uint) (*mobius.Team, error) {
	s.mu.Lock()
...
func (s *DataStore) TeamByName(ctx context.Context, name string) (*mobius.Team, error) {
	s.mu.Lock()
...
func (s *DataStore) TeamByFilename(ctx context.Context, filename string) (*mobius.Team, error) {
	s.mu.Lock()
...
func (s *DataStore) ListTeams(ctx context.Context, filter mobius.TeamFilter, opt mobius.ListOptions) ([]*mobius.Team, error) {
	s.mu.Lock()
...
func (s *DataStore) TeamsSummary(ctx context.Context) ([]*mobius.TeamSummary, error) {
	s.mu.Lock()
...
func (s *DataStore) SearchTeams(ctx context.Context, filter mobius.TeamFilter, matchQuery string, omit ...uint) ([]*mobius.Team, error) {
	s.mu.Lock()
...
func (s *DataStore) TeamEnrollSecrets(ctx context.Context, teamID uint) ([]*mobius.EnrollSecret, error) {
	s.mu.Lock()
...
func (s *DataStore) DeleteIntegrationsFromTeams(ctx context.Context, deletedIntgs mobius.Integrations) error {
	s.mu.Lock()
...
func (s *DataStore) ListSoftwareTitles(ctx context.Context, opt mobius.SoftwareTitleListOptions, tmFilter mobius.TeamFilter) ([]mobius.SoftwareTitleListResult, int, *mobius.PaginationMetadata, error) {
	s.mu.Lock()
...
func (s *DataStore) SoftwareTitleByID(ctx context.Context, id uint, teamID *uint, tmFilter mobius.TeamFilter) (*mobius.SoftwareTitle, error) {
	s.mu.Lock()
...
func (s *DataStore) InsertSoftwareInstallRequest(ctx context.Context, hostID uint, softwareInstallerID uint, opts mobius.HostSoftwareInstallOptions) (string, error) {
	s.mu.Lock()
...
func (s *DataStore) ListSoftwareForVulnDetection(ctx context.Context, filter mobius.VulnSoftwareFilter) ([]mobius.Software, error) {
	s.mu.Lock()
...
func (s *DataStore) ListSoftwareVulnerabilitiesByHostIDsSource(ctx context.Context, hostIDs []uint, source mobius.VulnerabilitySource) (map[uint][]mobius.SoftwareVulnerability, error) {
	s.mu.Lock()
...
func (s *DataStore) LoadHostSoftware(ctx context.Context, host *mobius.Host, includeCVEScores bool) error {
	s.mu.Lock()
...
func (s *DataStore) AllSoftwareIterator(ctx context.Context, query mobius.SoftwareIterQueryOptions) (mobius.SoftwareIterator, error) {
	s.mu.Lock()
...
func (s *DataStore) UpsertSoftwareCPEs(ctx context.Context, cpes []mobius.SoftwareCPE) (int64, error) {
	s.mu.Lock()
...
func (s *DataStore) DeleteSoftwareCPEs(ctx context.Context, cpes []mobius.SoftwareCPE) (int64, error) {
	s.mu.Lock()
...
func (s *DataStore) ListSoftwareCPEs(ctx context.Context) ([]mobius.SoftwareCPE, error) {
	s.mu.Lock()
...
func (s *DataStore) InsertSoftwareVulnerability(ctx context.Context, vuln mobius.SoftwareVulnerability, source mobius.VulnerabilitySource) (bool, error) {
	s.mu.Lock()
...
func (s *DataStore) SoftwareByID(ctx context.Context, id uint, teamID *uint, includeCVEScores bool, tmFilter *mobius.TeamFilter) (*mobius.Software, error) {
	s.mu.Lock()
...
func (s *DataStore) ListSoftwareByHostIDShort(ctx context.Context, hostID uint) ([]mobius.Software, error) {
	s.mu.Lock()
...
func (s *DataStore) HostVulnSummariesBySoftwareIDs(ctx context.Context, softwareIDs []uint) ([]mobius.HostVulnerabilitySummary, error) {
	s.mu.Lock()
...
func (s *DataStore) HostsByCVE(ctx context.Context, cve string) ([]mobius.HostVulnerabilitySummary, error) {
	s.mu.Lock()
...
func (s *DataStore) InsertCVEMeta(ctx context.Context, cveMeta []mobius.CVEMeta) error {
	s.mu.Lock()
...
func (s *DataStore) ListCVEs(ctx context.Context, maxAge time.Duration) ([]mobius.CVEMeta, error) {
	s.mu.Lock()
...
func (s *DataStore) ListHostSoftware(ctx context.Context, host *mobius.Host, opts mobius.HostSoftwareTitleListOptions) ([]*mobius.HostSoftwareWithInstaller, *mobius.PaginationMetadata, error) {
	s.mu.Lock()
...
func (s *DataStore) SetHostSoftwareInstallResult(ctx context.Context, result *mobius.HostSoftwareInstallResultPayload) (wasCanceled bool, err error) {
	s.mu.Lock()
...
func (s *DataStore) NewSoftwareCategory(ctx context.Context, name string) (*mobius.SoftwareCategory, error) {
	s.mu.Lock()
...
func (s *DataStore) GetVPPInstallsByVerificationUUID(ctx context.Context, verificationUUID string) ([]*mobius.HostVPPSoftwareInstall, error) {
	s.mu.Lock()
...
func (s *DataStore) GetHostOperatingSystem(ctx context.Context, hostID uint) (*mobius.OperatingSystem, error) {
	s.mu.Lock()
...
func (s *DataStore) ListOperatingSystems(ctx context.Context) ([]mobius.OperatingSystem, error) {
	s.mu.Lock()
...
func (s *DataStore) ListOperatingSystemsForPlatform(ctx context.Context, platform string) ([]mobius.OperatingSystem, error) {
	s.mu.Lock()
...
func (s *DataStore) UpdateHostOperatingSystem(ctx context.Context, hostID uint, hostOS mobius.OperatingSystem) error {
	s.mu.Lock()
...
func (s *DataStore) NewActivity(ctx context.Context, user *mobius.User, activity mobius.ActivityDetails, details []byte, createdAt time.Time) error {
	s.mu.Lock()
...
func (s *DataStore) ListActivities(ctx context.Context, opt mobius.ListActivitiesOptions) ([]*mobius.Activity, *mobius.PaginationMetadata, error) {
	s.mu.Lock()
...
func (s *DataStore) ListHostUpcomingActivities(ctx context.Context, hostID uint, opt mobius.ListOptions) ([]*mobius.UpcomingActivity, *mobius.PaginationMetadata, error) {
	s.mu.Lock()
...
func (s *DataStore) CancelHostUpcomingActivity(ctx context.Context, hostID uint, executionID string) (mobius.ActivityDetails, error) {
	s.mu.Lock()
...
func (s *DataStore) ListHostPastActivities(ctx context.Context, hostID uint, opt mobius.ListOptions) ([]*mobius.Activity, *mobius.PaginationMetadata, error) {
	s.mu.Lock()
...
func (s *DataStore) GetHostUpcomingActivityMeta(ctx context.Context, hostID uint, executionID string) (*mobius.UpcomingActivityMeta, error) {
	s.mu.Lock()
...
func (s *DataStore) ShouldSendStatistics(ctx context.Context, frequency time.Duration, config config.MobiusConfig) (mobius.StatisticsPayload, bool, error) {
	s.mu.Lock()
...
func (s *DataStore) ApplyPolicySpecs(ctx context.Context, authorID uint, specs []*mobius.PolicySpec) error {
	s.mu.Lock()
...
func (s *DataStore) NewGlobalPolicy(ctx context.Context, authorID *uint, args mobius.PolicyPayload) (*mobius.Policy, error) {
	s.mu.Lock()
...
func (s *DataStore) Policy(ctx context.Context, id uint) (*mobius.Policy, error) {
	s.mu.Lock()
...
func (s *DataStore) PolicyLite(ctx context.Context, id uint) (*mobius.PolicyLite, error) {
	s.mu.Lock()
...
func (s *DataStore) SavePolicy(ctx context.Context, p *mobius.Policy, shouldRemoveAllPolicyMemberships bool, removePolicyStats bool) error {
	s.mu.Lock()
...
func (s *DataStore) ListGlobalPolicies(ctx context.Context, opts mobius.ListOptions) ([]*mobius.Policy, error) {
	s.mu.Lock()
...
func (s *DataStore) PoliciesByID(ctx context.Context, ids []uint) (map[uint]*mobius.Policy, error) {
	s.mu.Lock()
...
func (s *DataStore) PolicyQueriesForHost(ctx context.Context, host *mobius.Host) (map[string]string, error) {
	s.mu.Lock()
...
func (s *DataStore) GetTeamHostsPolicyMemberships(ctx context.Context, domain string, teamID uint, policyIDs []uint, hostID *uint) ([]mobius.HostPolicyMembershipData, error) {
	s.mu.Lock()
...
func (s *DataStore) GetPoliciesWithAssociatedInstaller(ctx context.Context, teamID uint, policyIDs []uint) ([]mobius.PolicySoftwareInstallerData, error) {
	s.mu.Lock()
...
func (s *DataStore) GetPoliciesWithAssociatedVPP(ctx context.Context, teamID uint, policyIDs []uint) ([]mobius.PolicyVPPData, error) {
	s.mu.Lock()
...
func (s *DataStore) GetPoliciesWithAssociatedScript(ctx context.Context, teamID uint, policyIDs []uint) ([]mobius.PolicyScriptData, error) {
	s.mu.Lock()
...
func (s *DataStore) GetCalendarPolicies(ctx context.Context, teamID uint) ([]mobius.PolicyCalendarData, error) {
	s.mu.Lock()
...
func (s *DataStore) AsyncBatchInsertPolicyMembership(ctx context.Context, batch []mobius.PolicyMembershipResult) error {
	s.mu.Lock()
...
func (s *DataStore) MigrationStatus(ctx context.Context) (*mobius.MigrationStatus, error) {
	s.mu.Lock()
...
func (s *DataStore) ListSoftware(ctx context.Context, opt mobius.SoftwareListOptions) ([]mobius.Software, *mobius.PaginationMetadata, error) {
	s.mu.Lock()
...
func (s *DataStore) CountSoftware(ctx context.Context, opt mobius.SoftwareListOptions) (int, error) {
	s.mu.Lock()
...
func (s *DataStore) DeleteSoftwareVulnerabilities(ctx context.Context, vulnerabilities []mobius.SoftwareVulnerability) error {
	s.mu.Lock()
...
func (s *DataStore) DeleteOutOfDateVulnerabilities(ctx context.Context, source mobius.VulnerabilitySource, duration time.Duration) error {
	s.mu.Lock()
...
func (s *DataStore) CreateOrUpdateCalendarEvent(ctx context.Context, uuid string, email string, startTime time.Time, endTime time.Time, data []byte, timeZone *string, hostID uint, webhookStatus mobius.CalendarWebhookStatus) (*mobius.CalendarEvent, error) {
	s.mu.Lock()
...
func (s *DataStore) GetCalendarEvent(ctx context.Context, email string) (*mobius.CalendarEvent, error) {
	s.mu.Lock()
...
func (s *DataStore) GetCalendarEventDetailsByUUID(ctx context.Context, uuid string) (*mobius.CalendarEventDetails, error) {
	s.mu.Lock()
...
func (s *DataStore) GetHostCalendarEvent(ctx context.Context, hostID uint) (*mobius.HostCalendarEvent, *mobius.CalendarEvent, error) {
	s.mu.Lock()
...
func (s *DataStore) GetHostCalendarEventByEmail(ctx context.Context, email string) (*mobius.HostCalendarEvent, *mobius.CalendarEvent, error) {
	s.mu.Lock()
...
func (s *DataStore) UpdateHostCalendarWebhookStatus(ctx context.Context, hostID uint, status mobius.CalendarWebhookStatus) error {
	s.mu.Lock()
...
func (s *DataStore) ListCalendarEvents(ctx context.Context, teamID *uint) ([]*mobius.CalendarEvent, error) {
	s.mu.Lock()
...
func (s *DataStore) ListOutOfDateCalendarEvents(ctx context.Context, t time.Time) ([]*mobius.CalendarEvent, error) {
	s.mu.Lock()
...
func (s *DataStore) NewTeamPolicy(ctx context.Context, teamID uint, authorID *uint, args mobius.PolicyPayload) (*mobius.Policy, error) {
	s.mu.Lock()
...
func (s *DataStore) ListTeamPolicies(ctx context.Context, teamID uint, opts mobius.ListOptions, iopts mobius.ListOptions) (teamPolicies []*mobius.Policy, inheritedPolicies []*mobius.Policy, err error) {
	s.mu.Lock()
...
func (s *DataStore) ListMergedTeamPolicies(ctx context.Context, teamID uint, opts mobius.ListOptions) ([]*mobius.Policy, error) {
	s.mu.Lock()
...
func (s *DataStore) TeamPolicy(ctx context.Context, teamID uint, policyID uint) (*mobius.Policy, error) {
	s.mu.Lock()
...
func (s *DataStore) DBLocks(ctx context.Context) ([]*mobius.DBLock, error) {
	s.mu.Lock()
...
func (s *DataStore) GetLatestCronStats(ctx context.Context, name string) ([]mobius.CronStats, error) {
	s.mu.Lock()
...
func (s *DataStore) InsertCronStats(ctx context.Context, statsType mobius.CronStatsType, name string, instance string, status mobius.CronStatsStatus) (int, error) {
	s.mu.Lock()
...
func (s *DataStore) UpdateCronStats(ctx context.Context, id int, status mobius.CronStatsStatus, cronErrors *mobius.CronScheduleErrors) error {
	s.mu.Lock()
...
func (s *DataStore) UpdateAllCronStatsForInstance(ctx context.Context, instance string, fromStatus mobius.CronStatsStatus, toStatus mobius.CronStatsStatus) error {
	s.mu.Lock()
...
func (s *DataStore) LoadHostByNodeKey(ctx context.Context, nodeKey string) (*mobius.Host, error) {
	s.mu.Lock()
...
func (s *DataStore) LoadHostByOrbitNodeKey(ctx context.Context, nodeKey string) (*mobius.Host, error) {
	s.mu.Lock()
...
func (s *DataStore) UpdateHostOsqueryIntervals(ctx context.Context, hostID uint, intervals mobius.HostOsqueryIntervals) error {
	s.mu.Lock()
...
func (s *DataStore) TeamFeatures(ctx context.Context, teamID uint) (*mobius.Features, error) {
	s.mu.Lock()
...
func (s *DataStore) TeamMDMConfig(ctx context.Context, teamID uint) (*mobius.TeamMDM, error) {
	s.mu.Lock()
...
func (s *DataStore) SaveHostPackStats(ctx context.Context, teamID *uint, hostID uint, stats []mobius.PackStats) error {
	s.mu.Lock()
...
func (s *DataStore) AsyncBatchSaveHostsScheduledQueryStats(ctx context.Context, stats map[uint][]mobius.ScheduledQueryStats, batchSize int) (int, error) {
	s.mu.Lock()
...
func (s *DataStore) UpdateHostSoftware(ctx context.Context, hostID uint, software []mobius.Software) (*mobius.UpdateHostSoftwareDBResult, error) {
	s.mu.Lock()
...
func (s *DataStore) UpdateHostSoftwareInstalledPaths(ctx context.Context, hostID uint, reported map[string]struct{}, mutationResults *mobius.UpdateHostSoftwareDBResult) error {
	s.mu.Lock()
...
func (s *DataStore) UpdateHost(ctx context.Context, host *mobius.Host) error {
	s.mu.Lock()
...
func (s *DataStore) ListScheduledQueriesInPack(ctx context.Context, packID uint) (mobius.ScheduledQueryList, error) {
	s.mu.Lock()
...
func (s *DataStore) RecordPolicyQueryExecutions(ctx context.Context, host *mobius.Host, results map[uint]*bool, updated time.Time, deferredSaveHost bool) error {
	s.mu.Lock()
...
func (s *DataStore) RecordLabelQueryExecutions(ctx context.Context, host *mobius.Host, results map[uint]*bool, t time.Time, deferredSaveHost bool) error {
	s.mu.Lock()
...
func (s *DataStore) SaveHostUsers(ctx context.Context, hostID uint, users []mobius.HostUser) error {
	s.mu.Lock()
...
func (s *DataStore) SetOrUpdateMDMData(ctx context.Context, hostID uint, isServer bool, enrolled bool, serverURL string, installedFromDep bool, name string, mobiusEnrollRef string) error {
	s.mu.Lock()
	s.SetOrUpdateMDMDataFuncInvoked = true
	s.mu.Unlock()
	return s.SetOrUpdateMDMDataFunc(ctx, hostID, isServer, enrolled, serverURL, installedFromDep, name, mobiusEnrollRef)
}
...
func (s *DataStore) SetOrUpdateHostDiskEncryptionKey(ctx context.Context, host *mobius.Host, encryptedBase64Key string, clientError string, decryptable *bool) error {
	s.mu.Lock()
...
func (s *DataStore) SaveLUKSData(ctx context.Context, host *mobius.Host, encryptedBase64Passphrase string, encryptedBase64Salt string, keySlot uint) error {
	s.mu.Lock()
...
func (s *DataStore) GetUnverifiedDiskEncryptionKeys(ctx context.Context) ([]mobius.HostDiskEncryptionKey, error) {
	s.mu.Lock()
...
func (s *DataStore) GetHostDiskEncryptionKey(ctx context.Context, hostID uint) (*mobius.HostDiskEncryptionKey, error) {
	s.mu.Lock()
...
func (s *DataStore) GetHostCertAssociationsToExpire(ctx context.Context, expiryDays int, limit int) ([]mobius.SCEPIdentityAssociation, error) {
	s.mu.Lock()
...
func (s *DataStore) SetCommandForPendingSCEPRenewal(ctx context.Context, assocs []mobius.SCEPIdentityAssociation, cmdUUID string) error {
	s.mu.Lock()
...
func (s *DataStore) UpdateHostMDMProfilesVerification(ctx context.Context, host *mobius.Host, toVerify []string, toFail []string, toRetry []string) error {
	s.mu.Lock()
...
func (s *DataStore) GetHostMDMProfilesExpectedForVerification(ctx context.Context, host *mobius.Host) (map[string]*mobius.ExpectedMDMProfile, error) {
	s.mu.Lock()
...
func (s *DataStore) GetHostMDMProfilesRetryCounts(ctx context.Context, host *mobius.Host) ([]mobius.HostMDMProfileRetryCount, error) {
	s.mu.Lock()
...
func (s *DataStore) GetHostMDMProfileRetryCountByCommandUUID(ctx context.Context, host *mobius.Host, cmdUUID string) (mobius.HostMDMProfileRetryCount, error) {
	s.mu.Lock()
...
func (s *DataStore) ReplaceHostBatteries(ctx context.Context, id uint, mappings []*mobius.HostBattery) error {
	s.mu.Lock()
...
func (s *DataStore) VerifyEnrollSecret(ctx context.Context, secret string) (*mobius.EnrollSecret, error) {
	s.mu.Lock()
...
func (s *DataStore) EnrollHost(ctx context.Context, isMDMEnabled bool, osqueryHostId string, hardwareUUID string, hardwareSerial string, nodeKey string, teamID *uint, cooldown time.Duration) (*mobius.Host, error) {
	s.mu.Lock()
...
func (s *DataStore) NewJob(ctx context.Context, job *mobius.Job) (*mobius.Job, error) {
	s.mu.Lock()
...
func (s *DataStore) GetQueuedJobs(ctx context.Context, maxNumJobs int, now time.Time) ([]*mobius.Job, error) {
	s.mu.Lock()
...
func (s *DataStore) UpdateJob(ctx context.Context, id uint, job *mobius.Job) (*mobius.Job, error) {
	s.mu.Lock()
...
func (s *DataStore) ProcessList(ctx context.Context) ([]mobius.MySQLProcess, error) {
	s.mu.Lock()
...
func (s *DataStore) ListWindowsUpdatesByHostID(ctx context.Context, hostID uint) ([]mobius.WindowsUpdate, error) {
	s.mu.Lock()
...
func (s *DataStore) InsertWindowsUpdates(ctx context.Context, hostID uint, updates []mobius.WindowsUpdate) error {
	s.mu.Lock()
...
func (s *DataStore) ListOSVulnerabilitiesByOS(ctx context.Context, osID uint) ([]mobius.OSVulnerability, error) {
	s.mu.Lock()
...
func (s *DataStore) ListVulnsByOsNameAndVersion(ctx context.Context, name string, version string, includeCVSS bool) (mobius.Vulnerabilities, error) {
	s.mu.Lock()
...
func (s *DataStore) InsertOSVulnerabilities(ctx context.Context, vulnerabilities []mobius.OSVulnerability, source mobius.VulnerabilitySource) (int64, error) {
	s.mu.Lock()
...
func (s *DataStore) DeleteOSVulnerabilities(ctx context.Context, vulnerabilities []mobius.OSVulnerability) error {
	s.mu.Lock()
...
func (s *DataStore) InsertOSVulnerability(ctx context.Context, vuln mobius.OSVulnerability, source mobius.VulnerabilitySource) (bool, error) {
	s.mu.Lock()
...
func (s *DataStore) DeleteOutOfDateOSVulnerabilities(ctx context.Context, source mobius.VulnerabilitySource, duration time.Duration) error {
	s.mu.Lock()
...
func (s *DataStore) ListVulnerabilities(ctx context.Context, opt mobius.VulnListOptions) ([]mobius.VulnerabilityWithMetadata, *mobius.PaginationMetadata, error) {
	s.mu.Lock()
...
func (s *DataStore) Vulnerability(ctx context.Context, cve string, teamID *uint, includeCVEScores bool) (*mobius.VulnerabilityWithMetadata, error) {
	s.mu.Lock()
...
func (s *DataStore) CountVulnerabilities(ctx context.Context, opt mobius.VulnListOptions) (uint, error) {
	s.mu.Lock()
...
func (s *DataStore) IsCVEKnownToMobius(ctx context.Context, cve string) (bool, error) {
	s.mu.Lock()
	s.IsCVEKnownToMobiusFuncInvoked = true
	s.mu.Unlock()
	return s.IsCVEKnownToMobiusFunc(ctx, cve)
}

func (s *DataStore) NewMDMAppleConfigProfile(ctx context.Context, p mobius.MDMAppleConfigProfile, usesMobiusVars []string) (*mobius.MDMAppleConfigProfile, error) {
	s.mu.Lock()
	s.NewMDMAppleConfigProfileFuncInvoked = true
	s.mu.Unlock()
	return s.NewMDMAppleConfigProfileFunc(ctx, p, usesMobiusVars)
}

func (s *DataStore) BulkUpsertMDMAppleConfigProfiles(ctx context.Context, payload []*mobius.MDMAppleConfigProfile) error {
	s.mu.Lock()
...
func (s *DataStore) GetMDMAppleConfigProfileByDeprecatedID(ctx context.Context, profileID uint) (*mobius.MDMAppleConfigProfile, error) {
	s.mu.Lock()
...
func (s *DataStore) GetMDMAppleConfigProfile(ctx context.Context, profileUUID string) (*mobius.MDMAppleConfigProfile, error) {
	s.mu.Lock()
...
func (s *DataStore) GetMDMAppleDeclaration(ctx context.Context, declUUID string) (*mobius.MDMAppleDeclaration, error) {
	s.mu.Lock()
...
func (s *DataStore) ListMDMAppleConfigProfiles(ctx context.Context, teamID *uint) ([]*mobius.MDMAppleConfigProfile, error) {
	s.mu.Lock()
...
func (s *DataStore) BulkDeleteMDMAppleHostsConfigProfiles(ctx context.Context, payload []*mobius.MDMAppleProfilePayload) error {
	s.mu.Lock()
...
func (s *DataStore) GetHostMDMAppleProfiles(ctx context.Context, hostUUID string) ([]mobius.HostMDMAppleProfile, error) {
	s.mu.Lock()
...
func (s *DataStore) NewMDMAppleEnrollmentProfile(ctx context.Context, enrollmentPayload mobius.MDMAppleEnrollmentProfilePayload) (*mobius.MDMAppleEnrollmentProfile, error) {
	s.mu.Lock()
...
func (s *DataStore) GetMDMAppleEnrollmentProfileByToken(ctx context.Context, token string) (*mobius.MDMAppleEnrollmentProfile, error) {
	s.mu.Lock()
...
func (s *DataStore) GetMDMAppleEnrollmentProfileByType(ctx context.Context, typ mobius.MDMAppleEnrollmentType) (*mobius.MDMAppleEnrollmentProfile, error) {
	s.mu.Lock()
...
func (s *DataStore) ListMDMAppleEnrollmentProfiles(ctx context.Context) ([]*mobius.MDMAppleEnrollmentProfile, error) {
	s.mu.Lock()
...
func (s *DataStore) GetMDMAppleCommandResults(ctx context.Context, commandUUID string) ([]*mobius.MDMCommandResult, error) {
	s.mu.Lock()
...
func (s *DataStore) GetVPPCommandResults(ctx context.Context, commandUUID string, hostUUID string) ([]*mobius.MDMCommandResult, error) {
	s.mu.Lock()
...
func (s *DataStore) ListMDMAppleCommands(ctx context.Context, tmFilter mobius.TeamFilter, listOpts *mobius.MDMCommandListOptions) ([]*mobius.MDMAppleCommand, error) {
	s.mu.Lock()
...
func (s *DataStore) NewMDMAppleInstaller(ctx context.Context, name string, size int64, manifest string, installer []byte, urlToken string) (*mobius.MDMAppleInstaller, error) {
	s.mu.Lock()
...
func (s *DataStore) MDMAppleInstaller(ctx context.Context, token string) (*mobius.MDMAppleInstaller, error) {
	s.mu.Lock()
...
func (s *DataStore) MDMAppleInstallerDetailsByID(ctx context.Context, id uint) (*mobius.MDMAppleInstaller, error) {
	s.mu.Lock()
...
func (s *DataStore) MDMAppleInstallerDetailsByToken(ctx context.Context, token string) (*mobius.MDMAppleInstaller, error) {
	s.mu.Lock()
...
func (s *DataStore) ListMDMAppleInstallers(ctx context.Context) ([]mobius.MDMAppleInstaller, error) {
	s.mu.Lock()
...
func (s *DataStore) BatchSetMDMAppleProfiles(ctx context.Context, tmID *uint, profiles []*mobius.MDMAppleConfigProfile) error {
	s.mu.Lock()
...
func (s *DataStore) MDMAppleListDevices(ctx context.Context) ([]mobius.MDMAppleDevice, error) {
	s.mu.Lock()
...
func (s *DataStore) UpsertMDMAppleHostDEPAssignments(ctx context.Context, hosts []mobius.Host, abmTokenID uint) error {
	s.mu.Lock()
...
func (s *DataStore) IngestMDMAppleDevicesFromDEPSync(ctx context.Context, devices []godep.Device, abmTokenID uint, macOSTeam *mobius.Team, iosTeam *mobius.Team, ipadTeam *mobius.Team) (int64, error) {
	s.mu.Lock()
...
func (s *DataStore) IngestMDMAppleDeviceFromOTAEnrollment(ctx context.Context, teamID *uint, deviceInfo mobius.MDMAppleMachineInfo) error {
	s.mu.Lock()
...
func (s *DataStore) MDMAppleUpsertHost(ctx context.Context, mdmHost *mobius.Host) error {
	s.mu.Lock()
...
func (s *DataStore) RestoreMDMApplePendingDEPHost(ctx context.Context, host *mobius.Host) error {
	s.mu.Lock()
...
func (s *DataStore) GetHostDEPAssignment(ctx context.Context, hostID uint) (*mobius.HostDEPAssignment, error) {
	s.mu.Lock()
...
func (s *DataStore) GetNanoMDMEnrollment(ctx context.Context, id string) (*mobius.NanoEnrollment, error) {
	s.mu.Lock()
...
func (s *DataStore) GetNanoMDMUserEnrollment(ctx context.Context, id string) (*mobius.NanoEnrollment, error) {
	s.mu.Lock()
...
func (s *DataStore) OutdatedAutomationBatch(ctx context.Context) ([]mobius.PolicyFailure, error) {
	s.mu.Lock()
...
func (s *DataStore) ListMDMAppleProfilesToInstall(ctx context.Context) ([]*mobius.MDMAppleProfilePayload, error) {
	s.mu.Lock()
...
func (s *DataStore) ListMDMAppleProfilesToRemove(ctx context.Context) ([]*mobius.MDMAppleProfilePayload, error) {
	s.mu.Lock()
...
func (s *DataStore) BulkUpsertMDMAppleHostProfiles(ctx context.Context, payload []*mobius.MDMAppleBulkUpsertHostProfilePayload) error {
	s.mu.Lock()
...
func (s *DataStore) BulkSetPendingMDMHostProfiles(ctx context.Context, hostIDs []uint, teamIDs []uint, profileUUIDs []string, hostUUIDs []string) (updates mobius.MDMProfilesUpdates, err error) {
	s.mu.Lock()
...
func (s *DataStore) UpdateOrDeleteHostMDMAppleProfile(ctx context.Context, profile *mobius.HostMDMAppleProfile) error {
	s.mu.Lock()
...
func (s *DataStore) GetMDMAppleProfilesSummary(ctx context.Context, teamID *uint) (*mobius.MDMProfilesSummary, error) {
	s.mu.Lock()
...
func (s *DataStore) InsertMDMIdPAccount(ctx context.Context, account *mobius.MDMIdPAccount) error {
	s.mu.Lock()
...
func (s *DataStore) GetMDMIdPAccountByUUID(ctx context.Context, uuid string) (*mobius.MDMIdPAccount, error) {
	s.mu.Lock()
...
func (s *DataStore) GetMDMIdPAccountByEmail(ctx context.Context, email string) (*mobius.MDMIdPAccount, error) {
	s.mu.Lock()
...
func (s *DataStore) GetMDMAppleFileVaultSummary(ctx context.Context, teamID *uint) (*mobius.MDMAppleFileVaultSummary, error) {
	s.mu.Lock()
...
func (s *DataStore) InsertMDMAppleBootstrapPackage(ctx context.Context, bp *mobius.MDMAppleBootstrapPackage, pkgStore mobius.MDMBootstrapPackageStore) error {
	s.mu.Lock()
...
func (s *DataStore) CopyDefaultMDMAppleBootstrapPackage(ctx context.Context, ac *mobius.AppConfig, toTeamID uint) error {
	s.mu.Lock()
...
func (s *DataStore) GetMDMAppleBootstrapPackageMeta(ctx context.Context, teamID uint) (*mobius.MDMAppleBootstrapPackage, error) {
	s.mu.Lock()
...
func (s *DataStore) GetMDMAppleBootstrapPackageBytes(ctx context.Context, token string, pkgStore mobius.MDMBootstrapPackageStore) (*mobius.MDMAppleBootstrapPackage, error) {
	s.mu.Lock()
...
func (s *DataStore) GetMDMAppleBootstrapPackageSummary(ctx context.Context, teamID uint) (*mobius.MDMAppleBootstrapPackageSummary, error) {
	s.mu.Lock()
...
func (s *DataStore) CleanupUnusedBootstrapPackages(ctx context.Context, pkgStore mobius.MDMBootstrapPackageStore, removeCreatedBefore time.Time) error {
	s.mu.Lock()
...
func (s *DataStore) GetHostMDMMacOSSetup(ctx context.Context, hostID uint) (*mobius.HostMDMMacOSSetup, error) {
	s.mu.Lock()
...
func (s *DataStore) MDMGetEULAMetadata(ctx context.Context) (*mobius.MDMEULA, error) {
	s.mu.Lock()
...
func (s *DataStore) MDMGetEULABytes(ctx context.Context, token string) (*mobius.MDMEULA, error) {
	s.mu.Lock()
...
func (s *DataStore) MDMInsertEULA(ctx context.Context, eula *mobius.MDMEULA) error {
	s.mu.Lock()
...
func (s *DataStore) SetOrUpdateMDMAppleSetupAssistant(ctx context.Context, asst *mobius.MDMAppleSetupAssistant) (*mobius.MDMAppleSetupAssistant, error) {
	s.mu.Lock()
...
func (s *DataStore) GetMDMAppleSetupAssistant(ctx context.Context, teamID *uint) (*mobius.MDMAppleSetupAssistant, error) {
	s.mu.Lock()
...
func (s *DataStore) GetMatchingHostSerials(ctx context.Context, serials []string) (map[string]*mobius.Host, error) {
	s.mu.Lock()
...
func (s *DataStore) MDMAppleDDMDeclarationsToken(ctx context.Context, hostUUID string) (*mobius.MDMAppleDDMDeclarationsToken, error) {
	s.mu.Lock()
...
func (s *DataStore) MDMAppleDDMDeclarationItems(ctx context.Context, hostUUID string) ([]mobius.MDMAppleDDMDeclarationItem, error) {
	s.mu.Lock()
...
func (s *DataStore) MDMAppleDDMDeclarationsResponse(ctx context.Context, identifier string, hostUUID string) (*mobius.MDMAppleDeclaration, error) {
	s.mu.Lock()
...
func (s *DataStore) MDMAppleStoreDDMStatusReport(ctx context.Context, hostUUID string, updates []*mobius.MDMAppleHostDeclaration) error {
	s.mu.Lock()
...
func (s *DataStore) MDMAppleSetPendingDeclarationsAs(ctx context.Context, hostUUID string, status *mobius.MDMDeliveryStatus, detail string) error {
	s.mu.Lock()
...
func (s *DataStore) GetMDMAppleOSUpdatesSettingsByHostSerial(ctx context.Context, hostSerial string) (*mobius.AppleOSUpdateSettings, error) {
	s.mu.Lock()
...
func (s *DataStore) InsertMDMConfigAssets(ctx context.Context, assets []mobius.MDMConfigAsset, tx sqlx.ExtContext) error {
	s.mu.Lock()
...
func (s *DataStore) InsertOrReplaceMDMConfigAsset(ctx context.Context, asset mobius.MDMConfigAsset) error {
	s.mu.Lock()
...
func (s *DataStore) GetAllMDMConfigAssetsByName(ctx context.Context, assetNames []mobius.MDMAssetName, queryerContext sqlx.QueryerContext) (map[mobius.MDMAssetName]mobius.MDMConfigAsset, error) {
	s.mu.Lock()
...
func (s *DataStore) GetAllMDMConfigAssetsHashes(ctx context.Context, assetNames []mobius.MDMAssetName) (map[mobius.MDMAssetName]string, error) {
	s.mu.Lock()
...
func (s *DataStore) DeleteMDMConfigAssetsByName(ctx context.Context, assetNames []mobius.MDMAssetName) error {
	s.mu.Lock()
...
func (s *DataStore) HardDeleteMDMConfigAsset(ctx context.Context, assetName mobius.MDMAssetName) error {
	s.mu.Lock()
...
func (s *DataStore) ReplaceMDMConfigAssets(ctx context.Context, assets []mobius.MDMConfigAsset, tx sqlx.ExtContext) error {
	s.mu.Lock()
...
func (s *DataStore) GetAllCAConfigAssetsByType(ctx context.Context, assetType mobius.CAConfigAssetType) (map[string]mobius.CAConfigAsset, error) {
	s.mu.Lock()
...
func (s *DataStore) GetCAConfigAsset(ctx context.Context, name string, assetType mobius.CAConfigAssetType) (*mobius.CAConfigAsset, error) {
	s.mu.Lock()
...
func (s *DataStore) SaveCAConfigAssets(ctx context.Context, assets []mobius.CAConfigAsset) error {
	s.mu.Lock()
...
func (s *DataStore) GetABMTokenByOrgName(ctx context.Context, orgName string) (*mobius.ABMToken, error) {
	s.mu.Lock()
...
func (s *DataStore) SaveABMToken(ctx context.Context, tok *mobius.ABMToken) error {
	s.mu.Lock()
...
func (s *DataStore) InsertVPPToken(ctx context.Context, tok *mobius.VPPTokenData) (*mobius.VPPTokenDB, error) {
	s.mu.Lock()
...
func (s *DataStore) ListVPPTokens(ctx context.Context) ([]*mobius.VPPTokenDB, error) {
	s.mu.Lock()
...
func (s *DataStore) GetVPPToken(ctx context.Context, tokenID uint) (*mobius.VPPTokenDB, error) {
	s.mu.Lock()
...
func (s *DataStore) GetVPPTokenByTeamID(ctx context.Context, teamID *uint) (*mobius.VPPTokenDB, error) {
	s.mu.Lock()
...
func (s *DataStore) UpdateVPPTokenTeams(ctx context.Context, id uint, teams []uint) (*mobius.VPPTokenDB, error) {
	s.mu.Lock()
...
func (s *DataStore) UpdateVPPToken(ctx context.Context, id uint, tok *mobius.VPPTokenData) (*mobius.VPPTokenDB, error) {
	s.mu.Lock()
...
func (s *DataStore) InsertABMToken(ctx context.Context, tok *mobius.ABMToken) (*mobius.ABMToken, error) {
	s.mu.Lock()
...
func (s *DataStore) ListABMTokens(ctx context.Context) ([]*mobius.ABMToken, error) {
	s.mu.Lock()
...
func (s *DataStore) GetABMTokenByID(ctx context.Context, tokenID uint) (*mobius.ABMToken, error) {
	s.mu.Lock()
...
func (s *DataStore) GetMDMAppleEnrolledDeviceDeletedFromMobius(ctx context.Context, hostUUID string) (*mobius.MDMAppleEnrolledDeviceInfo, error) {
	s.mu.Lock()
	s.GetMDMAppleEnrolledDeviceDeletedFromMobiusFuncInvoked = true
	s.mu.Unlock()
	return s.GetMDMAppleEnrolledDeviceDeletedFromMobiusFunc(ctx, hostUUID)
}

func (s *DataStore) ListMDMAppleEnrolledIPhoneIpadDeletedFromMobius(ctx context.Context, limit int) ([]string, error) {
	s.mu.Lock()
	s.ListMDMAppleEnrolledIPhoneIpadDeletedFromMobiusFuncInvoked = true
	s.mu.Unlock()
	return s.ListMDMAppleEnrolledIPhoneIpadDeletedFromMobiusFunc(ctx, limit)
}

func (s *DataStore) ReconcileMDMAppleEnrollRef(ctx context.Context, enrollRef string, machineInfo *mobius.MDMAppleMachineInfo) (string, error) {
	s.mu.Lock()
...
func (s *DataStore) GetMDMIdPAccountByHostUUID(ctx context.Context, hostUUID string) (*mobius.MDMIdPAccount, error) {
	s.mu.Lock()
...
func (s *DataStore) MDMWindowsInsertEnrolledDevice(ctx context.Context, device *mobius.MDMWindowsEnrolledDevice) error {
	s.mu.Lock()
...
func (s *DataStore) MDMWindowsGetEnrolledDeviceWithDeviceID(ctx context.Context, mdmDeviceID string) (*mobius.MDMWindowsEnrolledDevice, error) {
	s.mu.Lock()
...
func (s *DataStore) MDMWindowsInsertCommandForHosts(ctx context.Context, hostUUIDs []string, cmd *mobius.MDMWindowsCommand) error {
	s.mu.Lock()
...
func (s *DataStore) MDMWindowsGetPendingCommands(ctx context.Context, deviceID string) ([]*mobius.MDMWindowsCommand, error) {
	s.mu.Lock()
...
func (s *DataStore) MDMWindowsSaveResponse(ctx context.Context, deviceID string, enrichedSyncML mobius.EnrichedSyncML) error {
	s.mu.Lock()
...
func (s *DataStore) GetMDMWindowsCommandResults(ctx context.Context, commandUUID string) ([]*mobius.MDMCommandResult, error) {
	s.mu.Lock()
...
func (s *DataStore) GetMDMWindowsConfigProfile(ctx context.Context, profileUUID string) (*mobius.MDMWindowsConfigProfile, error) {
	s.mu.Lock()
...
func (s *DataStore) GetHostMDMWindowsProfiles(ctx context.Context, hostUUID string) ([]mobius.HostMDMWindowsProfile, error) {
	s.mu.Lock()
...
func (s *DataStore) ListMDMConfigProfiles(ctx context.Context, teamID *uint, opt mobius.ListOptions) ([]*mobius.MDMConfigProfilePayload, *mobius.PaginationMetadata, error) {
	s.mu.Lock()
...
func (s *DataStore) BatchResendMDMProfileToHosts(ctx context.Context, profileUUID string, filters mobius.BatchResendMDMProfileFilters) (int64, error) {
	s.mu.Lock()
...
func (s *DataStore) GetMDMConfigProfileStatus(ctx context.Context, profileUUID string) (mobius.MDMConfigProfileStatus, error) {
	s.mu.Lock()
...
func (s *DataStore) GetHostMDMProfileInstallStatus(ctx context.Context, hostUUID string, profileUUID string) (mobius.MDMDeliveryStatus, error) {
	s.mu.Lock()
...
func (s *DataStore) GetLinuxDiskEncryptionSummary(ctx context.Context, teamID *uint) (mobius.MDMLinuxDiskEncryptionSummary, error) {
	s.mu.Lock()
...
func (s *DataStore) ListMDMCommands(ctx context.Context, tmFilter mobius.TeamFilter, listOpts *mobius.MDMCommandListOptions) ([]*mobius.MDMCommand, error) {
	s.mu.Lock()
...
func (s *DataStore) GetMDMWindowsBitLockerSummary(ctx context.Context, teamID *uint) (*mobius.MDMWindowsBitLockerSummary, error) {
	s.mu.Lock()
...
func (s *DataStore) GetMDMWindowsBitLockerStatus(ctx context.Context, host *mobius.Host) (*mobius.HostMDMDiskEncryption, error) {
	s.mu.Lock()
...
func (s *DataStore) GetMDMWindowsProfilesSummary(ctx context.Context, teamID *uint) (*mobius.MDMProfilesSummary, error) {
	s.mu.Lock()
...
func (s *DataStore) ListMDMWindowsProfilesToInstall(ctx context.Context) ([]*mobius.MDMWindowsProfilePayload, error) {
	s.mu.Lock()
...
func (s *DataStore) ListMDMWindowsProfilesToRemove(ctx context.Context) ([]*mobius.MDMWindowsProfilePayload, error) {
	s.mu.Lock()
...
func (s *DataStore) BulkUpsertMDMWindowsHostProfiles(ctx context.Context, payload []*mobius.MDMWindowsBulkUpsertHostProfilePayload) error {
	s.mu.Lock()
...
func (s *DataStore) GetMDMWindowsProfilesContents(ctx context.Context, profileUUIDs []string) (map[string]mobius.MDMWindowsProfileContents, error) {
	s.mu.Lock()
...
func (s *DataStore) BulkDeleteMDMWindowsHostsConfigProfiles(ctx context.Context, payload []*mobius.MDMWindowsProfilePayload) error {
	s.mu.Lock()
...
func (s *DataStore) NewMDMWindowsConfigProfile(ctx context.Context, cp mobius.MDMWindowsConfigProfile) (*mobius.MDMWindowsConfigProfile, error) {
	s.mu.Lock()
...
func (s *DataStore) SetOrUpdateMDMWindowsConfigProfile(ctx context.Context, cp mobius.MDMWindowsConfigProfile) error {
	s.mu.Lock()
...
func (s *DataStore) BatchSetMDMProfiles(ctx context.Context, tmID *uint, macProfiles []*mobius.MDMAppleConfigProfile, winProfiles []*mobius.MDMWindowsConfigProfile, macDeclarations []*mobius.MDMAppleDeclaration, profilesVariables []mobius.MDMProfileIdentifierMobiusVariables) (updates mobius.MDMProfilesUpdates, err error) {
	s.mu.Lock()
...
func (s *DataStore) NewMDMAppleDeclaration(ctx context.Context, declaration *mobius.MDMAppleDeclaration) (*mobius.MDMAppleDeclaration, error) {
	s.mu.Lock()
...
func (s *DataStore) SetOrUpdateMDMAppleDeclaration(ctx context.Context, declaration *mobius.MDMAppleDeclaration) (*mobius.MDMAppleDeclaration, error) {
	s.mu.Lock()
...
func (s *DataStore) NewHostScriptExecutionRequest(ctx context.Context, request *mobius.HostScriptRequestPayload) (*mobius.HostScriptResult, error) {
	s.mu.Lock()
...
func (s *DataStore) SetHostScriptExecutionResult(ctx context.Context, result *mobius.HostScriptResultPayload) (hsr *mobius.HostScriptResult, action string, err error) {
	s.mu.Lock()
...
func (s *DataStore) GetHostScriptExecutionResult(ctx context.Context, execID string) (*mobius.HostScriptResult, error) {
	s.mu.Lock()
...
func (s *DataStore) GetSelfServiceUninstallScriptExecutionResult(ctx context.Context, execID string, hostID uint) (*mobius.HostScriptResult, error) {
	s.mu.Lock()
...
func (s *DataStore) ListPendingHostScriptExecutions(ctx context.Context, hostID uint, onlyShowInternal bool) ([]*mobius.HostScriptResult, error) {
	s.mu.Lock()
...
func (s *DataStore) ListReadyToExecuteScriptsForHost(ctx context.Context, hostID uint, onlyShowInternal bool) ([]*mobius.HostScriptResult, error) {
	s.mu.Lock()
...
func (s *DataStore) NewScript(ctx context.Context, script *mobius.Script) (*mobius.Script, error) {
	s.mu.Lock()
...
func (s *DataStore) UpdateScriptContents(ctx context.Context, scriptID uint, scriptContents string) (*mobius.Script, error) {
	s.mu.Lock()
...
func (s *DataStore) Script(ctx context.Context, id uint) (*mobius.Script, error) {
	s.mu.Lock()
...
func (s *DataStore) ListScripts(ctx context.Context, teamID *uint, opt mobius.ListOptions) ([]*mobius.Script, *mobius.PaginationMetadata, error) {
	s.mu.Lock()
...
func (s *DataStore) GetHostScriptDetails(ctx context.Context, hostID uint, teamID *uint, opts mobius.ListOptions, hostPlatform string) ([]*mobius.HostScriptDetail, *mobius.PaginationMetadata, error) {
	s.mu.Lock()
...
func (s *DataStore) BatchSetScripts(ctx context.Context, tmID *uint, scripts []*mobius.Script) ([]mobius.ScriptResponse, error) {
	s.mu.Lock()
...
func (s *DataStore) BatchExecuteSummary(ctx context.Context, executionID string) (*mobius.BatchExecutionSummary, error) {
	s.mu.Lock()
...
func (s *DataStore) GetHostLockWipeStatus(ctx context.Context, host *mobius.Host) (*mobius.HostLockWipeStatus, error) {
	s.mu.Lock()
...
func (s *DataStore) LockHostViaScript(ctx context.Context, request *mobius.HostScriptRequestPayload, hostMobiusPlatform string) error {
	s.mu.Lock()
	s.LockHostViaScriptFuncInvoked = true
	s.mu.Unlock()
	return s.LockHostViaScriptFunc(ctx, request, hostMobiusPlatform)
}

func (s *DataStore) UnlockHostViaScript(ctx context.Context, request *mobius.HostScriptRequestPayload, hostMobiusPlatform string) error {
	s.mu.Lock()
	s.UnlockHostViaScriptFuncInvoked = true
	s.mu.Unlock()
	return s.UnlockHostViaScriptFunc(ctx, request, hostMobiusPlatform)
}

func (s *DataStore) UnlockHostManually(ctx context.Context, hostID uint, hostMobiusPlatform string, ts time.Time) error {
	s.mu.Lock()
	s.UnlockHostManuallyFuncInvoked = true
	s.mu.Unlock()
	return s.UnlockHostManuallyFunc(ctx, hostID, hostMobiusPlatform, ts)
}
...
func (s *DataStore) WipeHostViaScript(ctx context.Context, request *mobius.HostScriptRequestPayload, hostMobiusPlatform string) error {
	s.mu.Lock()
	s.WipeHostViaScriptFuncInvoked = true
	s.mu.Unlock()
	return s.WipeHostViaScriptFunc(ctx, request, hostMobiusPlatform)
}

func (s *DataStore) WipeHostViaWindowsMDM(ctx context.Context, host *mobius.Host, cmd *mobius.MDMWindowsCommand) error {
	s.mu.Lock()
...
func (s *DataStore) GetSoftwareInstallDetails(ctx context.Context, executionId string) (*mobius.SoftwareInstallDetails, error) {
	s.mu.Lock()
...
func (s *DataStore) GetHostLastInstallData(ctx context.Context, hostID uint, installerID uint) (*mobius.HostLastInstallData, error) {
	s.mu.Lock()
...
func (s *DataStore) MatchOrCreateSoftwareInstaller(ctx context.Context, payload *mobius.UploadSoftwareInstallerPayload) (installerID uint, titleID uint, err error) {
	s.mu.Lock()
...
func (s *DataStore) GetSoftwareInstallerMetadataByID(ctx context.Context, id uint) (*mobius.SoftwareInstaller, error) {
	s.mu.Lock()
...
func (s *DataStore) UpdateSoftwareInstallerWithoutPackageIDs(ctx context.Context, id uint, payload mobius.UploadSoftwareInstallerPayload) error {
	s.mu.Lock()
...
func (s *DataStore) SaveInstallerUpdates(ctx context.Context, payload *mobius.UpdateSoftwareInstallerPayload) error {
	s.mu.Lock()
...
func (s *DataStore) GetVPPAppByTeamAndTitleID(ctx context.Context, teamID *uint, titleID uint) (*mobius.VPPApp, error) {
	s.mu.Lock()
...
func (s *DataStore) GetVPPAppMetadataByTeamAndTitleID(ctx context.Context, teamID *uint, titleID uint) (*mobius.VPPAppStoreApp, error) {
	s.mu.Lock()
...
func (s *DataStore) GetTitleInfoFromVPPAppsTeamsID(ctx context.Context, vppAppsTeamsID uint) (*mobius.PolicySoftwareTitle, error) {
	s.mu.Lock()
...
func (s *DataStore) GetVPPAppMetadataByAdamIDPlatformTeamID(ctx context.Context, adamID string, platform mobius.AppleDevicePlatform, teamID *uint) (*mobius.VPPApp, error) {
	s.mu.Lock()
...
func (s *DataStore) DeleteVPPAppFromTeam(ctx context.Context, teamID *uint, appID mobius.VPPAppID) error {
	s.mu.Lock()
...
func (s *DataStore) GetSummaryHostSoftwareInstalls(ctx context.Context, installerID uint) (*mobius.SoftwareInstallerStatusSummary, error) {
	s.mu.Lock()
...
func (s *DataStore) GetSummaryHostVPPAppInstalls(ctx context.Context, teamID *uint, appID mobius.VPPAppID) (*mobius.VPPAppStatusSummary, error) {
	s.mu.Lock()
...
func (s *DataStore) GetSoftwareInstallResults(ctx context.Context, resultsUUID string) (*mobius.HostSoftwareInstallerResult, error) {
	s.mu.Lock()
...
func (s *DataStore) CleanupUnusedSoftwareInstallers(ctx context.Context, softwareInstallStore mobius.SoftwareInstallerStore, removeCreatedBefore time.Time) error {
	s.mu.Lock()
...
func (s *DataStore) BatchSetSoftwareInstallers(ctx context.Context, tmID *uint, installers []*mobius.UploadSoftwareInstallerPayload) error {
	s.mu.Lock()
...
func (s *DataStore) GetSoftwareInstallers(ctx context.Context, tmID uint) ([]mobius.SoftwarePackageResponse, error) {
	s.mu.Lock()
...
func (s *DataStore) BatchInsertVPPApps(ctx context.Context, apps []*mobius.VPPApp) error {
	s.mu.Lock()
...
func (s *DataStore) GetAssignedVPPApps(ctx context.Context, teamID *uint) (map[mobius.VPPAppID]mobius.VPPAppTeam, error) {
	s.mu.Lock()
...
func (s *DataStore) GetVPPApps(ctx context.Context, teamID *uint) ([]mobius.VPPAppResponse, error) {
	s.mu.Lock()
...
func (s *DataStore) SetTeamVPPApps(ctx context.Context, teamID *uint, appIDs []mobius.VPPAppTeam) error {
	s.mu.Lock()
...
func (s *DataStore) InsertVPPAppWithTeam(ctx context.Context, app *mobius.VPPApp, teamID *uint) (*mobius.VPPApp, error) {
	s.mu.Lock()
...
func (s *DataStore) GetAllVPPApps(ctx context.Context) ([]*mobius.VPPApp, error) {
	s.mu.Lock()
...
func (s *DataStore) InsertVPPApps(ctx context.Context, apps []*mobius.VPPApp) error {
	s.mu.Lock()
...
func (s *DataStore) InsertHostVPPSoftwareInstall(ctx context.Context, hostID uint, appID mobius.VPPAppID, commandUUID string, associatedEventID string, opts mobius.HostSoftwareInstallOptions) error {
	s.mu.Lock()
...
func (s *DataStore) GetPastActivityDataForVPPAppInstall(ctx context.Context, commandResults *mdm.CommandResults) (*mobius.User, *mobius.ActivityInstalledAppStoreApp, error) {
	s.mu.Lock()
...
func (s *DataStore) GetVPPTokenByLocation(ctx context.Context, loc string) (*mobius.VPPTokenDB, error) {
	s.mu.Lock()
...
func (s *DataStore) ListSetupExperienceSoftwareTitles(ctx context.Context, teamID uint, opts mobius.ListOptions) ([]mobius.SoftwareTitleListResult, int, *mobius.PaginationMetadata, error) {
	s.mu.Lock()
...
func (s *DataStore) GetTeamsWithInstallerByHash(ctx context.Context, sha256 string, url string) (map[uint]*mobius.ExistingSoftwareInstaller, error) {
	s.mu.Lock()
...
func (s *DataStore) ListSetupExperienceResultsByHostUUID(ctx context.Context, hostUUID string) ([]*mobius.SetupExperienceStatusResult, error) {
	s.mu.Lock()
...
func (s *DataStore) UpdateSetupExperienceStatusResult(ctx context.Context, status *mobius.SetupExperienceStatusResult) error {
	s.mu.Lock()
...
func (s *DataStore) GetSetupExperienceScript(ctx context.Context, teamID *uint) (*mobius.Script, error) {
	s.mu.Lock()
...
func (s *DataStore) GetSetupExperienceScriptByID(ctx context.Context, scriptID uint) (*mobius.Script, error) {
	s.mu.Lock()
...
func (s *DataStore) SetSetupExperienceScript(ctx context.Context, script *mobius.Script) error {
	s.mu.Lock()
...
func (s *DataStore) MaybeUpdateSetupExperienceScriptStatus(ctx context.Context, hostUUID string, executionID string, status mobius.SetupExperienceStatusResultStatus) (bool, error) {
	s.mu.Lock()
...
func (s *DataStore) MaybeUpdateSetupExperienceSoftwareInstallStatus(ctx context.Context, hostUUID string, executionID string, status mobius.SetupExperienceStatusResultStatus) (bool, error) {
	s.mu.Lock()
...
func (s *DataStore) MaybeUpdateSetupExperienceVPPStatus(ctx context.Context, hostUUID string, commandUUID string, status mobius.SetupExperienceStatusResultStatus) (bool, error) {
	s.mu.Lock()
...
func (s *DataStore) ListAvailableMobiusMaintainedApps(ctx context.Context, teamID *uint, opt mobius.ListOptions) ([]mobius.MaintainedApp, *mobius.PaginationMetadata, error) {
	s.mu.Lock()
	s.ListAvailableMobiusMaintainedAppsFuncInvoked = true
	s.mu.Unlock()
	return s.ListAvailableMobiusMaintainedAppsFunc(ctx, teamID, opt)
}

func (s *DataStore) ClearRemovedMobiusMaintainedApps(ctx context.Context, slugsToKeep []string) error {
	s.mu.Lock()
	s.ClearRemovedMobiusMaintainedAppsFuncInvoked = true
	s.mu.Unlock()
	return s.ClearRemovedMobiusMaintainedAppsFunc(ctx, slugsToKeep)
}

func (s *DataStore) GetMaintainedAppByID(ctx context.Context, appID uint, teamID *uint) (*mobius.MaintainedApp, error) {
	s.mu.Lock()
...
func (s *DataStore) GetMaintainedAppBySlug(ctx context.Context, slug string, teamID *uint) (*mobius.MaintainedApp, error) {
	s.mu.Lock()
...
func (s *DataStore) UpsertMaintainedApp(ctx context.Context, app *mobius.MaintainedApp) (*mobius.MaintainedApp, error) {
	s.mu.Lock()
...
func (s *DataStore) BulkUpsertMDMManagedCertificates(ctx context.Context, payload []*mobius.MDMManagedCertificate) error {
	s.mu.Lock()
...
func (s *DataStore) GetHostMDMCertificateProfile(ctx context.Context, hostUUID string, profileUUID string, caName string) (*mobius.HostMDMCertificateProfile, error) {
	s.mu.Lock()
...
func (s *DataStore) ListHostMDMManagedCertificates(ctx context.Context, hostUUID string) ([]*mobius.MDMManagedCertificate, error) {
	s.mu.Lock()
...
func (s *DataStore) UpsertSecretVariables(ctx context.Context, secretVariables []mobius.SecretVariable) error {
	s.mu.Lock()
...
func (s *DataStore) GetSecretVariables(ctx context.Context, names []string) ([]mobius.SecretVariable, error) {
	s.mu.Lock()
...
func (s *DataStore) AndroidHostLite(ctx context.Context, enterpriseSpecificID string) (*mobius.AndroidHost, error) {
	s.mu.Lock()
...
func (s *DataStore) NewAndroidHost(ctx context.Context, host *mobius.AndroidHost) (*mobius.AndroidHost, error) {
	s.mu.Lock()
...
func (s *DataStore) UpdateAndroidHost(ctx context.Context, host *mobius.AndroidHost, fromEnroll bool) error {
	s.mu.Lock()
...
func (s *DataStore) CreateScimUser(ctx context.Context, user *mobius.ScimUser) (uint, error) {
	s.mu.Lock()
...
func (s *DataStore) ScimUserByID(ctx context.Context, id uint) (*mobius.ScimUser, error) {
	s.mu.Lock()
...
func (s *DataStore) ScimUserByUserName(ctx context.Context, userName string) (*mobius.ScimUser, error) {
	s.mu.Lock()
...
func (s *DataStore) ScimUserByUserNameOrEmail(ctx context.Context, userName string, email string) (*mobius.ScimUser, error) {
	s.mu.Lock()
...
func (s *DataStore) ScimUserByHostID(ctx context.Context, hostID uint) (*mobius.ScimUser, error) {
	s.mu.Lock()
...
func (s *DataStore) ReplaceScimUser(ctx context.Context, user *mobius.ScimUser) error {
	s.mu.Lock()
...
func (s *DataStore) ListScimUsers(ctx context.Context, opts mobius.ScimUsersListOptions) (users []mobius.ScimUser, totalResults uint, err error) {
	s.mu.Lock()
...
func (s *DataStore) CreateScimGroup(ctx context.Context, group *mobius.ScimGroup) (uint, error) {
	s.mu.Lock()
...
func (s *DataStore) ScimGroupByID(ctx context.Context, id uint, excludeUsers bool) (*mobius.ScimGroup, error) {
	s.mu.Lock()
...
func (s *DataStore) ScimGroupByDisplayName(ctx context.Context, displayName string) (*mobius.ScimGroup, error) {
	s.mu.Lock()
...
func (s *DataStore) ReplaceScimGroup(ctx context.Context, group *mobius.ScimGroup) error {
	s.mu.Lock()
...
func (s *DataStore) ListScimGroups(ctx context.Context, opts mobius.ScimGroupsListOptions) (groups []mobius.ScimGroup, totalResults uint, err error) {
	s.mu.Lock()
...
func (s *DataStore) ScimLastRequest(ctx context.Context) (*mobius.ScimLastRequest, error) {
	s.mu.Lock()
...
func (s *DataStore) UpdateScimLastRequest(ctx context.Context, lastRequest *mobius.ScimLastRequest) error {
	s.mu.Lock()
...
func (s *DataStore) ConditionalAccessMicrosoftGet(ctx context.Context) (*mobius.ConditionalAccessMicrosoftIntegration, error) {
	s.mu.Lock()
...
func (s *DataStore) LoadHostConditionalAccessStatus(ctx context.Context, hostID uint) (*mobius.HostConditionalAccessStatus, error) {
	s.mu.Lock()
