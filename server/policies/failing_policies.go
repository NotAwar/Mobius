...
func TriggerFailingPoliciesAutomation(
	...
	sendFunc func(*mobius.Policy, FailingPolicyAutomationConfig) error,
) error {
...
func makeTeamConfigCache(ds mobius.Datastore, globalIntgs mobius.Integrations) func(ctx context.Context, teamID uint) (FailingPolicyAutomationConfig, error) {
...
func getActiveAutomation(webhook mobius.FailingPoliciesWebhookSettings, intgs mobius.Integrations) FailingPolicyAutomationType {
