...
func testCollectHostsLastSeen(t *testing.T, ds *mysql.Datastore, pool mobius.RedisPool) {
...
func testRecordHostLastSeenSync(t *testing.T, ds *mock.Store, pool mobius.RedisPool) {
	ctx := context.Background()
...
func testRecordHostLastSeenAsync(t *testing.T, ds *mock.Store, pool mobius.RedisPool) {
	ctx := context.Background()
