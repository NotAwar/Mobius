...
var (
	...
	ErrPasswordResetRequired = errors.New("Password reset required. Please sign into the Mobius UI to update your password, then log in again with: mobiuscli login.")
...
func (e setupAlreadyErr) Error() string {
	return "Mobius has already been setup"
}
...
func (e notSetupErr) Error() string {
	return "The Mobius instance is not set up yet"
}
...
// TODO: we have a similar but different interface in the mobius package,
// mobius.NotFoundError - at the very least, the NotFound method should be the
