...
type listCarvesRequest struct {
	ListOptions mobius.CarveListOptions `url:"carve_options"`
}
...
func listCarvesEndpoint(ctx context.Context, request interface{}, svc mobius.Service) (mobius.Errorer, error) {
...
func (svc *Service) ListCarves(ctx context.Context, opt mobius.CarveListOptions) ([]*mobius.CarveMetadata, error) {
	if err := svc.authz.Authorize(ctx, &mobius.CarveMetadata{}, mobius.ActionRead); err != nil {
		return nil, err
	}
...
func getCarveEndpoint(ctx context.Context, request interface{}, svc mobius.Service) (mobius.Errorer, error) {
...
func (svc *Service) GetCarve(ctx context.Context, id int64) (*mobius.CarveMetadata, error) {
	if err := svc.authz.Authorize(ctx, &mobius.CarveMetadata{}, mobius.ActionRead); err != nil {
		return nil, err
	}
...
func getCarveBlockEndpoint(ctx context.Context, request interface{}, svc mobius.Service) (mobius.Errorer, error) {
...
func carveBeginEndpoint(ctx context.Context, request interface{}, svc mobius.Service) (mobius.Errorer, error) {
...
func (svc *Service) CarveBegin(ctx context.Context, payload mobius.CarveBeginPayload) (*mobius.CarveMetadata, error) {
...
func carveBlockEndpoint(ctx context.Context, request interface{}, svc mobius.Service) (mobius.Errorer, error) {
...
func (svc *Service) CarveBlock(ctx context.Context, payload mobius.CarveBlockPayload) error {
	// skipauth: Authorization is currently for user endpoints only.
	svc.authz.SkipAuthorization(ctx)
...
func (svc *Service) validateCarveBlock(payload mobius.CarveBlockPayload, carve *mobius.CarveMetadata) error {
