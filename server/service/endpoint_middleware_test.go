...
// 	assert.Nil(t, err)
// 	admin1Session, err := ds.NewSession(&mobius.Session{
// 		UserID: admin1.ID,
// 		Key:    "admin1",
// 	})
// 	assert.Nil(t, err)
...
// 	assert.Nil(t, err)
// 	user1Session, err := ds.NewSession(&mobius.Session{
// 		UserID: user1.ID,
// 		Key:    "user1",
// 	})
// 	assert.Nil(t, err)
...
// 	assert.Nil(t, err)
// 	user2Session, err := ds.NewSession(&mobius.Session{
// 		UserID: user2.ID,
// 		Key:    "user2",
// 	})
// 	assert.Nil(t, err)
...
func TestAuthenticatedHost(t *testing.T) {
	...
	expectedHost := mobius.Host{Hostname: "foo!"}
