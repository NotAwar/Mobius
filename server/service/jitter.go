...
// jitterHashTable implements a data structure that allows a mobius to generate a static jitter value
...
// Hosts that have been placed in a bucket remain in that bucket for as long as the mobius instance is
// running.
...
// The main caveat of this approach is that it works at the mobius instance. So depending on what
