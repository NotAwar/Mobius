...
func (mw metricsMiddleware) CallbackSSO(ctx context.Context, auth mobius.Auth) (sess *mobius.SSOSession, err error) {
	defer func(begin time.Time) {
...
func (mw metricsMiddleware) Login(ctx context.Context, email string, password string, supportsEmailVerification bool) (*mobius.User, *mobius.Session, error) {
	var (
		user    *mobius.User
...
func (mw metricsMiddleware) GetInfoAboutSessionsForUser(ctx context.Context, id uint) ([]*mobius.Session, error) {
	var (
		sessions []*mobius.Session
		err      error
	)
	defer func(begin time.Time) {
...
func (mw metricsMiddleware) GetInfoAboutSession(ctx context.Context, id uint) (*mobius.Session, error) {
	var (
		session *mobius.Session
		err     error
	)
