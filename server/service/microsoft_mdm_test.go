...
func NewSoapRequest(request []byte) (mobius.SoapRequest, error) {
	// Sanity check on input
	if len(request) == 0 {
		return mobius.SoapRequest{}, errors.New("soap request is invalid")
	}

	// Unmarshal the XML data from the request into the SoapRequest struct
	var req mobius.SoapRequest
...
func TestValidSyncMLCmdStatus(t *testing.T) {
	...
	err = checkWrappedSyncMLCmd(mobius.CmdStatus, payload)
	require.NoError(t, err)
...
func TestValidNewSyncMLCmdGet(t *testing.T) {
	testOmaURI := "testuri"
	cmdMsg := newSyncMLNoFormat(mobius.CmdGet, testOmaURI)
	outXML, err := xml.MarshalIndent(cmdMsg, "", "  ")
	require.NoError(t, err)
	require.NotEmpty(t, outXML)
	payload := string(outXML)
	err = checkWrappedSyncMLCmd(mobius.CmdGet, payload)
	require.NoError(t, err)
...
func TestValidNewSyncMLCmdBool(t *testing.T) {
	...
	require.NotEmpty(t, outXML)
	payload := string(outXML)
	err = checkWrappedSyncMLCmd(mobius.CmdReplace, payload)
	require.NoError(t, err)
	require.Contains(t, payload, fmt.Sprintf("<LocURI>%s</LocURI>", testOmaURI))
...
func TestValidSyncMLCmdAlert(t *testing.T) {
	testData := "1234"
	cmdMsg := newSyncMLNoItem(mobius.CmdAlert, testData)
	outXML, err := xml.MarshalIndent(cmdMsg, "", "  ")
	require.NoError(t, err)
	require.NotEmpty(t, outXML)
	payload := string(outXML)
	err = checkWrappedSyncMLCmd(mobius.CmdAlert, payload)
	require.NoError(t, err)
	require.Contains(t, payload, fmt.Sprintf("<Data>%s</Data>", testData))
}
...
func TestBuildCommandFromProfileBytes(t *testing.T) {
	...
	require.Equal(
		t,
		fmt.Sprintf(`<Atomic><!-- CmdID generated by Mobius --><CmdID>uuid-1</CmdID><Replace><!-- CmdID generated by Mobius --><CmdID>%s</CmdID><Item><Target><LocURI>foo/bar</LocURI></Target></Item></Replace><Add><!-- CmdID generated by Mobius --><CmdID>%s</CmdID><Item><Target><LocURI>foo/bar</LocURI></Target></Item></Add></Atomic>`, syncOne.ReplaceCommands[0].CmdID.Value, syncOne.AddCommands[0].CmdID.Value),
	...
	require.Equal(
		t,
		fmt.Sprintf(`<Atomic><!-- CmdID generated by Mobius --><CmdID>uuid-2</CmdID><Replace><!-- CmdID generated by Mobius --><CmdID>%s</CmdID><Item><Target><LocURI>foo/bar</LocURI></Target></Item></Replace><Add><!-- CmdID generated by Mobius --><CmdID>%s</CmdID><Item><Target><LocURI>foo/bar</LocURI></Target></Item></Add></Atomic>`, syncTwo.ReplaceCommands[0].CmdID.Value, syncTwo.AddCommands[0].CmdID.Value),
		string(cmd.RawCommand),
	)
