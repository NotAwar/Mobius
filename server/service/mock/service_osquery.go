...
type AuthenticateHostFunc func(ctx context.Context, nodeKey string) (host *mobius.Host, debug bool, err error)
...
type SubmitDistributedQueryResultsFunc func(ctx context.Context, results mobius.OsqueryDistributedQueryResults, statuses map[string]mobius.OsqueryStatus, messages map[string]string, stats map[string]*mobius.Stats) (err error)
...
func (s *TLSService) AuthenticateHost(ctx context.Context, nodeKey string) (host *mobius.Host, debug bool, err error) {
	s.mu.Lock()
...
func (s *TLSService) SubmitDistributedQueryResults(ctx context.Context, results mobius.OsqueryDistributedQueryResults, statuses map[string]mobius.OsqueryStatus, messages map[string]string, stats map[string]*mobius.Stats) (err error) {
	s.mu.Lock()
...
func (s *TLSService) YaraRuleByName(ctx context.Context, name string) (*mobius.YaraRule, error) {
	s.mu.Lock()
