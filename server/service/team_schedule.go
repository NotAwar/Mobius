...
func getTeamScheduleEndpoint(ctx context.Context, request interface{}, svc mobius.Service) (mobius.Errorer, error) {
...
func (svc Service) GetTeamScheduledQueries(ctx context.Context, teamID uint, opts mobius.ListOptions) ([]*mobius.ScheduledQuery, error) {
	var teamID_ *uint
	if teamID != 0 {
		teamID_ = &teamID
	}
...
func teamScheduleQueryEndpoint(ctx context.Context, request interface{}, svc mobius.Service) (mobius.Errorer, error) {
	req := request.(*teamScheduleQueryRequest)
	resp, err := svc.TeamScheduleQuery(ctx, req.TeamID, &mobius.ScheduledQuery{
...
func (svc Service) TeamScheduleQuery(ctx context.Context, teamID uint, scheduledQuery *mobius.ScheduledQuery) (*mobius.ScheduledQuery, error) {
...
func modifyTeamScheduleEndpoint(ctx context.Context, request interface{}, svc mobius.Service) (mobius.Errorer, error) {
...
) (*mobius.ScheduledQuery, error) {
	query, err := svc.ModifyQuery(ctx, scheduledQueryID, mobius.ScheduledQueryPayloadToQueryPayloadForModifyQuery(scheduledQueryPayload))
	if err != nil {
		return nil, err
	}
...
func deleteTeamScheduleEndpoint(ctx context.Context, request interface{}, svc mobius.Service) (mobius.Errorer, error) {
