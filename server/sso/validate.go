...
type Validator interface {
	ValidateSignature(auth mobius.Auth) (mobius.Auth, error)
	ValidateResponse(auth mobius.Auth) error
}
...
func (v *validator) ValidateResponse(auth mobius.Auth) error {
	info := auth.(*resp)
...
func (v *validator) ValidateSignature(auth mobius.Auth) (mobius.Auth, error) {
	info := auth.(*resp)
...
func ValidateAudiences(metadata Metadata, auth mobius.Auth, audiences ...string) error {
