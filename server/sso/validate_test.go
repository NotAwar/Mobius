...
<?xml version="1.0" encoding="UTF-8"?>
  <md:EntityDescriptor xmlns:md="urn:oasis:names:tc:SAML:2.0:metadata" entityID="https://mobius-dev-ed.my.salesforce.com" validUntil="2027-04-29T19:22:40.750Z" xmlns:ds="http://www.w3.org/2000/09/xmldsig#">
      <md:IDPSSODescriptor WantAuthnRequestsSigned="false" protocolSupportEnumeration="urn:oasis:names:tc:SAML:2.0:protocol">
         ...
         <md:SingleSignOnService Binding="urn:oasis:names:tc:SAML:2.0:bindings:HTTP-POST" Location="https://mobius-dev-ed.my.salesforce.com/idp/endpoint/HttpPost"/>
         <md:SingleSignOnService Binding="urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Redirect" Location="https://mobius-dev-ed.my.salesforce.com/idp/endpoint/HttpRedirect"/>
      </md:IDPSSODescriptor>
   </md:EntityDescriptor>
`), &metadata); err != nil {
		panic(err)
...
func tamperedResponse(original string) (string, error) {
	...
	// change name
	resp.Assertion.Subject.NameID.Value = "bob@mobius.co"
...
func TestVerifyGoogleResponseCommentInjected(t *testing.T) {
	t.Skip("this test now fails on Go 1.17 because of changes to xml parser - it use to fail roundtripping, now it passes and there is no signature so the validation ends without error")
