...
func TestMatchVersion(t *testing.T) {
	...
	expected := []mobius.SoftwareVulnerability{
		{
			SoftwareID:        1,
			CVE:               "CVE-2024-001",
...
func TestMatchFilters(t *testing.T) {
	...
	testCases := []struct {
		name           string
		rule           CVEMatchingRule
		expectedFilter mobius.VulnSoftwareFilter
	}{
		{
			name: "Match all",
			rule: CVEMatchingRule{
...
func TestCheckCustomVulnerabilities(t *testing.T) {
	...
	t.Run("New Vulns return all inserted", func(t *testing.T) {
		...
		ds.InsertSoftwareVulnerabilityFunc = func(ctx context.Context, vuln mobius.SoftwareVulnerability, source mobius.VulnerabilitySource) (bool, error) {
			insertCount++
			require.Equal(t, mobius.CustomSource, source)
			return true, nil
		}
		...
		cmpSoftwareVulnerability := func(v []mobius.SoftwareVulnerability) func(i, j int) bool {
