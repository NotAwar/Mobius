...
func TestDatabase(t *testing.T) {
	...
	t.Run("Non-matching architecture", func(t *testing.T) {
		require.Len(t, db.Eval([]mobius.Software{{Name: "expat", Version: "2.1.0", Release: "", Arch: "x86_64"}}, logger), 0)
	})

	t.Run("Non-matching package name", func(t *testing.T) {
		require.Len(t, db.Eval([]mobius.Software{{Name: "expath", Version: "2.1.0", Release: "", Arch: "aarch64"}}, logger), 0)
	})

	t.Run("Fixed version", func(t *testing.T) {
		require.Len(t, db.Eval([]mobius.Software{{Name: "expath", Version: "2.1.0", Release: "15.amzn2.0.3", Arch: "aarch64"}}, logger), 0)
	})

	t.Run("Newer than fixed version", func(t *testing.T) {
		require.Len(t, db.Eval([]mobius.Software{{Name: "expath", Version: "2.1.0", Release: "15.amzn2.0.5", Arch: "aarch64"}}, logger), 0)
	})

	t.Run("Older than fixed version", func(t *testing.T) {
		vulns := db.Eval([]mobius.Software{{Name: "expat", Version: "2.1.0", Release: "", Arch: "aarch64", ID: 123}}, logger)
	...
	t.Run("Multiple packages, fixed version", func(t *testing.T) {
		require.Len(t, db.Eval([]mobius.Software{
