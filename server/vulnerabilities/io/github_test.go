...
func (m mockGHReleaseListerWithInvalidNames) ListReleases(
	...
	for i := 0; i < m.N; i++ {
		asset := github.ReleaseAsset{
			...
			URL:                ptr.String("https://api.github.com/repos/mobiusmdm/nvd/releases/assets/76142088"),
			...
			BrowserDownloadURL: ptr.String(fmt.Sprintf("https://github.com/notawar/nvd/releases/download/202208290017/%d.json", i)),
		...
		Assets: []*github.ReleaseAsset{
			{
				...
				Size:               ptr.Int(52107588),
				DownloadCount:      ptr.Int(683),
				BrowserDownloadURL: ptr.String("https://github.com/notawar/nvd/releases/download/202208290017/cpe-80f8ec9cfb9d810.sqlite"),
				NodeID:             ptr.String("RA_kwDOF19pRs4EidYI"),
			},
			{
				ID:                 ptr.Int64(76142089),
				URL:                ptr.String("https://api.github.com/repos/mobiusmdm/nvd/releases/assets/76142089"),
				...
				Size:               ptr.Int(52107588),
				DownloadCount:      ptr.Int(683),
				BrowserDownloadURL: ptr.String(fmt.Sprintf("https://github.com/notawar/nvd/releases/download/202208290017/%sWindows_10-2022_09_10.json", mSRCFilePrefix)),
			...
			},
			{
				...
				Size:               ptr.Int(52107588),
				DownloadCount:      ptr.Int(683),
				BrowserDownloadURL: ptr.String(fmt.Sprintf("https://github.com/notawar/nvd/releases/download/202208290017/%sWindows_11-2022_09_10.json", mSRCFilePrefix)),
				NodeID:             ptr.String("RA_kwDOF19pRs4EidYA"),
			},
		},
	})
...
func TestIntegrationsGithubClient(t *testing.T) {
	...
	t.Run("MacOfficeReleaseNotes", func(t *testing.T) {
		...
		t.Run("with a single release note asset", func(t *testing.T) {
			...
			name, url, err := sut.MacOfficeReleaseNotes(ctx)
			require.NoError(t, err)
			require.Equal(t, "https://github.com/notawar/nvd/releases/download/202208290017/0.json", url)
	...
	t.Run("#Download", func(t *testing.T) {
		...
		urlPath := fmt.Sprintf("/mobiusmdm/nvd/releases/download/202208290017/%s", fileName)
