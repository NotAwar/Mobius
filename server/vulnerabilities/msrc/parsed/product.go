...
func (p Products) GetMatchForOS(ctx context.Context, os mobius.OperatingSystem) (string, error) {
	...
	for pID, product := range p {
		...
		// updated after an upgrade to mobius v4.44.0 or later
...
func NewProductFromOS(os mobius.OperatingSystem) Product {
