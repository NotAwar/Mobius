...
func DownloadCPETranslationsFromGithub(vulnPath string, cpeTranslationsURL string) error {
	...
	client := mobiushttp.NewGithubClient()
...
func (c CPETranslations) Translate(reCache *regexpCache, s *mobius.Software) (CPETranslation, bool, error) {
	for _, item := range c {
...
func (c CPETranslationSoftware) Matches(reCache *regexpCache, s *mobius.Software) (bool, error) {
