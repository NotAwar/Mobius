...
func sanitizeSoftwareName(s *mobius.Software) string {
...
func productVariations(s *mobius.Software) []string {
	var r []string
...
func vendorVariations(s *mobius.Software) []string {
	var r []string
	rSet := make(map[string]bool)
...
func targetSW(s *mobius.Software) string {
	switch s.Source {
	case "apps":
		return "macos"
