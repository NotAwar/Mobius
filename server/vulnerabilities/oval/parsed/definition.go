...
func (d Definition) Eval(osTstResults map[int]bool, pkgTstResults map[int][]mobius.Software) bool {
...
func evalCriteria(c *Criteria, osTstResults map[int]bool, pkgTstResults map[int][]mobius.Software) (bool, error) {
	var vals []bool
	var result bool
