...
// return nil.
func (t *RpmInfoTest) Eval(packages []mobius.Software) ([]mobius.Software, error) {
	if len(packages) == 0 {
		return nil, nil
	}
...
func (t *RpmInfoTest) matches(software []mobius.Software) (int, int, []mobius.Software, error) {
	var nObjects int
	var nState int
