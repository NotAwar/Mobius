...
func (r UbuntuResult) Eval(ver mobius.OSVersion, software []mobius.Software) ([]mobius.SoftwareVulnerability, error) {
...
func (r UbuntuResult) EvalKernel(software []mobius.Software) ([]mobius.SoftwareVulnerability, error) {
