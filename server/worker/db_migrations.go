...
// "mobius prepare db" command can reuse this job.
...
func extractVPPTokenFromMigration(migratedToken *mobius.VPPTokenDB) (tokData *mobius.VPPTokenData, didUpdateMetadata bool, err error) {
	var vppTokenData mobius.VPPTokenData
	...
	var vppTokenRaw mobius.VPPTokenRaw
