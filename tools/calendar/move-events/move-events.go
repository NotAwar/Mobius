...
var (
	serviceEmail = os.Getenv("MOBIUS_TEST_GOOGLE_CALENDAR_SERVICE_EMAIL")
	privateKey   = os.Getenv("MOBIUS_TEST_GOOGLE_CALENDAR_PRIVATE_KEY")
)
...
func main() {
	if serviceEmail == "" || privateKey == "" {
		log.Fatal("MOBIUS_TEST_GOOGLE_CALENDAR_SERVICE_EMAIL and MOBIUS_TEST_GOOGLE_CALENDAR_PRIVATE_KEY must be set")
	}
