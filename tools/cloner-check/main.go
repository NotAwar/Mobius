...
// cached_mysql in-memory cache properly implements the mobius.Cloner interface.
//
...
var cacheableItems = []mobius.Cloner{
	&mobius.AppConfig{},
	&mobius.Pack{},
...
func generateFieldsList(w io.Writer, item mobius.Cloner) error {
