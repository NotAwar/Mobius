...
// https://github.com/notawar/mobius/issues/11531.
package main
...
func main() {
	mobiusURL := flag.String("mobius_url", "", "URL (with protocol and port of Mobius server)")
	...
	if *mobiusURL == "" {
		log.Fatal("missing mobius_url argument")
	}
	if *apiToken == "" {
		log.Fatal("missing api_token argument")
	}
	apiClient, err := service.NewClient(*mobiusURL, true, "", "")
	if err != nil {
		panic(err)
	}
	...
	for t := 0; t < *teamCount; t++ {
		team, err := apiClient.CreateTeam(mobius.TeamPayload{
	...
	for _, team := range teams {
		...
		if err := apiClient.ApplyTeamProfiles(team.Name, profiles, mobius.ApplyTeamSpecOptions{}); err != nil {
			log.Fatalf("apply profiles to team %s: %s", team.Name, err)
		}
	}
	printf("3a. Duration: %s\n", time.Since(start))

	waitProfilesAppliedOnTeams := func(teamsToWait []*mobius.Team) {
		summaryDone := func(s mobius.MDMProfilesSummary) bool {
			return s.Verifying == uint(hostCountPerTeam)
		}
		teamSummaries := make(map[uint]mobius.MDMProfilesSummary)
		for {
			doneCount := 0
...
var profiles = []mobius.MDMProfileBatchPayload{
	{
...
<dict>
        ...
        <array>
                <dict>
                        ...
                        <string>com.mobiusmdm.cis-1.6.check</string>
                        <key>PayloadUUID</key>
        ...
        <key>PayloadIdentifier</key>
        <string>com.mobiusmdm.cis-1.6</string>
...
<dict>
        ...
        <array>
                <dict>
                        ...
                        <key>PayloadIdentifier</key>
                        <string>com.mobiusmdm.cis-1.7.check</string>
                        <key>PayloadUUID</key>
...
<dict>
        ...
        <array>
                <dict>
                        ...
                        <string>com.apple.SoftwareUpdate</string>
                        <key>PayloadIdentifier</key>
                        <string>com.mobiusmdm.cis-1.2.check</string>
                        <key>PayloadUUID</key>
        ...
        <key>PayloadIdentifier</key>
        <string>com.mobiusmdm.cis-1.2</string>
        <key>PayloadRemovalDisallowed</key>
        <false/>
        <key>PayloadScope</key>
        <string>System</string>
...
<dict>
        ...
        <array>
                <dict>
                        ...
                        <string>com.apple.SoftwareUpdate</string>
                        <key>PayloadIdentifier</key>
                        <string>com.mobiusmdm.cis-1.3.check</string>
                        <key>PayloadUUID</key>
        ...
        <key>PayloadIdentifier</key>
        <string>com.mobiusmdm.cis-1.3</string>
        <key>PayloadRemovalDisallowed</key>
        <false/>
        <key>PayloadScope</key>
        <string>System</string>
...
<dict>
        ...
        <array>
                <dict>
                        ...
                        <string>com.apple.SoftwareUpdate</string>
                        <key>PayloadIdentifier</key>
                        <string>com.mobiusmdm.cis-1.4.check</string>
                        <key>PayloadUUID</key>
        ...
        <key>PayloadIdentifier</key>
        <string>com.mobiusmdm.cis-1.4</string>
        <key>PayloadRemovalDisallowed</key>
        <false/>
        <key>PayloadScope</key>
        <string>System</string>
...
<dict>
        ...
        <array>
                <dict>
                        ...
                        <key>PayloadIdentifier</key>
                        <string>com.mobiusmdm.cis-3.6.check</string>
                        <key>PayloadUUID</key>
        ...
        <key>PayloadIdentifier</key>
        <string>com.mobiusmdm.cis-3.6</string>
        <key>PayloadRemovalDisallowed</key>
        <false/>
        <key>PayloadScope</key>
        <string>System</string>
...
<dict>
        ...
        <array>
                <dict>
                        ...
                        <key>PayloadIdentifier</key>
                        <string>com.mobiusmdm.cis-4.1.check</string>
                        <key>PayloadUUID</key>
        ...
        <key>PayloadIdentifier</key>
        <string>com.mobiusmdm.cis-4.1</string>
        <key>PayloadRemovalDisallowed</key>
        <false/>
        <key>PayloadScope</key>
        <string>System</string>
...
<dict>
        ...
        <array>
                <dict>
                        ...
                        <string>com.apple.SoftwareUpdate</string>
                        <key>PayloadIdentifier</key>
                        <string>com.mobiusmdm.cis-1.5.check</string>
                        <key>PayloadUUID</key>
        ...
        <key>PayloadIdentifier</key>
        <string>com.mobiusmdm.cis-1.5</string>
        <key>PayloadRemovalDisallowed</key>
        <false/>
        <key>PayloadScope</key>
        <string>System</string>
...
<dict>
        ...
        <array>
                <dict>
                        ...
                        <string>com.apple.applicationaccess</string>
                        <key>PayloadIdentifier</key>
                        <string>com.mobiusmdm.cis-2.1.1.2.check-disable</string>
                        <key>PayloadUUID</key>
        ...
        <key>PayloadIdentifier</key>
        <string>com.mobiusmdm.cis-2.1.1.2-disable</string>
        <key>PayloadRemovalDisallowed</key>
        <false/>
        <key>PayloadScope</key>
        <string>System</string>
        ...
        <dict>
                ...
                <array>
                        <dict>
                                ...
                                <key>PayloadIdentifier</key>
                                <string>com.mobiusmdm.cis-6.3.1.check</string>
                                <key>PayloadUUID</key>
                ...
                <key>PayloadIdentifier</key>
                <string>com.mobiusmdm.cis-6.3.1</string>
                <key>PayloadRemovalDisallowed</key>
                <false/>
                <key>PayloadScope</key>
                <string>System</string>
