...
// "tools/osquery-agent-options/main.go" and run "cd server/mobius/ && go generate".
package mobius
...
func main() {
	...
	urlStr := fmt.Sprintf("https://updates.mobiusmdm.com/targets/osqueryd/macos-app/%s/osqueryd.app.tar.gz", osqueryVersion)
	...
	var allOSSpecific struct {
		mobius.OsqueryCommandLineFlagsLinux
		mobius.OsqueryCommandLineFlagsWindows
		mobius.OsqueryCommandLineFlagsMacOS
		mobius.OsqueryCommandLineFlagsHidden
	}
