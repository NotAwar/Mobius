...
// as Orbit would do following reception of a Mobius server notification of
// pending script(s) to execute.
//
// It allows to run such scripts without having to build and deploy orbit on
// the target host and without having to enroll that host in mobius and have the
// mobius server send script execution requests to it.
//
