...
$config = array(
    ...
    'example-userpass' => array(
        ...
        // sso_user_3_global_admin has MOBIUS_JIT_USER_ROLE_GLOBAL attribute to be added as global admin.
        'sso_user_3_global_admin:user123#' => array(
            ...
            'MOBIUS_JIT_USER_ROLE_GLOBAL' => 'admin',
        ),
        // sso_user_4_team_maintainer has MOBIUS_JIT_USER_ROLE_TEAM_1 attribute to be added as maintainer
        ...
        'sso_user_4_team_maintainer:user123#' => array(
            ...
            'MOBIUS_JIT_USER_ROLE_TEAM_1' => 'maintainer',
        ),
        // sso_user_5_team_admin has MOBIUS_JIT_USER_ROLE_TEAM_1 attribute to be added as admin
        // of team with ID 1, its login will fail if team with ID 1 doesn't exist.
        // It also sets MOBIUS_JIT_USER_ROLE_GLOBAL and MOBIUS_JIT_USER_ROLE_TEAM_2 to `null` which means
        // Mobius will ignore such fields.
        'sso_user_5_team_admin:user123#' => array(
            ...
            'MOBIUS_JIT_USER_ROLE_TEAM_1' => 'admin',
            'MOBIUS_JIT_USER_ROLE_GLOBAL' => 'null',
            'MOBIUS_JIT_USER_ROLE_TEAM_2' => 'null',
        ),
        // sso_user_6_global_observer has all MOBIUS_JIT_USER_ROLE_* attributes set to null, so it
        ...
        'sso_user_6_global_observer:user123#' => array(
            ...
            'MOBIUS_JIT_USER_ROLE_GLOBAL' => 'null',
            'MOBIUS_JIT_USER_ROLE_TEAM_1' => 'null',
        ),
