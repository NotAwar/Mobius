...
// Set env var MOBIUSDAEMONM_APIKEY
// Set env var MOBIUSDAEMONM_URL (I couldn't figure out how to set this otherwise...)
...
func TestAccMobiusdmTeams_basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: fmt.Sprintf(`
					resource "mobiusdm_teams" "test_team" {
						name        = "%s"
						description = "Awesome description"
					}
				`, teamName),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("mobiusdm_teams.test_team", "name", teamName),
					resource.TestCheckResourceAttr("mobiusdm_teams.test_team", "description", "Awesome description"),
					resource.TestCheckResourceAttr("mobiusdm_teams.test_team", "agent_options", defaultAgentOptions),
				),
			},
		},
	})
...
func TestAccMobiusdmTeams_agent_options(t *testing.T) {
	teamName := fmt.Sprintf("aaa-%s",
		acctest.RandStringFromCharSet(6, acctest.CharSetAlpha))
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("mobiusdm_teams.test_team", "name", teamName),
					resource.TestCheckResourceAttr("mobiusdm_teams.test_team", "description", "Awesome description"),
					resource.TestCheckResourceAttr("mobiusdm_teams.test_team", "agent_options", newAO),
				),
			},
		},
	})
...
func TestAccMobiusdmTeams_update_all(t *testing.T) {
	teamName := fmt.Sprintf("aaa-%s",
		acctest.RandStringFromCharSet(6, acctest.CharSetAlpha))
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				`, NewTeamName, upAO),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("mobiusdm_teams.test_team", "name", NewTeamName),
					resource.TestCheckResourceAttr("mobiusdm_teams.test_team", "description", "Awesomer description"),
					resource.TestCheckResourceAttr("mobiusdm_teams.test_team", "agent_options", upAO),
				),
			},
		},
	})
...
func TestAccMobiusdmTeams_update_each(t *testing.T) {
	teamName := fmt.Sprintf("aaa-%s",
		acctest.RandStringFromCharSet(6, acctest.CharSetAlpha))
	NewTeamName := fmt.Sprintf("aaa-%s-new",
		acctest.RandStringFromCharSet(6, acctest.CharSetAlpha))
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("mobiusdm_teams.test_team", "name", teamName),
					resource.TestCheckResourceAttr("mobiusdm_teams.test_team", "description", ""),
					resource.TestCheckResourceAttr("mobiusdm_teams.test_team", "agent_options", defaultAgentOptions),
				),
			},
			{
