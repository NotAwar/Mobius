module.exports = {
  ...
  fn: async function () {
    ...
    let pageTitleForMeta = 'Mobius blog';
    let pageDescriptionForMeta = 'Read the latest articles written by Mobius.';
    ...
    switch(category) {
      case 'success-stories':
        ...
        pageDescriptionForMeta = 'Read about how others are using Mobius and osquery.';
        currentSection = 'platform';
        break;
      case 'deploy':
        pageTitleForMeta = 'Deployment guides';
        pageDescriptionForMeta = 'Learn how to deploy Mobius on a variety of production environments.';
        currentSection = 'documentation';
        break;
      case 'releases':
        pageTitleForMeta = 'Releases';
        pageDescriptionForMeta = 'Mobius releases new and updated features every three weeks. Read about the latest product improvements here.';
        currentSection = 'documentation';
        break;
      case 'guides':
        pageTitleForMeta = 'Guides';
        pageDescriptionForMeta = 'A collection of how-to guides for Mobius and osquery.';
        currentSection = 'documentation';
        break;
      case 'securing':
        pageTitleForMeta = 'Security articles';
        pageDescriptionForMeta = 'Learn more about how we secure Mobius.';
        break;
      case 'engineering':
        pageTitleForMeta = 'Engineering articles';
        pageDescriptionForMeta = 'Read about engineering at Mobius and beyond.';
        break;
      case 'announcements':
        pageTitleForMeta = 'Announcements';
        pageDescriptionForMeta = 'Read the latest news from Mobius.';
        break;
      case 'podcasts':
      ...
      case 'articles':
        ...
        pageDescriptionForMeta = 'Read the latest articles from the Mobius team and community.';
        break;
    }
