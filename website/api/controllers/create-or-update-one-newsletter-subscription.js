module.exports = {
  ...
  exits: {
    ...
    success: {
      description: 'A user has successfully changed their subscription to the Mobius newsletter'
    },
  ...
  fn: async function ({emailAddress}) {
    ...
    sails.helpers.flow.build(async()=>{
      let recordIds = await sails.helpers.salesforce.updateOrCreateContactAndAccount.with({
        ...
        description: `Subscribed to the Mobius newsletter`,
      ...
      await sails.helpers.salesforce.createHistoricalEvent.with({
        ...
        intentSignal: 'Subscribed to the Mobius newsletter',
      });
