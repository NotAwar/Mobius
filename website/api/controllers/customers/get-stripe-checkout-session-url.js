module.exports = {
  ...
  description: 'Creates a Stripe checkout session for a new Mobius Premium subscription and returns the URL',
  ...
  exits: {
    success: {
      description: 'A Stripe checkout session was successfully created for a new Mobius Premium subscription.'
    }
  },
