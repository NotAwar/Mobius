module.exports = {
  ...
  description: 'Creates a Stripe billing portal session for a Mobius Premium subscriber and redirects them.',
  ...
  exits: {
    ...
    noSubscription: {
      responseType: 'redirect',
      description: 'The Requesting user does not have a Mobius premium subscription.'
    },
  },
