module.exports = {
  ...
  inputs: {
    unsignedCsrData: {
      required: true,
      type: 'string',
      description: 'Base64 encoded CSR submitted from the Mobius server or `mobiuscli` on behalf of the user.'
    },
    deliveryMethod: {
      type: 'string',
    ...
    switch(deliveryMethod) {
      ...
      case 'email':
        ...
        await sails.helpers.sendTemplateEmail.with({
          ...
          subject: 'Your certificate signing request from Mobius',
