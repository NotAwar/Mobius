...
the account verification message.)`,
  ...
  exits: {
    ...
    invalidEmailDomain: {
      description: 'This email address is on a denylist of domains and cannot be used to signup for a mobiusmdm.com account.',
      responseType: 'badRequest'
    },
  ...
  fn: async function ({emailAddress, password, firstName, lastName, organization, signupReason}) {
    // Note: in Oct. 2023, the Mobius Sandbox related code was removed from this action. For more details, see https://github.com/notawar/mobius/pull/14638/files
    ...
    sails.helpers.salesforce.updateOrCreateContactAndAccount.with({
      ...
      if(err){
        sails.log.warn(`Background task failed: When a user (email: ${newEmailAddress} signed up for a mobiusmdm.com account, a Contact and Account record could not be created/updated in the CRM.`, err);
      }
      return;
    });
