module.exports = {
  ...
  fn: async function ({pageUrlSuffix}) {
    ...
    return {
      ...
      pageTitleForMeta: (
        thisPage.title !== 'Readme.md' ? thisPage.title + ' | Mobius handbook'// « custom meta title for this page, if provided in markdown
      ...
      pageDescriptionForMeta: (
        ...
        : 'View the Mobius handbook.'// « otherwise use a generic description
      ),
