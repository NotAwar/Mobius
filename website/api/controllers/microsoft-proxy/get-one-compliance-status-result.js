module.exports = {
  ...
  exits: {
    tenantNotFound: {description: 'No existing Microsoft compliance tenant was found for the Mobius instance that sent the request.', responseType: 'unauthorized'}
  },


  fn: async function ({entraTenantId, mobiusServerSecret, messageId}) {
