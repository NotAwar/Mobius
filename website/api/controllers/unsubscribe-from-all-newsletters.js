module.exports = {
  ...
  fn: async function ({emailAddress}) {
    ...
    if(!updatedSubscription) { // If a subscription could not be found with the specified email address, we'll log a warning and return a 200 response.
      sails.log.warn('When a user tried to unsubscribe from the Mobius newsletter, a NewsletterSubscription record for the specified email address ('+ emailAddress +') could not be found.');
    }
    // All done.
