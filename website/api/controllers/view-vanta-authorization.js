module.exports = {
  ...
  fn: async function (inputs) {
    ...
    if(!recordOfThisAuthorization){
      ...
      throw new Error(`When a user tried to connect their Vanta account with their Mobius instance. No VantaConnection record with the sourceID ${this.req.signedCookies.vantaSourceId} could be found.`);
    }
