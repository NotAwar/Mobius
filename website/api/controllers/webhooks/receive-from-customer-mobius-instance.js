module.exports = {
  ...
  friendlyName: 'Receive from customer Mobius instance',


  description: 'Receive webhook requests from a customer\'s Mobius instance and sends a request to unenroll a specfied host from the customer\'s Workspace One instance.',
  ...
  inputs: {
    ...
    webhookSecret: {
      type: 'string',
      required: true,
      description: 'A shared secret used to confirm that this request came from a customer\'s Mobius instance.',
