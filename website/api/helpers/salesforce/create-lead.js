module.exports = {
  ...
  description: 'Create a Lead record in Salesforce representing some kind of action Mobius needs to take for someone, whether based on a signal from their behavior or their explicit request.',
