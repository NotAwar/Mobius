module.exports = {
  ...
  fn: function ({ text }) {
    ...
    let KNOWN_ACRONYMS = ['JSON', 'REST', 'CLI', 'API', 'FAQ', 'QA', 'UI', 'README'];  // « helps make this smarter about things like: "Mobius rEST aPI" => "Mobius REST API")
    let KNOWN_PROPER_NOUNS = ['Mobius'];// « helps make this smarter about things like: "Deploying mobius" => "Deploying Mobius"
