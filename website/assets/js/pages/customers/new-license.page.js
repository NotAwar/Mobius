parasails.registerPage('new-license', {
  ...
  mounted: async function() {
    ...
    // If this user's signupReason is 'Try Mobius Sandbox' we'll need some additional information to complete this order.
    if(this.me.signupReason === 'Try Mobius Sandbox') {
