...
module.exports.custom = {
  ...
  *                                                                          *
  * See also the CODEOWNERS file in mobiusmdm/mobius for more context / links.  *
  *                                                                          *
  ***************************************************************************/
  githubRepoDRIByPath: {// mobiusmdm/mobius
    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    // FUTURE: To avoid repeating structure and comments, consolidate all these configs w/ something like:
    //    ````
    //    'articles': { dri: 'mike-j-thomas', maintainers: ['mike-j-thomas', 'mike-j-thomas', 'mikermcneil'], repo: 'mobiusmdm/mobius' },
    //    ````
    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    'tools/api': 'lukeheath', //« Scripts used to interact with the Mobius API

    // ⚗️ Reference, config surface, built-in queries, API, and other documentation
    // 'docs/Using-Mobius/REST-API.md': '',              // « Covered in CODEOWNERS (2023-07-22)
    ...
    'docs/01-Using-Mobius/standard-query-library/standard-query-library.yml': 'rachaelshaw', //« Built-in queries
    '/docs/get-started/faq': 'zayhanlon',
    'ee/cis': 'sharon-fdm',//« Mobius Premium only: built-in queries  (built-in policies for CIS benchmarks)  -- FYI: On 2023-07-15, we changed this so that Sharon, Lucas, and Rachel are all maintainers, but where there is a single DRI who is automatically requested approval from.

    // Mobius's internal IT and security (+dogfooding)
    ...
    'tools/mobiuscli-npm/README.md': 'mikermcneil',// « NPM brandfront (npmjs.com/package/mobiuscli)
  ...
  *                                                                          *
  ***************************************************************************/
  githubRepoMaintainersByPath: {// mobiusmdm/mobius

    // Code for core product and integrations
    'ee/tools/puppet': ['lukeheath', 'gillespi314', 'mna', 'georgekarrv'],
    'tools/api': ['lukeheath', 'georgekarrv', 'sharon-fdm'],//« Scripts for interacting with the Mobius API
    ...
    'docs/01-Using-Mobius/standard-query-library/standard-query-library.yml': ['rachaelshaw', 'noahtalerman', 'eashaw'],// (standard query library)
    ...
    // Other brandfronts
    'README.md': ['mikermcneil', 'mike-j-thomas', 'lukeheath'],//« github brandfront (github.com/notawar/mobius)
    'tools/mobiuscli-npm/README.md': ['mikermcneil', 'mike-j-thomas', 'lukeheath'],//« brandfront for mobiuscli package on npm (npmjs.com/package/mobiuscli)

    // Config as code for infrastructure, internal security and IT use cases, and more.
    //'infrastructure': [],// Decided against in https://github.com/notawar/mobius/pull/12890
    //'charts': [], //Decided against in https://github.com/notawar/mobius/pull/12890
    //'terraform': [],//Decided against in https://github.com/notawar/mobius/pull/12890

    // Github workflows
    '.github/workflows/deploy-mobius-website.yml': ['eashaw','mikermcneil'],// (website deploy script)
    ...
    // Handbook
    'handbook/README.md': 'mikermcneil', // See https://github.com/notawar/mobius/pull/13195
  ...
  confidentialGithubRepoMaintainersByPath: {// mobiusmdm/confidential

    // Config as code for infrastructure, internal security and IT use cases, and more.
    'mdm_profiles': ['lukeheath'],//« for dogfood.mobiusmdm.com, this is the required OS settings applied to contributor Macs
    'vpn': ['rfairburn', 'lukeheath'],// « for managing VPN rules for accessing customer and Mobius Sandbox infrastructure
    ...
    'free-for-all': '*',//« Folder that any mobiusie (core team member, not consultants) can push to, willy-nilly
  ...
  mobiusMdmGitopsGithubRepoMaintainersByPath: {
  ...
  // (both in Mobius's query console and on mobiusmdm.com)
  ...
  ***************************************************************************/
  ...
  // For receive-from-customer-mobius-instance webhook.
