module.exports = {
  ...
  description: 'Generate an HTML partial for the Mobius newsletter from Markdown files in the articles/ folder of the mobiusmdm/mobius repo.',
  ...
  fn: async function ({ articleFilename }) {
    ...
    // Modify path-relative links in the final HTML like `./…` and `../…` to make them absolute.  (See https://github.com/notawar/mobius/issues/706#issuecomment-884641081 for more background)
